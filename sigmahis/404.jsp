...
<jsp:include page="/common/title.jsp" flush="true">
	<jsp:param name="title" value="ERROR 404: PAGINA NO ENCONTRADA"></jsp:param>
		...
		<td><table width="100%" border="0" align="center" class="TableBorder">
				...
				<tr height="150" align="center" class="TextRow01">
					<td><%=CmnMgr.getCurrentDate("dd/mm/yyyy hh24:mi:ss")%></br>
						<h2>La p&aacute;gina que est&aacute; tratando de accesar est&aacute; en proceso de generacion o no existe.</h2><br>
