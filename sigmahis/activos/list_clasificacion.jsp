...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and cod_clasif like '%"+request.getParameter("codigo").toUpperCase()+"%'";
  ...
  if (request.getParameter("descripcion") != null && !request.getParameter("descripcion").trim().equals(""))
  {
	...
	sql="select cod_clasif as codigo, descripcion from tbl_con_clasif_hacienda where compania = "+(String)session.getAttribute("_companyId")+appendFilter+" order by cod_clasif";
...
document.title = 'Lista de Clasificación - '+document.title;
...
function returnValue(op,code,name)
{
	...
	{  
	   ...
	   <%if(fp.trim().equals("activo")){%>
			window.opener.document.form0.grupo_clasif.value=code; 
			window.opener.document.form0.grupo_desc.value=name; 
			window.close();
			<%}else{%>
			window.opener.document.form1.codehacienda.value=code; 
			window.opener.document.form1.namehacienda.value=name; 
			window.close();
			<%}%>
		 break;
		case 2:
		window.opener.document.form1.codeclasificacion.value=code; 
		window.opener.document.form1.nameclasificacion.value=name; 
		window.close();
		 break;
	}
}
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CONTABILIDAD - MANTENIMINETO - GRUPO DE ACTIVO"></jsp:param>
</jsp:include>
