...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "SELECT secuencia_campos codigo, descripcion,decode(estado,'A','ACTIVO','I','INACTIVO') estado FROM tbl_con_lista_campos  "+appendFilter+"  ORDER BY secuencia_campos ASC ";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "CARACTERISTICAS A CLASIFICAR";
	String xtraSubtitle = "";
