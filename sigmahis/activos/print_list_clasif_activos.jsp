...
if (appendFilter == null) appendFilter = "";
  ...
  sql = " SELECT cod_clasif codigo, descripcion,decode(estado,'A','ACTIVO','I','INACTIVO') estado FROM tbl_con_clasif_hacienda where compania = "+(String)session.getAttribute("_companyId")+appendFilter+" ORDER BY cod_clasif ASC ";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "CLASIFICACION DE ACTIVOS";
	String xtraSubtitle = "";
