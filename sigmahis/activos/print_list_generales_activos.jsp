...
if (request.getMethod().equalsIgnoreCase("GET"))
{
 ...
 pc.setNoColumnFixWidth(dDetalle);
	...
	{
		pc.addCols(" Total: "+CmnMgr.getFormattedDecimal(totales),2,7);
		pc.addCols(" ",0,3);		
		pc.addCols(" ",1,8);
		pc.addCols(" ",1,8);
		...
		for (int j=0 ; j<alDet.size(); j++)
		{
		 ...
		 pc.setNoColumnFixWidth(dDetalle); 
			...
			pc.addCols(" "+cdo2.getColValue("cta6_depre_acum"),2,1);
		  ...
		  pc.addCols(" ",1,1);
		totales += Double.parseDouble(cdo2.getColValue("tot_acum"));
	...
	else
	{
		...
		pc.addCols(" "+CmnMgr.getFormattedDecimal(totales),2,1);
