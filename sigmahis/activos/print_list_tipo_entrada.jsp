...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select codigo_entrada codigo, descripcion,decode(estado,'A','ACTIVO','I','INACTIVO') estado from tbl_con_tipo_entrada "+appendFilter+" order by codigo_entrada desc";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE ENTRADAS";
	String xtraSubtitle = "";
