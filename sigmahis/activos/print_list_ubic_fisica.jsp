...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select codigo_ubic codigo, descripcion ,decode(estado,'A','ACTIVO','I','INACTIVO') estado from tbl_con_ubic_fisica "+appendFilter+" order by codigo_ubic asc";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "UBICACION FISICA";
	String xtraSubtitle = "";
