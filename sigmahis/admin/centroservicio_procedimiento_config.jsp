...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (id == null) throw new Exception("El Centro de Servicio Procedimiento no es válido. Por favor intente nuevamente!");
...
<%if (mode.equalsIgnoreCase("add")){%>
document.title="Centro de Servicio Procedimiento - Agregar - "+document.title;
<%}else if (mode.equalsIgnoreCase("edit")){%>
document.title="Centro de Servicio Procedimiento - Edición - "+document.title;
<%}%>
function agregar()
{
abrir_ventana1('centroservicio_proveedores_config.jsp');
}
</script>
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="ADMINISTRACIÓN - CENTRO DE SERVICIO PROCEDIMIENTO"></jsp:param>
</jsp:include>
...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
				...
				<td colspan="2">
					<table width="100%">
						<TR class="TextRow01">
							...
							<td width="30%">&nbsp;<%=id%></td>
							<td width="20%">&nbsp;<cellbytelabel>Centro de Servicio</cellbytelabel></td>
							<td width="30%">&nbsp;<%=fb.textBox("centro",cdo.getColValue("centro"),false,false,false,30)%></td>
						</TR>
					</table>
				</td>
			</tr>							
			<tr class="TextRow01" >
				...
				<td width="85%"><%=fb.intBox("codigo",cdo.getColValue("codigo"),false,false,true,15)%></td>
			</tr>		
			<tr class="TextRow01">
				<td>&nbsp;<cellbytelabel>Descripci&oacute;n</cellbytelabel></td>
				<td><%=fb.textBox("descripcion",cdo.getColValue("descripcion"),false,false,true,50)%>
				<%=fb.button("btnprocedimiento",".:.",true,false,null,null,"onClick=\"javascript:agreg();\"")%></td>
			</tr>	
			<tr class="TextRow01">
			...
			<tr class="TextRow01">
				<td colspan="2" align="right">&nbsp;<%=fb.button("btnservicio","Ser. Ext.",true,false,null,null,"onClick=\"javascript:agregar();\"")%></td>
			</tr>	
			<tr class="TextRow02">
