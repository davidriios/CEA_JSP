...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (id == null) throw new Exception("ElProveedor que Presta el Servicio no es válido. Por favor intente nuevamente!");
...
<%if (mode.equalsIgnoreCase("add")){%>
document.title="Proveedor Que Presta el Servicio - Agregar - "+document.title;
<%}else if (mode.equalsIgnoreCase("edit")){%>
document.title="Proveedor Que Presta el Servicio - Edición - "+document.title;
<%}%>
</script>
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CENTRO DE SERVICIO - PROVEEDOR QUE PRESTA EL SERVICIO"></jsp:param>
</jsp:include>
