...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo as code, descripcion as name from tbl_cds_clasif_servicio where codigo!=0"+appendFilter;
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cds_clasif_servicio WHERE codigo!=0"+appendFilter);
...
{
window.opener.document.form1.cod.value=code; 
window.opener.document.form1.descp.value=name; window.close();
}
</script>
</head>
