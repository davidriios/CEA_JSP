...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	sql = "select a.id, a.name, decode(a.status,'A','ACTIVO','I','INACTIVO') as status from tbl_sec_module a where a.id > 0 "+appendFilter+" order by 2";
...
function add(){abrir_ventana('../admin/reg_module.jsp?mode=add');}
function edit(id){abrir_ventana('../admin/reg_module.jsp?mode=edit&id='+id);}
</script>
</head>
...
<tr>
	<td align="right">&nbsp;<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo M&oacute;dulo</cellbytelabel> ]</a></authtype></td>
</tr>
<tr>
	<td>
