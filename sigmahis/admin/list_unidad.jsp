...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo as code, descripcion as name,compania from tbl_sec_unidad_ejec where compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
{
window.opener.document.form1.administracion.value=code; 
window.opener.document.form1.nombre.value=name; window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="ADMINISTACION - CENTRO DE SERVICIO"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Centro Educativo</cellbytelabel> ]</a>
<%
//}
%>
		</td>--%>
