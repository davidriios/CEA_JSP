...
String sql = "", appendFilter = (request.getParameter("appendFilter")==null?"":request.getParameter("appendFilter"));

sql = "select id, upper(nombre) nombre,usuario_creacion,fecha_creacion, fecha_modificacion, decode(estado,'I','INACTIVO','ACTIVO') estado, upper(observacion) observacion from tbl_param_consentimientos where 1= 1 "+appendFilter+" order by 1";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "LISTADO DE CONSENTIMIENTOS ";
	String xtraSubtitle = "";
	...
	pc.addBorderCols("CONSENTIMIENTO",0,1);
