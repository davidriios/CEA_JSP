...
sbSql.append("select a.codigo, a.ruc as identificacion, a.primer_nombre||decode(a.segundo_nombre,null,'',' '||a.segundo_nombre) as nombre, a.primer_apellido||decode(a.segundo_apellido,null,'',' '||a.segundo_apellido)||decode(a.sexo,'F',decode(a.apellido_de_casada,null,'',' '||a.apellido_de_casada)) as apellido, decode(a.estado,'A','ACTIVO','I','INACTIVO',a.estado) as estado from tbl_cxc_cliente_particular a where tipo_cliente in ( select column_value  from table( select split((select param_value from tbl_sec_comp_param where compania =a.compania and param_name='POS_TIPO_CLTE_");
sbSql.append(fg);
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = ((fg.trim().equals("ACC"))?"ACCIONISTA":"JUNTA DIRECTIVA");
	String xtraSubtitle = "";
