...
sql = "select id, titulo_frm as displayLabel, display_order as displayOrder, nvl(desc_terapia,'NA') as description, parent_id as parentId, level_frm as menuLevel, root_id from tbl_frm_terapias_test"+appendFilter+" order by Get_Frm_Code(id), id";
