...
sql = "select id, name, description, decode(status,'A','ACTIVO','I','INACTIVO') as status from tbl_sec_regvar"+appendFilter+" order by name";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "VARIABLE AMBIENTE";
	String xtraSubtitle = "";
