...
100032	IMPRIMIR LISTA DE TIPOS DE SERVICIOS
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
    ...
    searchType = "1";
    searchDisp = "Código";
		codigo     = request.getParameter("code");          // utilizada para mantener el código del tipo de servicio
	}
    ...
    searchType = "1";
    searchDisp = "Nombre";
		nombre     = request.getParameter("name");       // utilizada para mantener el nombre del tipo de servicio
	}
  ...
  else
  {
	...
	sql = "select codigo as code, descripcion as name, compania from tbl_cds_tipo_servicio where compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
function add()
{
	abrir_ventana('../admin/tipo_servicio_config.jsp');
}

function edit(id)
{
	abrir_ventana('../admin/tipo_servicio_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../admin/print_list_tipo_servicio.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;<!--<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevos Tipo de Servicio</cellbytelabel> ]</a>-->
		</td>
  </tr>
	<tr>
		<td>
...
<!-- ================================   S E A R C H   E N G I N E S   E N D   H E R E   ================================ -->
  ...
  <tr>
    <td align="right">
<%
if (SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"100032"))
{
%>
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td align="center">
<%
if (SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"100034"))
{
%>
