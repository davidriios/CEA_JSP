...
//{
   ...
   // PdfCreator pc = new PdfCreator(directory+folderName+"/"+year+"/"+month+"/"+fileName, width, height, isLandscape, sbFooter.toString(), leftRightMargin, topMargin, bottomMargin, headerFooterFont, logoMark, logoPath, statusMark, statusPath, displayPageNo, pageNoFontSize, pageNoLabel, pageNoPoxX, pageNoPosY);
    ...
    pc.addBorderCols(lng.equalsIgnoreCase("es")?"Por este medio yo, __________________________________________________________ con número de identidad personal __________________________, solicito que se llame al Doctor _____________________________________________________________ Especialista en  ____________________________________________________.\nPara que atienda al paciente ______________________________________________ en cuarto de Urgencias de "+nombreCompania+", hoy ____________ hora: __________\n\nExonerando de todo tipo de responsabilidad al Médico de Cuarto de Urgencias y a esta Institución por la decisión tomada.\n\nQueda entendido que si el Doctor __________________________________, no asistiera en los siguientes 30 minutos, este Centro Médico se reserva el derecho a llamar al especialista en turno de la especialidad involucrada en el caso del paciente." : "This agreement releases "+nombreCompania+" of any civil, financial or other type of liability as well as Dr. __________________________________________ and hospital staff for the injuries that may happen during ___________________________________________________________________ given the serious and unstable condition of the patient and his/her own diagnosis leads to this being the only alternative to any possible treatment.\n\nI acknowledge I have been clearly informed of the risks involved; ___________________________________________________________________________, therefore, I assume their consequences. I also accept the physician and hospital staff have explained to me everything related to this situation and I have taken this decision voluntarily, in agreement with the description of the facts.\n\nSituation (describe briefly)_____________________________________________________________________________", 4,dHeader.size());
  
    pc.addCols(" ", 0,dHeader.size());
    pc.addCols(" ", 0,dHeader.size());
    pc.addCols(" ", 0,dHeader.size());
    
    pc.addCols(lng.equalsIgnoreCase("es")?"Firma del Paciente _________________________________CIP_____________ Fecha: ____________":"Signature of the Patient:___________________________I.D._____________ Date: ____________", 0,dHeader.size());
   
    pc.addCols(" ", 0,dHeader.size());
    pc.addCols(" ", 0,dHeader.size());
    
    pc.addCols(lng.equalsIgnoreCase("es")?"Firma del Familiar responsable _________________________________CIP_____________ Fecha: ____________":"Signature of Family Member in charge:___________________________I.D._____________ Date: ____________", 0,dHeader.size());
