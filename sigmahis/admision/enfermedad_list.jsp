...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo, nombre as name from tbl_cds_enfermedad_notificable"+appendFilter+" order by nombre";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cds_enfermedad_notificable"+appendFilter);
...
document.title = 'Lista de Enfermedades - '+document.title;

function returnValue(code, name)
{
window.opener.document.form1.codenot.value=code; 
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="Clínico - Admisión - Diagnóstico"></jsp:param>
</jsp:include>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader">
	  <td width="10%">&nbsp;</td>
		<td width="45%">&nbsp;<cellbytelabel id="1">C&oacute;digo</cellbytelabel></td>
		<td width="45%">&nbsp;<cellbytelabel id="6">Nombre</cellbytelabel></td>	
	</tr>
	<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td>&nbsp;<a href="javascript:returnValue('<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("name")%>')" class="Link00"><%=cdo.getColValue("name")%></a></a></td>
				</tr>
				<%
				}
		%>						
