...
/**
==============================================================================
500021	VER LISTA DE ESPECIALIDADES MEDICAS
500022	IMPRIMIR LISTA DE ESPECIALIDADES MEDICAS
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion FROM tbl_adm_especialidad_medica"+appendFilter;
...
function add()
{
	abrir_ventana('esp_medica_config.jsp');
}

function edit(code)
{
	abrir_ventana('esp_medica_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_esp_medica.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
			    <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva Especialidad M&eacute;dica</cellbytelabel> ]</a></authtype>
	      </td>
    </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextHeader">
					...
					<td width="63%"><cellbytelabel id="3">Descripci&oacute;n</cellbytelabel></td>
					<td width="10%">&nbsp;</td>
				</tr>				
				<%
