...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  {
    appendFilter += " and upper(tipo_personal) like '%"+request.getParameter("tipo").toUpperCase()+"%'";
    searchOn = "tipo_personal";
  ...
  {
    appendFilter += " and status = '"+request.getParameter("status").toUpperCase()+"'";
    searchOn = "status";
  ...
  sql = "SELECT codigo, descripcion, DECODE(tipo_personal,'M','Médico','E','Empleado','S','Sociedad Medica') as tipo, DECODE(status,'A','Activo','I','Inactivo') as status FROM tbl_cds_funcion WHERE codigo<>'0'"+appendFilter+" order by descripcion";
...
document.title = 'Funciones del Personal - '+document.title;

function add()
{
	abrir_ventana('funcionespersonal_config.jsp');
}

function edit(code)
{
	abrir_ventana('funcionespersonal_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_funcionespersonal.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CLÍNICA - ADMISIÓN - FUNCIONES DEL PERSONAL"></jsp:param>
</jsp:include>

<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
       	    <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva Funci&oacute;n del Personal</cellbytelabel> ]</a></authtype>
	    </td>
    </tr>
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">		
				    ...
				    <td><cellbytelabel id="2">C&oacute;digo</cellbytelabel>
						<%=fb.textBox("codigo",codigo,false,false,false,35)%>
					   <cellbytelabel id="3">Descripci&oacute;n</cellbytelabel>
						<%=fb.textBox("descripcion",descripcion,false,false,false,47)%>
					    <cellbytelabel id="4">Tipo</cellbytelabel>
						<%=fb.select("tipo","M=Médico,E=Empleado,S=Sociedad Medica",tipo, false, false, 0, null,null,null,null,"T")%>
                        <cellbytelabel id="4">Estado</cellbytelabel>
						<%=fb.select("status","A=Activo,I=Inactivo",status, false, false, 0, null,null,null,null,"T")%>
					<%=fb.submit("go","Ir")%>
					</td>
				    <%=fb.formEnd()%>		
			    </tr>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextHeader">
					...
					<td width="25%"><cellbytelabel id="4">Tipo</cellbytelabel></td>
					<td width="10%" align="center"><cellbytelabel id="4">Estado</cellbytelabel></td>
					<td width="10%">&nbsp;</td>
				</tr>				
				<%
