...
function returnValue(op,code,name)
{
   ...
   {   
      case 1:
	       window.opener.document.generales.religionCode.value = code;
		   window.opener.document.generales.religion.value = name;
		   window.close();
      break;
	  
	  case 2:
	       window.opener.document.form0.religionCode.value = code;
		   window.opener.document.form0.religion.value = name;
		   window.close();
      break;
   }  		   
}
