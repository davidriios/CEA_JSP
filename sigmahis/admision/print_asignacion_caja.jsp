...
//{
	...
	pc.addCols("con cédula de identidad personal o pasaporte Nº",0,9);
	pc.addBorderCols(cdo.getColValue("cedula"),0,3,0.5f,0.0f,0.0f,0.0f);					
	pc.addCols("he guardado mis valores en la Caja de Seguridad Nº_______________________ y entiendo que",0,18);
	pc.addCols("debo recordar los 5 dígitos de la combinación de la Caja de Seguridad. Para retirar los mismos autorizo a _____________________",0,dHeader.size());
	pc.addCols("",0,dHeader.size());
	pc.addCols("Parentesco:________________________",0,2); 				
	pc.addCols("con teléfono y/ o celular___________________ a retirar los mismos.",0,dHeader.size());
	pc.addCols("",0,dHeader.size());
