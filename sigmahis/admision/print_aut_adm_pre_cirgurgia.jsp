...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subTitle = "AUTORIZACIÓN ADMINISTRATIVA";
	String xtraSubtitle = "PRE-CIRUGIA";
...
//control imgae
		...
		pc.addBorderCols(cdo.getColValue("nombrePaciente"),0,7,0.5f,0.0f,0.0f,0.0f);
		pc.addCols(" ",0, 1);
		pc.addCols("\n", 1, dHeader.size());
		
		pc.addCols(" ",0, 1);
		pc.addCols("MEDICO RESPONSABLE:",0, 2);
		pc.addBorderCols(cdo.getColValue("nombremedico"),0,6,0.5f,0.0f,0.0f,0.0f);
		pc.addCols(" ",0, 1);
		pc.addCols("\n", 1, dHeader.size());
		
		pc.addCols(" ",0, 1);
		pc.addCols("FECHA:",0, 1);
		pc.addBorderCols("",0,7,0.5f,0.0f,0.0f,0.0f);
		pc.addCols(" ",0, 1);
		...
		pc.addCols(" ",0, 1);
		pc.addCols("POR ESTE MEDIO HACEMOS CONSTAR QUE EL PACIENTE "+cdo.getColValue("nombrePaciente")+" CON CÉDULA "+cdo.getColValue("cedula")+" HA CUMPLIDO  CON EL TRAMITE  ADMINISTRATIVO  REQUERIDO PARA EL  INGRESO AL SALON  DE OPERACIONES.", 3, 8);
		pc.addCols(" ",0, 1);
		...
		pc.addCols(" ",0, 1);
		pc.addBorderCols("ATTE.\n\n", 3,4, 0.5f, 0.0f, 0.0f, 0.0f);
		pc.addCols(" ",0, 5);
		
		pc.addCols(" ",0, 1);
		pc.addCols("DEPTO. DE ADMISION", 3,4);
		pc.addCols(" ",0, 5);
