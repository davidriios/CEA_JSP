...
issi.admin.ISSILogger.setSession(session);
	...
	String p_mes  	= request.getParameter("mes5");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "REPORTE DE CANTIDAD DE PRUEBA DE LABORATORIO POR MEDICOS ";
