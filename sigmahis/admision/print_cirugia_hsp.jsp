...
issi.admin.ISSILogger.setSession(session);
	...
	String p_mes  	= request.getParameter("mes3");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "REPORTE DE CANTIDAD DE CIRUGIAS HOSPITALIARIAS POR MEDICOS ";
...
{
	sql = "SELECT "+p_mes+" mes, m.primer_apellido||' '||m.primer_nombre as nombremedico, a.categoria as total FROM  tbl_adm_admision a, tbl_adm_categoria_admision c,tbl_adm_medico m WHERE a.medico=m.codigo and a.categoria =1 and a.centro_servicio=24 and to_number(to_char(a.fecha_ingreso,'mm')) = "+p_mes+" and to_number(to_char(a.fecha_ingreso,'yyyy')) =  "+p_anio+" ";	
