...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subTitle = "FORMULARIO DE AUTORIZACIÓN PARA DECORACIÓN DE HABITACIONES";
	String xtraSubtitle = "";
...
//control imgae
		...
		pc.addCols("David, "+cdo.getColValue("lat_date")+"\n\n\n\nYo, "+cdo.getColValue("nombrePaciente")+" Solicito  autorización para decorar,  a mi costo, la habitación  que me ha sido asignada para mi estadía  en el hospital.\n\nDeclaro que  he leído  las disposiciones  y políticas  del hospital  en  relación  a la forma  en que debe  ser realizadas  tales decoraciones.\n\nMe comprometo  a cumplir con todos los requisitos y limitaciones en que se han informado. Acepto la responsabilidad por cualquier daño causado a las instalaciones o al mobiliario del hospital  con motivo  de la  colocación  o retiro  de los materiales y objetos de decoración.\n\n\n\nHabitación nº       "+cdo.getColValue("habitacion")+"         Firma: ________________________________________\n\nAprobado por: ____________________________________",3, dHeader.size());
