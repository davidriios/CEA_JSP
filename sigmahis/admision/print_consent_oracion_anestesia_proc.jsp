...
//control imgae
		...
		pc.addBorderCols("Fecha: "+fecha, 3, 2, 0.5f,0.0f,0.0f,0.0f);
		pc.addCols("",0, 8);
		...
		pc.addCols("\n", 1, dHeader.size());
		pc.addCols("4.	Doy mi consentimiento para la disposición de tejidos, partes o miembro que podrán ser desechados por autoridades  de _______________________________________________ o del Patólogo del mismo.",3, dHeader.size());
