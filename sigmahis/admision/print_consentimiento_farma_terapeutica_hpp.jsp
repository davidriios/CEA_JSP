...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String title = "COMITÉ DE FARMACIA Y TERAPÉUTICA (008)";
	String subTitle = "DISPOSICIÓN PARA LOS MEDICAMENTOS QUE TRAIGAN LOS PACIENTES";
	String xtraSubtitle = "ADMISIÓN"; //"DEL "+fechaini+" AL "+fechafin;
...
//control imgae
	...
	"de los medicamentos dispensados a los pacientes que ingresen al Hospital Punta Pacífica, "+
