...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subTitle = "CONSENTIMIENTO FOTOGRÁFICO";
	...
	sbBody.append("Los padres de el(los) recién nacido(s) dan su consentimiento para que el Hospital ");
	sbBody.append(_comp.getNombre());
	
	sbBody.append(" a través ");
	if (fg.trim().equals("HC")){
	   sbBody.append("de un funcionario de Relaciones Públicas, Admisión o Enfermería ");
	}else sbBody.append("  ..........................................................................................,");
	
	sbBody.append(" realice fotografías de su(s) bebé(s) nacido(s) en nuestro Hospital para uso únicamente de los padres como recordatorio del nacimiento de su(s) bebé(s).");
	...
	sbBody.append(_comp.getNombre());
	sbBody.append(" a incorporar las fotografía(s) tomadas de mi(s) bebé(s) en la Página Web del Hospital");
	
	if (fg.trim().equals("HC")){
	  sbBody.append(".");
	}
	else sbBody.append(", las cuales sólo podrán ser vistas a través de un usuario y contraseña que me proporcionarán sólo a mi persona a través de un correo electrónico, para poder acceder a las fotografías  y que podré compartir con mis familiares y amigos si sólo yo comparto dicha contraseña.");
	...
	pc.setFont(11, 1);	
    pc.addCols("\n\n\nAdjuntar copia de Cédula.", 0, dHeader.size());
