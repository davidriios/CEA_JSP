...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String title = "CONSENTIMIENTO GENERAL";
	String subtitle = "";
	String xtraSubtitle = " ";
	...
	pdfHeader(pc, _comp, xtraCompanyInfo, title, subtitle, xtraSubtitle, userName, fecha, dHeader.size());
		...
		pc.addCols("he venido al Hospital Punta Pacífica voluntariamente para realizarme los exámenes,",0,7);
		pc.addCols("tratamientos, procedimientos y/o cirugía que prescribe el médico.  Acepto igualmente seguir las Normas para pacientes",0,11);
		pc.addCols("que rigen en esta institución.",0,11);
		...
		pc.addCols("Firma:____________________________________",0,6); 		
