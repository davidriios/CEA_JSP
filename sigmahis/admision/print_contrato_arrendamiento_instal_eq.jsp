...
//control imgae
		...
		pc.addCols("\n\nEn reconocimiento y aceptación, firmamos hoy _______________ de ________________________ de _______________.", 1, dHeader.size());
		...
		pc.addCols(" ",1,2);
		pc.addBorderCols("EL PACIENTE",1,4,0.0f,0.5f,0.0f,0.0f);
