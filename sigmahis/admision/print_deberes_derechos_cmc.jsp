...
//{
   ...
   // PdfCreator pc = new PdfCreator(directory+folderName+"/"+year+"/"+month+"/"+fileName, width, height, isLandscape, sbFooter.toString(), leftRightMargin, topMargin, bottomMargin, headerFooterFont, logoMark, logoPath, statusMark, statusPath, displayPageNo, pageNoFontSize, pageNoLabel, pageNoPoxX, pageNoPosY);
	...
	pc.addCols(" ",0,dHeader.size());
			...
			pc.addCols("1.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Colaborar en el cumplimiento de las normas e instrucciones establecidas por el hospital, así como de informarse, conocer y respetar las reglas de funcionamiento.":"Collaborate with the compliance of all the norms and instructions established by the Hospital as well as inform him/herself, understand, and respect the regulations in the Hospital.",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("2.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Ayude en la prevención de la pérdida de objetos. Para ello, deje en su hogar aquellos objetos personales que sean de valor.":".",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("3.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Cumplir con las normas que prohíben fumar en las instalaciones del hospital, de esta manera preserva el área como una zona libre de humo.":".",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("4.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Tratar con el máximo respeto al personal del hospital y respetar los derechos de los  pacientes, familiares y visitantes; contemplando los horarios de visitas para así propiciar un ambiente de descanso, sanación y privacidad relacionado a su tratamiento.":".",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("5.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Cancelar las cuentas generadas por la atención recibida, proporcionando la información general y financiera necesaria. Firmar todos los consentimientos presentados al momento de su admisión y durante su hospitalización para la realización de procedimientos médicos.":".",0,1);
			...
			pc.addCols("8.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"Suministrar información sobre su estado físico o sobre su salud de manera leal y verdadera, así como colaborar con su obtención.":".",0,1);
			...
			pc.addCols("7.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"El Paciente tiene derecho a que se le asigne un médico cuyo nombre deberá conocer y que será su médico responsable y el interlocutor válido con el equipo de asistencia. En caso de ausencia de este facultativo, otro facultativo del equipo asumirá la responsabilidad.":"The Patient has the right to be assigned a physician whose name shall be known and that will be the responsible physician and valid liaison with the health team. In case this physician is absent another physician from the team will assume this responsibility. ",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("8.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"El Paciente tiene derecho a obtener constancia por escrito o en soporte técnico adecuado todo su proceso. Esta información y las pruebas realizadas constituyen el Expediente Clínico. Al finalizar su estancia en el Hospital, el paciente o el familiar que esté debidamente autorizado, recibirán copia del resumen de Egreso y del Plan de Salida del Paciente. Igualmente tiene derecho al acceso a la información recibida en el expediente clínico dentro de un tiempo razonable.":"The Patient has the right to have all his process recorded in writing or in digital format. This information and the test performed constitute the Medical Record.  At the end of the stay in the Hospital, the Patient or responsible family member will receive a copy of the Patient Discharge Summary and the Patient Discharge Plan. The Patient is also entitled to have access to the information in his/her Medical Record within a reasonable time.  ",0,1);

			pc.addCols(" ",0,dHeader.size());
			pc.setFont(11,1);
			pc.addCols("9.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"El Paciente tiene derecho a decidir que no se realicen a su persona investigaciones, experimentos o ensayos clínicos, sin una Información previa, sobre los métodos y fines del estudio y sin que este haya otorgado su libre consentimiento por escrito.":"The Patient has the right to decide whether or not research, experiments, or clinical trials are performed on his/her person without prior written consent and/or explaining of the methods and purposes of the study.",0,1);
			...
			pc.addCols("11.",0,2);
			pc.setFont(11,0);
			pc.addCols(lng.equalsIgnoreCase("es")?"El Paciente tiene derecho al correcto funcionamiento de los asistenciales y administrativos; que la estructura del Hospital proporcione unas condiciones aceptables de habitabilidad, higiene, alimentación, seguridad y respeto a su intimidad.":"The Patient has the right to receive proper functioning of the health services and administrative structure of the Hospital that provide acceptable conditions of habitability, hygiene, food, security and respect for their privacy.",0,1);
