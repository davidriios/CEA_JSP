...
//control imgae
		...
		dHeader.addElement("0.04");
		dHeader.addElement("0.16");
		dHeader.addElement("0.15");
		dHeader.addElement("0.10");
		dHeader.addElement("0.10");
		dHeader.addElement("0.11");
		dHeader.addElement("0.09");
		dHeader.addElement("0.10");
		dHeader.addElement("0.10");
		...
		pc.addCols(" ESTA PERMITIDO EL USO DE ADHESIVOS O CLAVOS EN DECORACIONES DE PAREDES O PUERTAS.",3, 8);
		pc.addCols("\n", 1, dHeader.size());
		
		pc.setFont(10, 0);
		pc.addCols("2.",0,1);
		pc.addCols("CUALQUIER DAÑO A LA INFRAESTRUCTURA DE LA HABITACION OCASIONADA POR LA COLOCACION DE",3, 9);
		pc.addCols(" ",0,1);
		pc.addCols("ARREGLOS DECORATIVOS O USO INDEBIDO DE LOS BIENES,",3, 5);
		pc.setFont(10, 1);
		pc.addBorderCols("SERA RESPONSABILIDAD DEL PACIENTE.",3, 4,0.5f,0.0f,0.0f,0.0f);
		pc.addCols("\n", 1, dHeader.size());
		...
		pc.addCols("5.",0,1);
		pc.addCols("AGRADECEMOS EVITAR LA VISITA DE BEBES O NIÑOS PEQUEÑOS A LAS",3, 6);
		pc.setFont(10, 1);
		pc.addBorderCols("HABITACIONES COMPARTIDAS",3, 3,0.5f,0.0f,0.0f,0.0f);
		pc.addCols(" ",0,1);
		pc.setFont(10, 0);
		pc.addCols("QUE PUEDAN PERTURBAR LA TRANQUILIDAD Y EL REPOSO DE LOS DEMAS PACIENTES.",3, 9);
		pc.addCols("\n", 1, dHeader.size());
		...
		pc.addCols("8.",0,1);
		pc.setFont(10, 1);
		pc.addCols("FUMAR ES NOCIVO PARA LA SALUD.",3, 3);
		pc.setFont(10, 0);
		pc.addCols("POR LO QUE NOS ESFORZAMOS POR EVITAR QUE LAS",3, 6);
		pc.addCols(" ",0,1);
		pc.addCols("PERSONAS FUMEN DENTRO DE NUESTRAS INSTALACIONES.",3, 9);
		pc.addCols("\n", 1, dHeader.size());
		...
		pc.addCols("\n", 1, dHeader.size());
		pc.setFont(10, 1);
		pc.addCols("FIRMA DE PERSONA RESPONSABLE: ____________________________",0, dHeader.size());
		pc.addCols("NO. CEDULA O PASAPORTE:                ____________________________",0, dHeader.size());
		/*
