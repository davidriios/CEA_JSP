...
issi.admin.ISSILogger.setSession(session);
	...
	String p_mes  	= request.getParameter("mes6");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "REPORTE DE PACIENTES HOSPITALIZADOS POR ESPECIALIDAD ";
...
{
	sql = "SELECT "+p_mes+" mes, em.descripcion as espe, m.primer_apellido||' '||m.primer_nombre as nombremedico, a.categoria as total FROM  tbl_adm_admision a, tbl_adm_categoria_admision c,tbl_adm_medico m, tbl_adm_medico_especialidad e, tbl_adm_especialidad_medica em WHERE a.medico=m.codigo and a.categoria =1 and a.categoria=c.codigo and m.codigo=e.medico and e.especialidad=em.codigo and to_number(to_char(a.fecha_ingreso,'mm')) = "+p_mes+" and to_number(to_char(a.fecha_ingreso,'yyyy')) =  "+p_anio+" ";	
