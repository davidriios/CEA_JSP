...
sql = "select id,codigo, descripcion,rango,decode(estatus,'A','Activo','I','Inactivo') as estatus from tbl_cds_cat_diagenfermera"+appendFilter+" order by descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_categoria_diagnotisco_enfermera";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "CATEGORIAS DE DIAGNOSTICOS ENFERMERA", userName, fecha);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.setFont(7, 0);
		pc.createTable();
			pc.addCols(" "+cdo.getColValue("id"),0,1,cHeight);
			pc.addCols(" "+cdo.getColValue("descripcion"),0,1,cHeight);
			pc.addCols(" "+cdo.getColValue("rango"),0,1,cHeight);
