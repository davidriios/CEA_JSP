...
sql = "SELECT codigo, descripcion FROM tbl_adm_categoria_admision "+appendFilter;
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_categoria_admision";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "CATEGORIAS DE ADMISION", userName, fecha);
