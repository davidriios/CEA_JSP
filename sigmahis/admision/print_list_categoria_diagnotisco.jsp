...
sql = "select codigo, descripcion,rango from tbl_cds_categoria_diag"+appendFilter+" order by descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_categoria_diagnotisco";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "CATEGORIAS DE DIAGNOSTICOS", userName, fecha);
