...
String tipoDesc =  request.getParameter("tipoDesc");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_clasific_admision";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "CLASIFICACION POR TIPO DE ADMISION", userName, fecha);
	...
	pc.createTable();
		...
		pc.addCols("[ "+catDesc+" ] "+tipoDesc,0,setDetail.size());
	pc.addTable();
