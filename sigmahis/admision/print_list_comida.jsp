...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_list_comida";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "COMIDA", userName, fecha);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.createTable();
			...
			pc.addCols(" "+tip.getStatus(),0,1,cHeight);
		pc.addTable();
		lCounter++;
