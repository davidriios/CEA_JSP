...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_list_documento";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "DOCUMENTO", userName, fecha);
	...
	pc.createTable();
		...
		pc.addBorderCols("Area de Revisión",1);
	pc.addTable();
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.createTable();
			...
			pc.addCols(" "+tip.getNombre(),0,1,cHeight);
			pc.addCols(" "+tip.getArea(),0,1,cHeight);
		pc.addTable();
		lCounter++;
