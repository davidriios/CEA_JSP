...
sql="select codigo, nombre from tbl_cds_enfermedad_notificable "+appendFilter+" order by nombre";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_enfermedad_notificable";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "ENFERMEDAD NOTIFICABLE", userName, fecha);
