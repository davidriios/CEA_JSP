...
sql = "SELECT codigo, descripcion, DECODE(tipo_personal,'M','MEDICO','E','EMPLEADO','S','SOCIEDAD MEDICA') as tipo, DECODE(status,'A','Activo','I','Inactivo') as status FROM tbl_cds_funcion WHERE codigo<>'0'"+appendFilter+" order by descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_funciones_personal";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "FUNCIONES DEL PERSONAL", userName, fecha);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.createTable();
			...
			pc.addCols(" "+cdo.getColValue("status"),1,1,cHeight);
		pc.addTable();
		lCounter++;
