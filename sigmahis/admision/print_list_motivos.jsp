...
if (fg == null) fg = "";
	...
	sql = "select a.codigo, a.descrip_motivo descripcion,decode(a.estado_motivo,'A','ACTIVO','I','INACTIVO') estado,observacion from tbl_sal_motivo_sol_proc a where codigo > 0 "+appendFilter;
	else
	sql = "select a.codigo, a.descrip_motivo descripcion,decode(a.estado_motivo,'A','ACTIVO','I','INACTIVO') estado from tbl_sal_cama_motivo a where a.compania ="+(String) session.getAttribute("_companyId")+appendFilter;
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "LISTADO DE MOTIVOS"+((fg.trim().equals("SP"))?" SOLICITUD DE PROCEDIMIENTOS":" DE DEMORA(CAMAS)");
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		else pc.addBorderCols("DESCRIPCIÓN",1,2);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		else pc.addCols(""+cdo.getColValue("descripcion"),0,2);
