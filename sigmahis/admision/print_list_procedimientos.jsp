...
sql = "select a.codigo, a.descripcion, nvl(a.observacion,'') as observacion, nvl(b.nombre,'SIN CATEGORIA') as categoria, nvl(a.precio,0) as precio,nvl(costo,0) as costo from tbl_cds_procedimiento a, tbl_cds_tipo_categoria b where a.tipo_categoria=b.codigo(+)"+appendFilter+" order by a.codigo";
...
PdfCreator pc = new PdfCreator(directory+folderName+"/"+year+"/"+month+"/"+fileName, width, height, isLandscape, sbFooter.toString(), leftRightMargin, topMargin, bottomMargin, headerFooterFont, logoMark, logoPath, statusMark, statusPath, displayPageNo, pageNoFontSize, pageNoLabel, pageNoPoxX, pageNoPosY);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.setFont(6, 0); 
			...
			pc.addCols(" "+cdo.getColValue("categoria"),0,1,cHeight);
