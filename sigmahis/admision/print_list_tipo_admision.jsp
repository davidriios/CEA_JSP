...
String codigoCat =  request.getParameter("codigoCat");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_tipo_admision";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "TIPOS DE ADMISION", userName, fecha);
	...
	pc.createTable();
		...
		pc.addCols("C A T E G O R I A :   [ "+codigoCat+" ] "+descripcionCat,0,2);
	pc.addTable();
