...
sql= "SELECT codigo, descripcion, cod_centro as centroCode, nvl(clave,' ') as clave FROM tbl_cds_clave_rx WHERE codigo<>0"+appendFilter+" order by descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_tipomovimiento";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "CLAVES O PLANTILLAS - RESULTADOS MEDICOS", userName, fecha);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.createTable();
			...
			pc.addCols(" "+cdo.getColValue("clave"),0,1,cHeight);
		pc.addTable();
		lCounter++;
