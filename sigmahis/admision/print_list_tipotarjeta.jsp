...
sql= "SELECT codigo, depositar,descripcion,observacion,comision FROM tbl_cja_tipo_tarjeta WHERE codigo<>0 "+appendFilter+" order by codigo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String fileNamePrefix = "print_list_tipotarjeta";
	...
	pdfHeader(pc, _comp, pCounter, nPages, "ADMISION", "TIPOS DE TARJETA", userName, fecha);
	...
	pc.createTable();
		...
		pc.addBorderCols("Depositar",1);
		pc.addBorderCols("Comision",1);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.createTable();
			...
			pc.addCols(" "+cdo.getColValue("depositar"),1,1,cHeight);
			pc.addCols(" "+cdo.getColValue("comision"),1,1,cHeight);
