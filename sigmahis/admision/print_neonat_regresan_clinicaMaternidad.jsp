...
<!--          "Particular y Regresaron a la Clínica (MATERNIDAD) "    -->
<!-- Reporte: ADM70022_B                                              -->
...
+" ae.ginecologo as ginecologo, ae.tipo_evento evento, ev.descripcion descEvento "
...
+" (ae.tipo_evento = ev.codigo and ae.tipo_encuesta = '1') and "
+" (aca.codigo = aa.categoria) and (aa.centro_servicio = cds.codigo) "
+" AND ae.provincia||ae.sigla||ae.tomo||ae.asiento =  ap.provincia||ap.sigla||ap.tomo||ap.asiento "
+" AND aa.fnac_madre is null AND aa.cpac_madre is null AND aa.admi_madre is null "+appendFilter1
...
+" to_char(aa.fecha_egreso,'dd-mm-yyyy'), ae.ginecologo, ae.tipo_evento, ev.descripcion "
+" order by  ae.tipo_evento, ev.descripcion,6,2,3,4,1 ";
//2,3,4,1 ";  
...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subtitle = "PERSONAS QUE REGRESARON A LA CLÍNICA (MATERNIDAD)";
