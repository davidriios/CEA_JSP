...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String title = "NOTIFICACIÓN DE HONORARIOS MÉDICOS";
...
//------------------------------------------------------------------------------------
String conFinancieroBody = "Por medio de la presente hacemos constar que los Honorarios Médicos "+" son independientes al funcionamiento interno, políticas y costo de las facilidades del Hospital Punta Pacífica,\n\n"+
        "Es necesario que usted converse con cada uno de los médicos encargados de su caso,"+
        " referente al tema del costo de sus servicios, previo a la realización de su procedimiento y/o cirugía.\n\n"+
	"Acepto que he sido informado por parte de un funcionario del Hospital Punta Pacífica"+
	" acerca de los Honorarios Médicos, en cuanto a la necesidad de orientación tocante a los mismos.\n\n\n\n";
