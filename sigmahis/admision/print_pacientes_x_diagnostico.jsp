...
<!-- ADMISION                                 -->
<!-- Reporte: "LISTADO DE PACIENTES X DIAGNÓSTICO" -->
<!-- Reporte: ADM_10035                       -->
...
//-------------------------------------------------------------------------------------------------------//
//--------------Query para obtener los Pacientes x Diagnóstico ----------------------------------------//
...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subtitle = "PACIENTES POR DIAGNÓSTICO";  
   ...
   //pc.setNoColumnFixWidth(dHeader);		
		...
		pc.addBorderCols("CÉDULA / PASAP.",1,1,cHeight,Color.lightGray);
		pc.addBorderCols("PID / ADMISIÓN",1,1,cHeight,Color.lightGray);
	...
	// Fin --- Agrupamiento x Diagnóstico	    
