...
<!-- Reporte: "Listado de Pacientes Hospitalizados x Sección"  -->
...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subtitle = "PACIENTES HOSPITALIZADO POR SECCIÓN  "; 
      ...
      if(!groupBy.equalsIgnoreCase("[ "+cdo.getColValue("codSala")+" ] "+cdo.getColValue("descSala")))
	    {
		  if (i != 0)  
		   {//i-1
			 ...
			 pc.addCols("PACIENTES X HABITACIÓN:                     "+pxcath+"                                                                                                TOTAL X HABITACIÓN:                   "+"$"+CmnMgr.getFormattedDecimal(varPrecioxhab),0,dHeader.size(),cHeight);	 			 
			 pc.addCols("TOTAL DE PACTS. X SALA O SECCIÓN: "+ pxs+"                                                                                                TOTAL DE HABITACION X SALA:   "+"$"+CmnMgr.getFormattedDecimal(varPrecioxsala),0,dHeader.size(),cHeight);
			 pc.addCols(" ",0,dHeader.size(),cHeight);			
			 pxcath = 0;
			 pxs    = 0;
			 varPrecioxhab  = 0;	
