...
sbSql.append("select p.id as combo_id, p.nombre as combo_name, decode(p.estado,'I','INACTIVO','A','APROBADO','N','NUEVO') as combo_status from tbl_cds_combo_cargo p");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(cdo.getColValue("combo_id"),1,1);
		pc.addCols(cdo.getColValue("combo_name"),0,1);
		pc.addCols(cdo.getColValue("combo_status"),1,1);
	}
	if (al.size() == 0)
	{
