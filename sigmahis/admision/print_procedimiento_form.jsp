...
//{
	...
	pc.addBorderCols("Nueva fecha de Ingreso x Corte de Cuenta: "+cdo.getColValue("fechaIngreso"),0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Dirección Residencial: "+cdo.getColValue("direc"),0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Ciudad y Estado: "+(cdo.getColValue("ciudadEstado") !=null&& (cdo.getColValue("ciudadEstado")).length()<=1?"N/A":cdo.getColValue("ciudadEstado")),0,2,0.5f,0.5f,0.5f,0.5f,24f);
	
	
	pc.addBorderCols("Estado Civil: "+cdo.getColValue("estado_civil"),0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Tel. Paciente: "+cdo.getColValue("telefono"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Ocupación Paciente: "+cdo.getColValue("puesto"), 0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Empleador: "+cdo.getColValue("empleador"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	
	pc.addBorderCols("Tel. Empleador: "+cdo.getColValue("telefoTrabajo"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Dirección Empleador: "+cdo.getColValue("direccion_trabajo"),0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Contacto Emergencia: "+cdo.getColValue("contactoUrgencia"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Tel. Contacto: "+cdo.getColValue("telefonoUrgencia"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	
	//BTLR
	
	pc.addBorderCols("Responsable Cta: "+cdo.getColValue("responsabilidad"),0,3,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Tel. Responsable Cta: "+(cdo.getColValue("responsabilidad") != null && cdo.getColValue("responsabilidad").equals("PACIENTE")?cdo.getColValue("telefono"):"N/A"), 0,3,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Lugar Nac Pac.: "+cdo.getColValue("lugarnaci"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Nacionalidad: "+cdo.getColValue("nacionalidad"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	
	pc.addBorderCols("Nombre, Apellido Padre: "+cdo.getColValue("nombrePadre"), 0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Nombre, Apellido Madre: "+cdo.getColValue("nombreMadre"), 0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols(" ", 1,2,0.5f,0.5f,0.5f,0.5f,24f);
	
	pc.addBorderCols("Nombre Cónyuge: "+cdo.getColValue("nombreConyuge"), 0,4,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Tel. Cónyuge: "+cdo.getColValue("telefoTrabajoConyuge"), 0,2,0.5f,0.5f,0.5f,0.5f,24f);
	pc.addBorderCols("Lugar Trabajo Cónyuge: "+cdo.getColValue("lugarTrabajoConyugue"), 0,4,0.5f,0.5f,0.5f,0.5f,24f);
	
	pc.addCols(" ",1,container.size());
	
	pc.setFont(6,1);
		pc.addCols("PREFERENCIAS Y/O NECESIDADES",1,container.size(),15f);
		
		pc.setFont(7,0);
	
	pc.addBorderCols(""+cdo.getColValue("preferencia"," "),0,container.size(),0.5f,0.5f,0.5f,0.5f,30f);
	...
	pc.createTable("diag_princ",false,0,0.0f,550f);
