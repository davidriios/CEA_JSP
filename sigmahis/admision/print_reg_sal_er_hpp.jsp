...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	pc.addBorderCols("Direccion Empleador: N/A",0,2,0.0f,0.5f,0.5f,0.5f);	
	pc.addBorderCols("Direc. Pac.: "+cdo.getColValue("direc"),0,2,0.5f,0.5f,0.5f,0.5f);
	pc.addBorderCols("Ciudad/Estado: "+((cdo.getColValue("ciudadEstado")).length()<=1?"N/A":cdo.getColValue("ciudadEstado")),0,2,0.5f,0.5f,0.5f,0.5f);
	pc.addBorderCols("Estado Civil:   "+cdo.getColValue("estado_civil"),0,2,0.5f,0.5f,0.5f,0.5f);
		
	pc.addBorderCols("Contacto ER: "+cdo.getColValue("contactoUrgencia"),0,2,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Teléfono ER: "+cdo.getColValue("telefonoUrgencia"),0,2,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Dir. ER: "+cdo.getColValue("direcUr"),0,2,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Resp. Cta.: "+cdo.getColValue("nombreResp"),0,2,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Tel. Resp. Cta.: "+cdo.getColValue("telResp"),0,2,0.5f,0.5f,0.5f,0.5f); 
		
	pc.addBorderCols("Dir. Resp. Cta.: "+cdo.getColValue("dirResp"),0,4,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Tel. Pac.: "+cdo.getColValue("telefono"),0,2,0.5f,0.5f,0.5f,0.5f); 
	pc.addBorderCols("Lug. de Nac.: "+cdo.getColValue("lugarnaci"),0,2,0.5f,0.5f,0.5f,0.5f); 
