...
//{
	...
	pc.addCols("REFERENCIAS DE CREDITO",1,dHeader.size());

	pc.setFont(10,2);
	pc.addCols("David, "+cdo.getColValue("curr_date"),0,dHeader.size());
