...
{
    var opciones="toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1002,height=620,top=5,left=default";
...
<script language="javascript">document.title="Solicitud Crédito - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="4" align="right"><a href="javascript:openwin('solicitudcredito_config.jsp');" ><font class="Link00">[ Registrar Nueva Solicitud de Cr&eacute;dito ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td>&nbsp;12-01-2007</td>
		<td>&nbsp;ACTIVO</td>
		<td><a href="javascript:openwin('solicitudcredito_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Editar</a></td>
	</tr>							
