...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, nombre,rango FROM tbl_cds_tipo_categoria"+appendFilter+" ORDER BY nombre";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cds_tipo_categoria"+appendFilter);
...
document.title = 'Tipo Categoría - '+document.title;

function add()
{
	abrir_ventana('tipocategoria_config.jsp');
}

function edit(code)
{
	abrir_ventana('tipocategoria_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_tipocategoria.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CLÍNICA - ADMISIÓN - MANTENIMIENTO - TIPO CATEGORÍA"></jsp:param>
</jsp:include>

<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
	    		<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Tipo Categor&iacute;a</cellbytelabel> ]</a></authtype>
	      </td>
    </tr>
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">	                    
					...
					<%=fb.hidden("fromPage",request.getContextPath()+request.getServletPath())%>
 				    <%=fb.hidden("toPage",request.getContextPath()+request.getServletPath())%>
				    <td width="50%"><cellbytelabel id="3">Nombre</cellbytelabel>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextHeader" align="center">
					...
					<td width="57%"><cellbytelabel id="3">Nombre</cellbytelabel></td>
					<td width="13%"><cellbytelabel id="8">Rango</cellbytelabel></td>
					<td width="10%">&nbsp;</td>
				</tr>				
				<%
