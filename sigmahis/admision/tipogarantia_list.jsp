...
500025	VER LISTA DE TIPOS DE GARANTIAS
500026	IMPRIMIR LISTA DE TIPOS DE GARANTIAS
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_adm_tipo_garantia"+appendFilter);
...
document.title = 'Tipo de Garantía - '+document.title;

function add()
{
	abrir_ventana('tipogarantia_config.jsp');
}

function edit(code)
{
	abrir_ventana('tipogarantia_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_tipogarantia.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
	    		<authtype type='3'><a href="javascript:add()" class="Link00">[ Registrar Nuevo Tipo de Garant&iacute;a ]</a></authtype>
	    	</td>
    </tr>
	<tr>
		<td>
