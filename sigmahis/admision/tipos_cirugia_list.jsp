...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	sql = "select codigo, descripcion from tbl_cdc_tipo_cirugia"+appendFilter+" order by codigo";
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from  tbl_cdc_tipo_cirugia"+appendFilter);
...
document.title = 'Tipos de Cirugía - '+document.title;

function add()
{
	abrir_ventana('../admision/tipos_cirugia_config.jsp');
}

function edit(id)
{
	abrir_ventana('../admision/tipos_cirugia_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../admision/print_list_tipo_cirugia.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="ADMISION - TIPOS DE CIRUGÍA"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Tipo de Cirug&iacute;a</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
