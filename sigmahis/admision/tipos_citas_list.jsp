...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	sql = "select codigo, descripcion from tbl_cdc_tipo_cita"+appendFilter+" order by codigo";
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from tbl_cdc_tipo_cita"+appendFilter);
...
document.title = 'Tipos de Citas - '+document.title;

function add()
{
	abrir_ventana('../admision/tipos_citas_config.jsp');
}

function edit(id)
{
	abrir_ventana('../admision/tipos_citas_config.jsp?mode=edit&id='+id);
}
function uso(id)
{
	abrir_ventana('../inventario/pension_x_tipo_cita.jsp?mode=edit&tipoId='+id);
}
function printList()
{
	abrir_ventana('../admision/print_list_tipo_citas.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="ADMISION - TIPOS DE CITAS"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Uso</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="70%"><cellbytelabel id="3">Descripci&oacute;n</cellbytelabel></td>
			<td width="10%">&nbsp;</td>
			<td width="10%">&nbsp;</td>
		</tr>
<%
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td align="center">
<%if(fg != null && fg.trim().equals("SOP")){%>
			<authtype type='4'><a href="javascript:uso(<%=cdo.getColValue("codigo")%>)" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel id="9">Uso de SOP</cellbytelabel></a></authtype>
<%}%>
			</td>
		</tr>
<%
