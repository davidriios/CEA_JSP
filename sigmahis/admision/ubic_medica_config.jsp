...
if (!(SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"500019") || SecMgr.checkAccess(session.getId(),"500020"))) throw new Exception("Usted no tiene los suficientes Derechos de Acceso a esta página.");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (code == null) throw new Exception("La Ubicación Médica no es válido. Por favor intente nuevamente!");
...
document.title = 'Ubicación Médica Edición - '+document.title;
</script>
</head>
