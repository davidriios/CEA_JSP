    ...
    <table class="table table-hover table-sm" style="font-size:12px !important">
        ...
        <tbody>
			...
			for (int i = 0; i < al.size(); i++){
			  ...
			  String baseResUrl = "http://192.168.31.68/ZFP?mode=proxy&titlebar=on&lights=on#View&ris_pat_id=@@pat_pid_number@@&ris_exam_id=@@accession_number@@&un=PORTALCHSF&pw=BPgUQJuq8tk82rQJCISKSO5JgQ%2fhduqGun5qz55BuPRBycl%2bQzCGLiu5kFEHdbtT";
			  ...
			  baseResUrl = baseResUrl.replaceAll("@@pat_pid_number@@", cdo.getColValue("pid")).replaceAll("@@accession_number@@", cdo.getColValue("num_orden"));
