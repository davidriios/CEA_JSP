...
function showReporte(fg)
{
  ...
  if(fg=='PEA'){ 
   // var almacen    = eval('document.form0.wh').value;
	...
	abrir_ventana('../compras/print_list_ordencompra_art.jsp?fp=RP&fDate='+fecha_i+'&tDate='+fecha_f+'&familia='+familia+'&clase='+clase+'&articulo='+articulo+'&proveedor='+proveedor+'&depto='+depto+'&titulo='+titulo+'&subclase='+subclase+'&anio='+anio_oc+'&numOc='+num_oc);

}else {
    
    abrir_ventana('../compras/print_list_ordencompra_prov.jsp?fp=RP&fDate='+fecha_i+'&tDate='+fecha_f+'&familia='+familia+'&clase='+clase+'&articulo='+articulo+'&proveedor='+proveedor+'&depto='+depto+'&titulo='+titulo+'&subclase='+subclase+'&anio='+anio_oc+'&numOc='+num_oc);
}
}
...
<td class="TableLeftBorder TableTopBorder TableBottomBorder TableRightBorder">		
		...
		<tr class="TextFilter">
			...
			<td><%=fb.textBox("anio_oc","",false,false,false,5)%>  Numero de Orden:<%=fb.textBox("num_oc","",false,false,false,5)%> </td>
		</tr>
		<tr class="TextHeader">
			<td>&nbsp;</td>
