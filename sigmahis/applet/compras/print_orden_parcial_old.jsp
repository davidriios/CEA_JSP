...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	pc.createTable(true);
		...
		pc.createInnerTable();
			...
			pc.addInnerTableCols("Fecha de entrega: "+cdo.getColValue("fecha_entrega"),0,5);
