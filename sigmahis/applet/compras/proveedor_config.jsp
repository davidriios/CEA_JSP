...
<%=fb.hidden("fg",fg)%>
		...
		<tr class="TextRow01">
			...
			<td colspan="3"><%=fb.select("localInt","1=LOCALES,2=IMPORTACIONES",cdo.getColValue("local_internacional"),true,false,(viewMode||viewModeConta),0,null,null,null,null,"S")%></td>
		</tr>
		<tr class="TextRow01">
