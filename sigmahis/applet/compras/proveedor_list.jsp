...
<%=fb.hidden("toPage",request.getContextPath()+request.getServletPath())%>
			<td width="100%">
                ...
                Tipo Prov.:<%=fb.select(ConMgr.getConnection(), "select tipo_proveedor, descripcion||' - '||tipo_proveedor as descripcion from tbl_com_tipo_proveedor", "tipo_prov",tipo_prov,false,false,0,null,"width:120px",null,null,"S")%>
				<cellbytelabel>Tipo Persona</cellbytelabel>
				...
				Vetado:<%=fb.select("vetado","S=SI,N=NO",vetado,false,false,false,0,null,null,null,null,"T")%>
                Cuenta:<%=fb.select("cuenta","S=SI,N=NO",cuenta,false,false,false,0,null,null,null,null,"T")%>
				<%=fb.submit("go","Ir")%>
			</td>
<%=fb.formEnd(true)%>
		</tr>
...
<tr>
	<td align="right"> <authtype type='50'> <a href="javascript:printList('CTA')" class="Link00">[ <cellbytelabel>Imprimir Lista Con Cuenta</cellbytelabel> ]</a></authtype>
