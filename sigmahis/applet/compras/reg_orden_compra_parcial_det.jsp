...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	else
	{
		...
		if (change==null || change.equals("null")){
			...
			else sbSql.append(", (select itbm from tbl_inv_articulo where cod_articulo = a.cod_articulo and cod_clase = a.cod_clase and cod_familia = a.cod_familia and compania = a.compania) as itbm");
			sbSql.append(", (select cod_medida from tbl_inv_articulo where cod_articulo = a.cod_articulo and cod_clase = a.cod_clase and cod_familia = a.cod_familia and compania = a.compania) as unidad");
			sbSql.append(", (select ");
			...
			sbSql.append("descripcion from tbl_inv_articulo where cod_articulo = a.cod_articulo and cod_clase = a.cod_clase and cod_familia = a.cod_familia and compania = a.compania) as articulo");
			if (viewMode) sbSql.append(", a.impuesto");
			else sbSql.append(", (select decode(itbm,'S',nvl(other5,0),0) from tbl_inv_articulo where cod_articulo = a.cod_articulo and cod_clase = a.cod_clase and cod_familia = a.cod_familia and compania = a.compania) as impuesto");
