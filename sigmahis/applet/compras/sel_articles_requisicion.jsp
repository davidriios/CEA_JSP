...
if (request.getMethod().equalsIgnoreCase("GET")) {
	...
	sbSql.append("select 'CS' as art_origen, to_char(z.requi_anio) as requi_anio, to_char(z.requi_numero) as requi_numero, y.cod_familia as cod_flia, y.cod_clase, y.cod_articulo, y.cantidad, y.precio_cotizado, y.especificacion, x.cod_provedor, nvl(getCantArtTramite(z.compania,z.codigo_almacen,y.cod_articulo),0) as cant_tramite, getlastprecioprovprueba(y.compania, ");
	...
	sbSql.append(", (select cod_subclase from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as cod_subclase");
	sbSql.append(", (select descripcion from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as articulo");
	sbSql.append(", (select cod_medida from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as cod_medida");
	sbSql.append(", (select itbm from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as itbm");
	sbSql.append(", (select other1 from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as other1");
	sbSql.append(", (select other2 from tbl_inv_articulo where compania = y.compania and cod_flia = y.cod_familia and cod_clase = y.cod_clase and cod_articulo = y.cod_articulo) as other2");
...
<div id="_cContent" class="ContainerContent">
		...
		<tr class="TextHeader">
			...
			<td width="20%" align="center" colspan="3"><cellbytelabel>C&oacute;digo</cellbytelabel></td>
			...
			<td width="10%" align="center" rowspan="2"><cellbytelabel>Und. Compra</cellbytelabel></td>
			<td width="10%" align="center" rowspan="2"><cellbytelabel>Cantidad</cellbytelabel></td>
			<td width="10%" align="center" rowspan="2"><cellbytelabel>Cant. Tr&aacute;mite</cellbytelabel></td>
...
<% } else { %>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td align="center">
			<%=fb.checkbox("chkArt"+i,""+i, false, false, "", "", onClick)%>
			</td>
		</tr>
<% } %>
<% } %>
<% if (al.size() == 0) { %>
		<tr><td align="center" colspan="7"><cellbytelabel>No registros encontrados</cellbytelabel>.</td></tr>
<% } %>
		</table>
</div>
</div>
