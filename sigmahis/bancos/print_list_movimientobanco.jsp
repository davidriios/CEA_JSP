...
if (compania == null) compania = "";
  ...
  sql.append("select distinct  ' [ ' ||a.cod_banco || ' ] '||c.nombre  nombre, a.cod_banco as banco, a.cuenta_banco as cuenta,a.descripcion,a.compania  FROM  tbl_con_cuenta_bancaria a, tbl_con_banco c WHERE a.compania=c.compania and a.cod_banco=c.cod_banco");
  ...
  sql.append(" order by a.compania,a.cod_banco asc");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "BANCOS CON MOVIMIENTOS BANCARIOS";
	String xtraSubtitle = "";
