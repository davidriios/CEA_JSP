...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	sbSql.append("select * from (select rownum as rn, a.* from (");
		sbSql.append("select a.codigo, a.descripcion,b.cta1||'.'||b.cta2||'.'||b.cta3||'.'||b.cta4||'.'||b.cta5||'.'||b.cta6 cuenta,nvl((select descripcion from tbl_con_catalogo_gral cg where cg.cta1||'.'||cg.cta2||'.'||cg.cta3||'.'||cg.cta4||'.'||cg.cta5||'.'||cg.cta6=b.cta1||'.'||b.cta2||'.'||b.cta3||'.'||b.cta4||'.'||b.cta5||'.'||b.cta6 and cg.compania=b.compania ),' ') descCuenta from tbl_cja_forma_pago a, tbl_cja_forma_pago_cta b where a.codigo=b.codigo(+) and b.compania(+)=");
...
function edit(id){abrir_ventana('../caja/reg_forma_pago_cta.jsp?mode=edit&id='+id);} 
function printList(){abrir_ventana('../caja/print_forma_pago_list_cta.jsp?appendFilter=<%=IBIZEscapeChars.forURL(sbFilter.toString())%>');}
</script>
</head>
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td align="center">
				<authtype type='50'><a href="javascript:edit(<%=cdo.getColValue("codigo")%>)" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel>Cuenta Contable</cellbytelabel></a></authtype>
