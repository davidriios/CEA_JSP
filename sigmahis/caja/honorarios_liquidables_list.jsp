...
document.title = 'Caja - Honorarios Liquidables - '+document.title;

function add()
{
	abrir_ventana('../facturacion/honorarios_liquidables.jsp');
}

function edit(id)
{
	abrir_ventana('../facturacion/honorarios_liquidables.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../facturacion/print_list_honorarios_liquidables.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CAJA - HONORARIOS LIQUIDABLES"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Honorarios Liquidables</cellbytelabel> ]</a>
<%
//}
%>
		</td>
