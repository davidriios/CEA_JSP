...
//sql = "SELECT a.cta1, a.cta2, a.cta3, a.cta4, a.cta5, a.cta6, b.descripcion as cuenta FROM tbl_con_conta_transaccion_cta a, tbl_con_catalogo_gral b WHERE a.cta1=b.cta1 and a.cta2=b.cta2 and a.cta3=b.cta3 and a.cta4=b.cta4 and a.cta5=b.cta5 and a.cta6=b.cta6 and a.compania=b.compania and a.codigo="+id+" and a.compania="+(String) session.getAttribute("_companyId");
 ...
 sql= "SELECT c.codigo, c.descripcion, a.cta1, a.cta2, a.cta3, a.cta4, a.cta5, a.cta6, b.descripcion as cuenta FROM tbl_con_conta_transaccion_cta a, tbl_con_catalogo_gral b, tbl_cja_tipo_transaccion c WHERE a.cta1=b.cta1 and a.cta2=b.cta2 and a.cta3=b.cta3 and a.cta4=b.cta4 and a.cta5=b.cta5 and a.cta6=b.cta6 and a.compania=b.compania and a.codigo=c.codigo"+appendFilter+"  and a.compania="+(String) session.getAttribute("_companyId")+" order by c.descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_ctas_tipotransaccion";
...
for (int j=1; j<=nPages; j++)
{
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("CAJA",1,1);
					pc.addCols("CTAS. CONTABLES ASOCIADAS A TIPO DE TRANSACCIONES", 1, 1);
				pc.addTable();
...
//				pc.addTable();
				...
				pc.createTable();
					...
					pc.addBorderCols("Cuenta Contable",1);
				pc.addTable();


				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe la Cuenta Contable seleccionada",1,5);
						pc.addTable();
						}
				else{
					if (al.size() > 0)
					{
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
						    CommonDataObject cdo1 = (CommonDataObject) al.get(i);
								...
								//id = cdo1.getColValue("codigo");

						nom_cuenta = cdo1.getColValue("cta1")+"-"+cdo1.getColValue("cta2")+"-"+cdo1.getColValue("cta3")+"-"+cdo1.getColValue("cta4")+"-"+cdo1.getColValue("cta5")+"-"+cdo1.getColValue("cta6")+"  "+cdo1.getColValue("cuenta");

								pc.createTable();
								pc.setFont(7, 0);
									pc.addCols(" "+cdo1.getColValue("codigo"),1,1);
									pc.addCols(" "+cdo1.getColValue("descripcion"),0,1);
									pc.addCols(" "+nom_cuenta,0,1);
								pc.addTable();
