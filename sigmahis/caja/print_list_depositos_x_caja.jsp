...
sql =  "SELECT codigo, descripcion, decode(estado,'A','Activo','I','Inactivo') as estado, ubicacion "
+ "  FROM tbl_cja_cajas "
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_depositos_x_caja";
...
for (int j=1; j<=nPages; j++)
{
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Caja",1,1);
					pc.addCols("CONSULTA DEPÓSITOS POR CAJA", 1, 1);
				pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Depósito de Caja seleccionado",1,5);
						pc.addTable();
