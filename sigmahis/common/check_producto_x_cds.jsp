...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (fp.equalsIgnoreCase("convenio_exclusion_detalle") || fp.equalsIgnoreCase("pm_convenio_exclusion_detalle"))
	{
		sql = "select codigo, descripcion from tbl_cds_producto_x_cds where cod_centro_servicio="+centroServicio+" and tser='"+tipoServicio+"'"+appendFilter+" order by descripcion";
		al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
		rowCount = CmnMgr.getCount("select count(*) from tbl_cds_producto_x_cds where cod_centro_servicio="+centroServicio+" and tser='"+tipoServicio+"'"+appendFilter+"");
	}
...
document.title = 'Productos x CDS - '+document.title;
</script>
</head>
<body topmargin="0" leftmargin="0" rightmargin="0">
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="SELECCION DE PRODUCTOS X CDS"></jsp:param>
</jsp:include>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="1" cellspacing="1">
				<tr class="TextHeader" align="center">
					...
					<td width="10%"><%=fb.checkbox("check","",false,false,null,null,"onClick=\"javascript:checkAll('"+fb.getFormName()+"','check',"+al.size()+",this,0)\"","Seleccionar todos los productos x cds listados!")%></td>
				</tr>				
				<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center"><%=( (fp.equalsIgnoreCase("convenio_exclusion_detalle")||fp.equalsIgnoreCase("pm_convenio_exclusion_detalle")) && vExclDet.contains(cdo.getColValue("codigo")))?"Elegido":fb.checkbox("check"+i,cdo.getColValue("codigo"),false,false)%></td>
				</tr>
<%
}
%>
	...
	if (fp.equalsIgnoreCase("convenio_exclusion_detalle") || fp.equalsIgnoreCase("pm_convenio_exclusion_detalle"))
	{
		for (int i=0; i<size; i++)
		{
			if (request.getParameter("check"+i) != null)
			{
				...
				ed.setSecuencia("0");
				ed.setCdsProducto(request.getParameter("codigo"+i));
...
{
<%
	if (fp.equalsIgnoreCase("convenio_exclusion_detalle"))
	{
%>
