...
if (request.getParameter("tLastLineNo") != null) tLastLineNo = Integer.parseInt(request.getParameter("tLastLineNo"));
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="SELECCION DE TIPOS DE HABITACIÓN"></jsp:param>
</jsp:include>
