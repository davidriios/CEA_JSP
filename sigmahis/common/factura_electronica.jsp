...
String ruc = request.getParameter("ruc_cedula");
String dv = request.getParameter("dv_nuevo");
...
String namefactura = request.getParameter("nombre_2");
...
String q_enca = "SELECT " +
                ...
                "    (  " +
                      ...
                      "            '' " +
                      "    END AS \"ADDINFO\", " +
                      "    REPLACE(GETMONTOCENTROTERCERO2(A.CODIGO, A.COMPANIA), '=', '') AS \"TRAILER\", " +
...
String q_Payments = "SELECT " +
                    ...
                    "   AND EXISTS (SELECT NULL FROM TBL_FAC_TRX T WHERE T.OTHER3 = '" + docNo + "' AND T.DOC_ID = B.DOC_ID AND t.company_id = " + ((String) session.getAttribute("_companyId")) +
					" ) " +
...
if (docType.equalsIgnoreCase("DGI")) {//I M P R E S O R A   F I S C A L
	...
	if (actType.equalsIgnoreCase("2")) {
        ...
        try {
			...
			BigDecimal prueba = new BigDecimal("0.00");
		    ...
		    System.out.println("JEANRIOS d_enca " + d_enca.size());
			System.out.println("JEANRIOS d_items " + d_items.size());
			System.out.println("JEANRIOS d_Payments " + d_Payments.size());
			System.out.println("JEANRIOS d_ubicacion " + d_ubicacion.size());
			System.out.println("JEANRIOS d_WS_FactElec " + d_WS_FactElec.size());
			System.out.println("JEANRIOS compania " +	compania);
			System.out.println("JEANRIOS tipo " + tipo);
			System.out.println("JEANRIOS ruc " + ruc );
			System.out.println("JEANRIOS dv " + dv );
			System.out.println("JEANRIOS e_mail " + e_mail);
			System.out.println("JEANRIOS tipocliente " +  tipocliente );
			System.out.println("JEANRIOS ubicacion_fe " +  ubicacion_fe );
	        ...
	        for (int i=0; i<d_items.size(); i++)
            {
                ...
                //if (1 == 1) throw new Exception("PRUEBA");
                ...
                Item itemFE = new Item(
                      ...
                      , new BigDecimal(precioItem).setScale(2, RoundingMode.HALF_UP).toString() //String precioItem Precio del em. Si el em no es valorable: informar campo en 0.00 PrecioItem <> Cantidad * (PrecioUnitario - PrecioUnitarioDescuento)
           ...
           ArrayList<FormaPago> listaFormaPago = new ArrayList<FormaPago>();
            ...
            String ruc_cliente_fe = request.getParameter("ruc_cedula"); //cdoE.getColValue("CustomerRUC");
            ...
            Cliente cliente = new Cliente(
                ...
                , tipocliente.equals("02")?null:((cdoE.getColValue("TIPO_CLIENTEFE").equals("01")||tipocliente.equals("03"))?request.getParameter("ruc_cedula"):null) //String numeroRUC
                , tipocliente.equals("02")?null:((cdoE.getColValue("TIPO_CLIENTEFE").equals("01")||tipocliente.equals("03"))?dv:null) //String digitoVerificadorRUC
                , namefactura//String razonSocial
            ...
            String tipoDocumento = "01"; //Inicialmente factura normal
             ...
             //   }
           // }
                System.out.println("Entro aqui "+cdoE.getColValue("AddInfo"));
