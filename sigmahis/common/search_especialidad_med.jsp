...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	if(fp.equalsIgnoreCase("addEspecialista")){

		sql="select codigo, descripcion from tbl_adm_especialidad_medica "+appendFilter+" order by codigo ";
...
document.title = 'Laboratorios - '+document.title;
</script>
<script language="javascript" >

<% if(fp.equalsIgnoreCase("addEspecialista")){ %>
function especialidad(id,descripcion){
	 window.opener.document.form001.especialidad_id.value = id;
 	 window.opener.document.form001.especialidad.value = descripcion;
	 window.close();
	}
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="LABORATORIOS"></jsp:param>
</jsp:include>
...
%>
				...
				<tr class="<%=color%>" onClick="javascript:especialidad('<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("descripcion")%>')" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" style="cursor:pointer">
