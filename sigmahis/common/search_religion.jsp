...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	sbSql.append("select codigo, descripcion from tbl_adm_religion where codigo is not null");
	sbSql.append(sbFilter);
	sbSql.append(" order by 2");
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sbSql.toString()+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_adm_religion where codigo is not null"+sbFilter.toString());
...
function returnValue(k)
{
	...
	var desc=eval('document.result.descripcion'+k).value;
<%
if (fp.equalsIgnoreCase("paciente"))
{
%>
	window.opener.document.form0.religionCode.value=code;
	window.opener.document.form0.religion.value=desc;
	window.close();
<%
}
%>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="SELECCION DE RELIGION"></jsp:param>
</jsp:include>
