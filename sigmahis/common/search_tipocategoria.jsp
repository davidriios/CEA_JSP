...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, nombre FROM tbl_cds_tipo_categoria"+filter+appendFilter+" ORDER BY nombre";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cds_tipo_categoria WHERE codigo<>0 "+filter+appendFilter);
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
            ...
            <%=fb.formStart(true)%>
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:returnValue(<%=i%>,1)">
