...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  {
    appendFilter += (appendFilter.equals("")?" where ":" and ")+" upper(codigo) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    searchOn = "codigo";
  ...
  {
    appendFilter += (appendFilter.equals("")?" where ":" and ")+" upper(descripcion) like '%"+request.getParameter("descripcion").toUpperCase()+"%'";
  ...
  else if (request.getParameter("searchQuery") != null && !request.getParameter("searchOn").equals("Todos") && (!request.getParameter("searchVal").equals("SV") || (!request.getParameter("searchValFromDate").equals("SVFD") && !request.getParameter("searchValToDate").equals("SVTD"))) && !request.getParameter("searchType").equals("ST"))
  {
		...
		{
			appendFilter += (appendFilter.equals("")?" where ":" and ")+" upper("+searchOn+") like '%"+searchVal.toUpperCase()+"%'";
		}
  }
  else
  {
	...
	if (fp.equalsIgnoreCase("cod_axa"))
	{
		sql = "select codigo, descripcion, observacion from fac_codigo_pamd " + appendFilter;
...
document.title = 'Códigos Axa - '+document.title;
...
<%
	...
	{
%>
		window.opener.document.form.cod_hna<%=index%>.value = eval('document.formAxa.codigo'+i).value;
		window.opener.document.form.desc_hna<%=index%>.value = eval('document.formAxa.descripcion'+i).value;
<%
    }
%>
		window.close();
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="1" cellspacing="1" class="sortable" id="expe">
				...
				<%
				fb = new FormBean("formAxa",request.getContextPath()+"/common/urlRedirect.jsp");
				%>
				<%=fb.formStart()%>
				<%
