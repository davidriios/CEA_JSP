...
function doSearch(){
  ...
  window.location = "../common/sel_consentimiento.jsp?pacId="+pacId+"&noAdmision="+noAdmision+"&search="+q+'&consetimiento=<%=consetimiento%>&exp=<%=exp%>';
}
</script>
</head>
...
function closeWindow(){
	...
	document.location = "../common/sel_consentimiento.jsp?pacId=<%=pacId%>&noAdmision=<%=noAdmision%>&pac_id=<%=pacId%>&no_adm=<%=noAdmision%>&consetimiento=<%=consetimiento%>&exp=<%=exp%>";
}
</script>
</head>
