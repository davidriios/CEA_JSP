...
if ((almacen=='' || codArticulo == '') && value=="3" )
{
{alert('Algún parámetro: Almacen o Artículo sin Valor.. Revise.. '); return false;}
}
...
<tr>
	...
	<tr class="TextFilter">
		...
		<td width="50%"> <cellbytelabel>Art&iacute;culo</cellbytelabel> <%=fb.intBox("codigo","",false,false,false,10,10)%>
