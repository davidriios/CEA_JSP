...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_tipo_proveedor";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Compras",1,1);
					pc.addCols("MANTENIMIENTO TIPO DE PROVEEDORES", 1, 1);
				pc.addTable();
				...
				if (al.size()==0) 
					{
						pc.createTable();
							pc.addCols("No existe el Tipo de Proveedor seleccionado",1,5);
						pc.addTable();
					}
				else
				{
