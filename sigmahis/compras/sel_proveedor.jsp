...
<%
	}else if (fp.equalsIgnoreCase("nentrega") )
	{
%>
	window.opener.document.search01.codProv.value = eval('document.detail.code'+i).value;
	window.opener.document.search01.descProv.value = eval('document.detail.desc'+i).value;
<%
	}
