...
System.out.println("Geetesh Printing list page of cuentas");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT a.codigo_prin as codigo, a.descripcion as descripcion FROM tbl_con_ctas_prin a "+appendFilter;
...
{
  window.opener.document.form1.codigoPrin.value = code;
  window.opener.document.form1.cuentaPrin.value = name;
  window.close();
}
</script>
</head>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">&nbsp;<a href="javascript:add('<%=cdo.getColValue("codigo")%>', '<%=cdo.getColValue("descripcion")%>')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Seleccionar</a></td>
				</tr>
				<%
				}
				%>							
