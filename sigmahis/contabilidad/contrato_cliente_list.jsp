...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion FROM tbl_cxc_cliente_particular where compania="+ (String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
document.title = 'Cliente Particular - '+document.title;

function returnValue(code, name)
{
   window.opener.document.form1.clienteCode.value = code;
   window.opener.document.form1.cliente.value = name;
   window.close();
}
</script>
</head>
