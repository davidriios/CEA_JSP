...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  {
    appendFilter += " and upper(cod_alquiler) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    searchOn = "cod_alquiler";
  ...
  sql = "SELECT cod_alquiler as codigo, descripcion FROM tbl_cxc_alquileres WHERE compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cxc_alquileres WHERE compania="+(String) session.getAttribute("_companyId")+appendFilter);
