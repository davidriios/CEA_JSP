...
document.title = 'Tipo Alquiler - '+document.title;
function returnValue(code, name, indexCode, indexName)
{
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">					
					<a href="javascript:returnValue(<%=cdo.getColValue("codigo")%>,'<%=cdo.getColValue("descripcion")%>','<%=indexCode%>','<%=indexName%>')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Seleccionar</a>				
					</td>					
				</tr>
				<%
				}
