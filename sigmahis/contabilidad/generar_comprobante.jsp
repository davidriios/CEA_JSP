...
function eject(accion){
	...
	else if(accion=='REPLIBING13')abrir_ventana('../cellbyteWV/report_container.jsp?reportName=contabilidad/rpt_ingreso_x_fact_desc_det.rptdesign&fechaIni='+fechaIni+'&fechaFin='+fechaFin);
