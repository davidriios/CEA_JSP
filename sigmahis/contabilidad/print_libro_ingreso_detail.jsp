...
String descCat ="TODAS LAS CATEGORIAS";
...
if (admType.trim().equals("I"))descCat="INGRESOS - IP";else if (admType.trim().equals("O"))descCat="INGRESOS - OP";

		sql.append("select  r.cta1||'-'||r.cta2||'-'||r.cta3||'-'||r.cta4||'-'||r.cta5||'-'||r.cta6  cuenta, r.cta1,r.cta2,r.cta3,r.cta4,r.cta5,r.cta6,r.lado,sum(nvl(r.montos,0)) monto,c.descripcion,r.tipo from tbl_con_libro_ingresos r, tbl_con_catalogo_gral c where r.compania = ");
	...
	if(!admType.trim().equals("")){sql.append("and r.adm_type ='");sql.append(admType);sql.append("'");}


		
	sql.append(" and c.compania = r.compania and c.cta1 = r.cta1 and c.cta2 = r.cta2 and c.cta3 = r.cta3 and c.cta4 = r.cta4 and c.cta5 = r.cta5 and c.cta6 = r.cta6 group by r.lado,r.cta1,r.cta2,r.cta3,r.cta4,r.cta5,r.cta6,c.descripcion,r.tipo order by r.cta1,r.cta2,r.cta3,r.cta4,r.cta5,r.cta6,r.tipo");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "LIBRO DE INGRESOS - "+descCat;
