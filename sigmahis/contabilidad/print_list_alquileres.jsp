...
sql = "SELECT a.cod_alquiler as codigo, a.descripcion, b.descripcion as tipo, a.estatus "
 + " FROM tbl_cxc_alquileres a, tbl_cxc_tipo_alquiler b "
 + " WHERE a.cod_tipo_alq=b.cod_tipo_alq and a.compania=b.compania "
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_alquileres";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("MANTENIMIENTO DE ALQUILERES", 1, 1);
				pc.addTable();
...
//				pc.addTable();
				...
				if (al.size()==0) {
						...
						pc.createTable();
							pc.addCols("No existe el Alquiler seleccionado",1,5);
						pc.addTable();
