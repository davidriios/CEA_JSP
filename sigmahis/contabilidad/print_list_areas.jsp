...
sql = "SELECT codigo, descripcion FROM tbl_con_pres_area "+appendFilter+" order by descripcion";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("MANTENIMIENTO ÁREAS", 1, 1);
				pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Área seleccionada",1,5);
						pc.addTable();
