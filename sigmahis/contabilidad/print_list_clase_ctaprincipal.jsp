...
sql = "SELECT a.codigo_clase as codigo, a.descripcion, a.codigo_prin as codigoPrin, b.descripcion as cuentaPrin "
+ " FROM tbl_con_cla_ctas a, tbl_con_ctas_prin b "
+ " WHERE a.codigo_prin=b.codigo_prin"+appendFilter
+ " order by a.codigo_prin, a.codigo_clase, a.descripcion";
			     ...
			     setHeader0.addElement(".2");
					...
					pc.createTable();
					  pc.setFont(9, 1);
						...
						pc.addCols("MANTENIMIENTO CLASES DE CUENTAS", 1,1);
					pc.addTable();
					...
					pc.createTable();
					  pc.addBorderCols("Cuenta Principal",0);
					...
					if (al.size()==0)
					 {
					  pc.createTable();
						  pc.addCols("No existe la Cuenta seleccionada");
						pc.addTable();
					 }
					 else
					 {
							  ...
							  for(int i= ((maxLines * j) - maxLines); i<(maxLines * j) ;i++)
							    {
								  CommonDataObject cdol = (CommonDataObject) al.get(i);
									...
									pc.createTable();
									  pc.setFont(7, 0);
										pc.addCols(" "+cdol.getColValue("cuentaPrin"),0,1);
