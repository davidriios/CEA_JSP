...
sql =   "SELECT a.secuencia, a.codigo, b.descripcion as tipoOtro, a.cta1, a.cta2, a.cta3, a.cta4, a.cta5, a.cta6,  a.cta1||'-'||a.cta2||'-'||a.cta3||'-'||a.cta4||'-'||a.cta5||'-'||a.cta6 as ctaFinanciera, c.descripcion as cuenta "
+ " FROM tbl_fac_otros_x_cuenta a, tbl_fac_tipo_otros b, tbl_con_catalogo_gral c "
+ " WHERE a.codigo=b.codigo and a.compania=b.compania "
+ " and a.cta1=c.cta1 and a.cta2=c.cta2 and a.cta3=c.cta3 and a.cta4=c.cta4 and a.cta5=c.cta5 and a.cta6=c.cta6 "
+ " and a.compania=c.compania and a.compania="+(String) session.getAttribute("_companyId")+appendFilter;
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		int maxLines = 10; //max lines of items
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("CUENTAS RELACIONADAS A OTROS TIPOS DE CARGOS", 1, 1);
				pc.addTable();
...
//				pc.addTable();
				...
				pc.createTable();
					...
					pc.addBorderCols("Tipo Otros",0);
					pc.addBorderCols("Cta. Financiera",0);
					pc.addBorderCols("Descrip. Cuenta",0);
				pc.addTable();
			...
			//	pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Cargo seleccionado",1,5);
						pc.addTable();
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
						    CommonDataObject cdo1 = (CommonDataObject) al.get(i);
								...
								pc.setFont(7, 0);
									...
									pc.addCols(" "+cdo1.getColValue("tipoOtro"),0,1);
