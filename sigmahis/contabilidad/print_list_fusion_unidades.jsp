...
sql = "SELECT a.unidad, a.descripcion, a.unidad_fusion, b.descripcion as fusion "
 + " FROM tbl_con_pres_fusion a, tbl_sec_unidad_ejec b "
 + " WHERE a.unidad_fusion=b.codigo and a.compania_uni_fusion=b.compania "
 + " and a.compania="+(String) session.getAttribute("_companyId")+appendFilter
			     ...
			     setHeader0.addElement(".2");
					...
					pc.createTable();
					  pc.setFont(9, 1);
						...
						pc.addCols("FUSIÓN DE UNIDADES", 1,1);
					pc.addTable();
					...
					pc.createTable();
					  pc.addBorderCols("Unidad Administrativa",0);
						pc.addBorderCols("Pasar a Unidad Administrativa",0);
					pc.addTable();
					...
					if (al.size()==0)
					 {
					  pc.createTable();
						  pc.addCols("No existe la Unidad o Fusión seleccionada");
						pc.addTable();
					 }
					 else
					 {
							  ...
							  for(int i= ((maxLines * j) - maxLines); i<(maxLines * j) ;i++)
							    {
									  CommonDataObject cdol = (CommonDataObject) al.get(i);
										...
										pc.createTable();
										  pc.setFont(7, 0);
											pc.addCols(" "+cdol.getColValue("unidad")+ " - " + cdol.getColValue("descripcion"),0,1);
											pc.addCols(" "+cdol.getColValue("unidad_fusion")+ " - " + cdol.getColValue("fusion"),0,1);
										pc.addTable();
