...
sql =  "SELECT a.codigo, a.descripcion, a.cod_rep, b.descripcion as reporte FROM tbl_con_grupos_rep a, tbl_con_reporte b WHERE a.cod_rep=b.codigo and a.cod_rep="+repCode+" and a.compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by a.descripcion";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("MANTENIMIENTO GRUPO DE REPORTES", 1, 1);
				pc.addTable();
...
//				pc.addTable();
			...
			//	pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Grupo de Reporte seleccionado",1,5);
						pc.addTable();
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
						    CommonDataObject cdo1 = (CommonDataObject) al.get(i);
								...
								pc.setFont(7, 0);
									...
									pc.addCols(" "+cdo1.getColValue("reporte"),0,1);
								pc.addTable();
