...
String tipoReporte = (request.getParameter("tipoReporte")==null?"":request.getParameter("tipoReporte"));
String codigo = (request.getParameter("codigo")==null?"":request.getParameter("codigo"));
String descripcion = (request.getParameter("descripcion")==null?"":request.getParameter("descripcion"));
String estadoAlquiler = "";  //variable que guarda el estatus del Alquiler A=libre I=ocupado
if (appendFilter == null) appendFilter = "";

/* if (tipoReporte.equals("")) {appendFilter+="  and nvl(tipo_reporte,'0') <> 'C'";}else{appendFilter+=" and tipo_reporte = 'C'";} */
if (tipo.equals("")) {appendFilter+="  and nvl(tipo_reporte,'0') <> 'C'";}else{appendFilter+=" and tipo_reporte = 'C'";}
if (!codigo.equals("")) appendFilter+=" and codigo = "+codigo;
if (!descripcion.equals("")) appendFilter += " and upper(descripcion) like '%"+descripcion.toUpperCase()+"%'";
...
sql = "SELECT codigo, descripcion FROM tbl_con_reporte where compania = "+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_reportes_consolidados";
	...
	//				pc.setNoColumnFixWidth(setHeader2);
					...
					pc.createTable();
					  pc.setFont(9, 1);
						...
						pc.addCols("MANTENIMIENTO REPORTES CONSOLIDADOS", 1,1);
					pc.addTable();
					...
					if (al.size()==0)
					 {
					  pc.createTable();
						  pc.addCols("No existe el Reporte seleccionado");
						pc.addTable();
					 }
					 else
					 {
							  ...
							  for(int i= ((maxLines * j) - maxLines); i<(maxLines * j) ;i++)
							    {
								      ...
								      no += 1;
										...
										pc.createTable();
										  pc.setFont(7, 0);
										  pc.addCols(" "+cdol.getColValue("codigo"),0,1);
