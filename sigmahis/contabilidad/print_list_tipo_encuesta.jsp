...
sql = "SELECT codigo_encuesta as codigo, descrip_encuesta as descripcion FROM tbl_adm_tipo_encuesta "+appendFilter
+ " order by descrip_encuesta ";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_tipo_encuesta";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("MANTENIMIENTO TIPOS DE ENCUESTA", 1, 1);
				pc.addTable();
...
//				pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Tipo de Encuesta seleccionada",1,5);
						pc.addTable();
						}
				else{
					if (al.size() > 0)
