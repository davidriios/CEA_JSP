...
sql = "SELECT tipo_inv as codigo, descripcion FROM tbl_con_tipo_inversion "+appendFilter+" order by descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_tipo_inversion";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Contabilidad",1,1);
					pc.addCols("MANTENIMIENTO TIPOS DE INVERSIÓN", 1, 1);
				pc.addTable();
...
//				pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el Tipo de Inversión seleccionada",1,5);
						pc.addTable();
						}
				else{
					if (al.size() > 0)
