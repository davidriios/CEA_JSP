...
function returnValue(op,code,name)
{
   ...
   {
       case 1:
	        window.opener.document.form1.moduloCode.value = code;
			window.opener.document.form1.modulo.value = name;
			window.close();
	   break;		
   }
}
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<table align="center" width="100%" cellpadding="0" cellspacing="1">
			...
			%>
			<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:returnValue(<%=id%>,<%=cdo.getColValue("cod_modulo")%>,'<%=cdo.getColValue("descripcion")%>')">
