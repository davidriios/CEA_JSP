...
//if (!(SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"900071") || SecMgr.checkAccess(session.getId(),"900072"))) throw new Exception("Usted no tiene los suficientes Derechos de Acceso a esta página.");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (id == null) throw new Exception("El Tipo de Alquiler no es válido. Por favor intente nuevamente!");
...
document.title="Tipo Alquiler Edición - "+document.title;
<%}%>
</script>
