...
{
	abrir_ventana2('../common/check_articulo.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}

function showUsoList()
{
	abrir_ventana2('../common/check_uso.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}

function showProcedimientoList()
{
	abrir_ventana2('../common/check_procedimiento.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}

function showOtrosCargosList()
{
	abrir_ventana2('../common/check_otroscargos.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}

function showTipoHabitacionList()
{
	abrir_ventana2('../common/check_tipo_habitacion.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}

function showMedicoList()
{
	abrir_ventana2('../common/check_empresa_medico.jsp?fp=convenio_cobertura_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoCobertura%>&ce=<%=cobertura%>&ceDetLastLineNo=<%=cobDetLastLineNo%>&tipoServicio=<%=tipoServicio%>');
}
