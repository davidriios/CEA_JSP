...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT DISTINCT codigo, descripcion FROM tbl_adm_tipo_empresa WHERE codigo NOT IN(1,4)"+appendFilter+" order by descripcion";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT DISTINCT count(*) FROM tbl_adm_tipo_empresa WHERE codigo NOT IN(1,4)"+appendFilter);
...
{
  window.opener.document.form1.tipoEmpCode.value = code;
  window.opener.document.form1.tipoEmp.value = desc;
  window.close();
}
</script>
</head>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				...
				%>
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:add(<%=cdo.getColValue("codigo")%>,'<%=cdo.getColValue("descripcion")%>')">
