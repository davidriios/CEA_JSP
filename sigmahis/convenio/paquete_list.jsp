...
document.title = 'Transacciones - Paquetes - '+document.title;

function add()
{
	abrir_ventana('../convenio/paquete_config.jsp');
}

function edit(id)
{
	abrir_ventana('../convenio/paquete_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../convenio/print_list_paquete.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="TRANSACCIONES - PAQUETES"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevos Paquetes</cellbytelabel> ]</a>
<%
//}
%>
		</td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="60%"><cellbytelabel>Paquete</cellbytelabel></td>
