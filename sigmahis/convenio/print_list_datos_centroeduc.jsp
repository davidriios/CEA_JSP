...
String estadoEmpresa = "";  //variable para el estado de la empresa A=activo I=inactivo

if (appendFilter == null) appendFilter = "";

sql="select empresa, secuencia as code, nombre as name, poliza, monto_limite as monto from tbl_adm_centros_educativos "+appendFilter+"order by nombre";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
	...
	String subtitle = "CENTROS EDUCATIVOS POR EMPRESA";
	String xtraSubtitle = "";
	...
	pc.addBorderCols("No. Póliza",1);
	pc.addBorderCols("Monto Límite",1);

	pc.setTableHeader(3);

	if (al.size()==0) {
		pc.addCols("No existe este Centro Educativo",1,setHeader2.size());
	}
	else{
		...
		for (int i=0; i<al.size(); i++)
		{
			...
			pc.addCols(" "+cdo1.getColValue("poliza"),2,1) ;
