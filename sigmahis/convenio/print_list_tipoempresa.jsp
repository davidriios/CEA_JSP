...
sql = "SELECT codigo as codEmp, descripcion nomEmp FROM tbl_adm_grupo_empresa"+appendFilter+" order by descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
	...
	String subtitle = "TIPOS DE EMPRESA";
	String xtraSubtitle = "";
	...
	if (al.size()==0) {
		pc.addCols("No existen empresas registradas",1,5);
	}
	else{
		...
		for (int i=0; i<al.size(); i++)
		{
			...
			pc.setFont(7, 0);
			pc.addCols(" "+cdo1.getColValue("codEmp"),0,1);
			pc.addCols(" "+cdo1.getColValue("nomEmp"),0,1);
		}//End For
