...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	if (!descrip.trim().equals("")) { sbFilter.append(" and upper(descripcion) like '%"); sbFilter.append(descrip.toUpperCase()); sbFilter.append("%'"); }

	sbSql.append("SELECT codigo, descripcion FROM tbl_adm_grupo_empresa");
...
document.title = 'Tipo de Empresa - '+document.title;
function add(){abrir_ventana('../convenio/tipoempresa_config.jsp');}
function edit(code){abrir_ventana('../convenio/tipoempresa_config.jsp?mode=edit&code='+code);}
function printList(){abrir_ventana('../convenio/print_list_tipoempresa.jsp?appendFilter=<%=IBIZEscapeChars.forURL(sbFilter.toString())%>');}
...
<tr>
	<td align="right"><authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Tipo Empresa</cellbytelabel> ]</a></authtype></td>
</tr>
<tr>
	<td>
...
<%=fb.hidden("toPage",request.getContextPath()+request.getServletPath())%>
			...
			<td width="50%">
				...
				<%=fb.textBox("descrip",descrip,false,false,false,40)%>
				<%=fb.submit("go","Ir")%>
			</td>
<%=fb.formEnd()%>
		</tr>
...
<tr>
	<td align="right"><authtype type='2'><a href="javascript:printList()" class="Link00">[ <cellbytelabel>Imprimir Lista</cellbytelabel> ]</a></authtype></td>
</tr>
<tr>
