<cellbytelabel></cellbytelabel><%@ page errorPage="../error.jsp"%>
...
document.title = 'Analista / Cobranza - '+document.title;

function add()
{
	abrir_ventana('../cxc/analista_cobranza_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/analista_cobranza_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_analista.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - ANALISTA / COBRANZA"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Analista/Cobranza</cellbytelabel> ]</a>
<%
//}
%>
		</td>
...
%>
				...
				<td width="40%" align="right">R<cellbytelabel>egistros desde</cellbytelabel> <%=pVal%> <cellbytelabel>hasta</cellbytelabel> <%=nVal%></td>
<%
