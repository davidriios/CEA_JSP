...
<script language="javascript">document.title="Comisión por Tipo Analista - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="4" align="right"><a href="javascript:openwin('comision_tipo_config.jsp');" ><font class="Link00">[ <cellbytelabel>Registrar Nueva Comisi&oacute;n x Tipo</cellbytelabel> ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
		<td width="15%">&nbsp;<cellbytelabel>C&oacute;digo</cellbytelabel></td>
		<td width="35%"><input type="text" name="codigo" size="30">&nbsp;<input type="button" name="btncodigo" value="Ir"></td>
		<td width="15%">&nbsp;<cellbytelabel>Descripci&oacute;n</cellbytelabel></td>
		<td width="35%"><input type="text" name="descripcion" size="35">&nbsp;<input type="button" name="btndesc" value="Ir"></td>		
	</tr>
</table>
<br/>	
<table align="center" width="100%" cellpadding="0" cellspacing="0">
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td><a href="javascript:openwin('comision_tipo_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel>Editar</cellbytelabel></a></td>
	</tr>							
