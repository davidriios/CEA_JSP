...
{
    var opciones="toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1002,height=280,top=5,left=default";
...
<script language="javascript">document.title="Cuadro de Autorizaciones - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="4" align="right"><a href="javascript:openwin('cuadro_auto_config.jsp');" ><font class="Link00">&nbsp;[ <cellbytelabel>Registrar Nuevo Cuadro de Autorizaci&oacute;n</cellbytelabel> ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
		<td width="10%">&nbsp;<cellbytelabel>C&eacute;dula</cellbytelabel></td>
		<td width="40%"><input type="text" name="cedula" size="45">&nbsp;<input type="button" name="btncod" value="Ir"></td>
		<td width="10%">&nbsp;<cellbytelabel>Nombre</cellbytelabel></td>
		<td width="40%"><input type="text" name="nombre" size="45">&nbsp;<input type="button" name="btnnombre" value="Ir"></td>
	</tr>	
</table>
<br/>	
<table align="center" width="100%" cellpadding="0" cellspacing="0">
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader">
	    ...
	    <td width="25%">&nbsp;<cellbytelabel>Apellido</cellbytelabel></td>
	...
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td>&nbsp;XXXXXXXX</td>
		<td>&nbsp;XXXXXXXX</td>		
		<td>&nbsp;<a href="javascript:openwin('cuadro_auto_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel>Editar</cellbytelabel></a></td>
    </tr>							
