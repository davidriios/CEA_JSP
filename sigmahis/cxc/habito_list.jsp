...
document.title = ' Cuentas por Cobrar - Habitos de Pago - '+document.title;

function add()
{
	abrir_ventana('../cxc/habito_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/habito_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_habito.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - HÁBITOS DE PAGO"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo H&aacute;bitos de Pago</cellbytelabel> ]</a>
<%
//}
%>
		</td>
