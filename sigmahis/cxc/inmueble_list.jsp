...
document.title = ' Cuentas por Cobrar - Inmuebles - '+document.title;

function add()
{
	abrir_ventana('../cxc/inmueble_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/inmueble_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_inmueble.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - INMUEBLES"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Inmueble</cellbytelabel> ]</a>
<%
//}
%>
		</td>
