...
document.title = ' Cuentas por Cobrar - Contrato de Alquiler - '+document.title;

function add()
{
	abrir_ventana('../cxc/inmueble_medico_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/inmueble_medico_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_inmueble_medico.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - CONTRATO DE ALQUILER"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Contrato de Alquiler</cellbytelabel> ]</a>
<%
//}
%>
		</td>
