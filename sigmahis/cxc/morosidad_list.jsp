...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
	...
	else if (request.getParameter("inmueble") != null)
	{
		appendFilter += " where upper() like '%"+request.getParameter("inmueble").toUpperCase()+"%'";

    searchOn = "";
    searchVal = request.getParameter("inmueble");
    searchType = "1";
    searchDisp = "Inmueble";
	}
...
document.title = ' Cuentas por Cobrar - Consulta de Morosidad Por Paciente - '+document.title;

function add()
{
	abrir_ventana('../cxc/morosidad_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/morosidad_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_morosidad.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - CONSULTA DE MOROSIDAD POR PACIENTE"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Consulta de Morosidad por Paciente</cellbytelabel> ]</a>
<%
//}
%>
		</td>
...
%>
				...
				<%=fb.hidden("toPage",request.getContextPath()+request.getServletPath())%>
				<td width="50%">
					<cellbytelabel>Inmueble</cellbytelabel>
					<%=fb.textBox("inmueble","",false,false,false,30)%>
					<%=fb.submit("go","Ir")%>
				</td>
				<%=fb.formEnd()%>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="70%"><cellbytelabel>Inmueble</cellbytelabel></td>
			<td width="10%">&nbsp;</td>
		</tr>
<%
