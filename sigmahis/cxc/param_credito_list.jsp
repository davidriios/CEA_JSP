...
document.title = ' Cuentas por Cobrar -  Parámetros de Crédito - '+document.title;

function add()
{
	abrir_ventana('../cxc/param_credito_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/param_credito_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_param_credito.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - PARÁMETROS DE CRÉDITO"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Par&aacute;metros de Cr&eacute;dito</cellbytelabel> ]</a>
<%
//}
%>
		</td>
