...
sql = "select tipo, descripcion, comision from tbl_cxc_tipo_analista"+appendFilter+" order by tipo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPO DE ANALISTA / COBRANZAS";
	String xtraSubtitle = "";
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(cdo.getColValue("comision"),1,1);
