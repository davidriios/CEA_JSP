...
{
    var opciones="toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1002,height=370,top=5,left=default";
...
<script language="javascript">document.title="Tipo Cobranza - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="4" align="right"><a href="javascript:openwin('tipo_cobranza_config.jsp');" ><font class="Link00">[ <cellbytelabel>Registrar Nuevo Tipo Cobranza</cellbytelabel> ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
		<td width="15%">&nbsp;<cellbytelabel>Tipo</cellbytelabel></td>
		<td width="35%"><input type="text" name="tipo" size="20">&nbsp;<input type="button" name="btntipo" value="Ir"></td>
		<td width="15%">&nbsp;<cellbytelabel>Encargado</cellbytelabel></td>
		<td width="35%"><input type="text" name="encargado" size="35">&nbsp;<input type="button" name="btnencargado" value="Ir"></td>		
	</tr>
</table>
<br/>	
<table align="center" width="100%" cellpadding="0" cellspacing="0">
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader">
	    <td width="5%">&nbsp;</td>
		<td width="20%">&nbsp;<cellbytelabel>Tipo Cobro</cellbytelabel></td>
		<td width="65%">&nbsp;<cellbytelabel>Encargado</cellbytelabel></td>		
		<td width="10%">&nbsp;</td>
	</tr>
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td><a href="javascript:openwin('tipo_cobranza_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel>Editar</cellbytelabel></a></td>
	</tr>							
