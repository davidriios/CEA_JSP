...
<script language="javascript">document.title="Tipo Inmueble Edición - "+document.title;</script>
...
<!--STYLE UP-->	
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextHeader">
					<td colspan="2" align="left">&nbsp;<cellbytelabel>Tipo de Inmueble</cellbytelabel></td>
				</tr>				
				<tr class="TextRow01" >
					<td width="18%">&nbsp;<cellbytelabel>C&oacute;digo</cellbytelabel></td>
					<td width="82%">&nbsp;<input type="text" name="codigo" size="20" value=""></td>
				</tr>							
				<tr class="TextRow02" >
				...
				<tr>
					<td colspan="2" align="right"><input type="button" name="cancel" value="Cancelar" onClick="javascript:window.close()">&nbsp;<input type="button" name="save" value="Guardar" onClick="javascript:window.close()"></td>
				</tr>	
