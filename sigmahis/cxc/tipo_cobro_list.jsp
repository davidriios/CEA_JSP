...
<script language="javascript">document.title="Tipo Cobro - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="4" align="right"><a href="javascript:openwin('tipo_cobro_config.jsp');" ><font class="Link00">&nbsp;[ <cellbytelabel>Registrar Nuevo Tipo de Cobro</cellbytelabel> ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
		<td width="15%">&nbsp;<cellbytelabel>C&oacute;digo</cellbytelabel></td>
		<td width="35%"><input type="text" name="codigo" size="20">&nbsp;<input type="button" name="btncod" value="Ir"></td>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td><a href="javascript:openwin('tipo_inmueble_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel>Editar</cellbytelabel></a></td>
    </tr>							
