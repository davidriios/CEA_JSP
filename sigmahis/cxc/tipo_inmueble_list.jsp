...
document.title = ' Cuentas por Cobrar - Tipo de Inmueble - '+document.title;

function add()
{
	abrir_ventana('../cxc/tipo_inmueble_config.jsp');
}

function edit(id)
{
	abrir_ventana('../cxc/tipo_inmueble_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../cxc/print_list_tipo_inmueble.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - TIPOS DE INMUEBLE"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Tipos de Inmuebles</cellbytelabel> ]</a>
<%
//}
%>
		</td>
