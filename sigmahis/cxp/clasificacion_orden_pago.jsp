                ...
                <td><table align="center" width="100%" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                      <td><table width="100%" cellpadding="1" cellspacing="0">
                          ...
                          <tr class="TextPanel">
                            <td>&nbsp;<cellbytelabel>Clasificaci&oacute;n de Ordenes de Pago</cellbytelabel></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                      <td><iframe name="itemFrame" id="itemFrame" frameborder="0" align="center" width="100%" height="300" scrolling="yes" src="../cxp/clasificacion_orden_pago_det.jsp?fp=<%=fp%>&fg=<%=fg%>&mode=<%=mode%>"></iframe></td>
                    </tr>
                    <tr class="TextRow02">
                      <td align="right"> 
