...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	float height = 72 * 7.362f;//530.064
	...
	float ckdHeight = 72 * 3.6745f;//264.564

	Vector dHeader = new Vector();
		dHeader.addElement("77");
		dHeader.addElement("215");
		dHeader.addElement("80");
		dHeader.addElement("15");
		dHeader.addElement("33");
		dHeader.addElement("90");
	...
	for (int i=0; i<htCK.size(); i++) {
		...
		pc.createTable("detail",true);
			...
			pc.addCols(" ",0,1,57.0f,null,0.0f,0.1f,0.0f,0.0f);
