	...
	*/
	...
	for (int i=0; i<htCK.size(); i++){
		...
		pc.createTable();
				...
				pc.setFont(12, 0);
				pc.addCols(cdoCK.getColValue("num_cheque"),2,5);
				pc.addCols(" ",0,1);
