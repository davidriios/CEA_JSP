...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	for (Enumeration e = iAnexo.keys(); e.hasMoreElements();)
	{
		...
		//} else {
			...
			sbSql.append(" num_renglon FROM (select SUM (dck.monto_renglon) monto_renglon, dck.cuenta1||dck.cuenta2||dck.cuenta3||dck.cuenta4 as cuenta, dck.descripcion, nvl(dck.descripcion, ct.descripcion)||decode('");
			...
			//sbSql.append(cdo.getColValue("renglon"));
			sbSql.append(" GROUP BY dck.cuenta1 || dck.cuenta2 || dck.cuenta3 || dck.cuenta4, dck.descripcion, nvl(dck.descripcion, ct.descripcion), dck.num_factura, ck.cod_compania HAVING SUM (dck.monto_renglon) > 0 order by dck.num_factura, 2) a");
