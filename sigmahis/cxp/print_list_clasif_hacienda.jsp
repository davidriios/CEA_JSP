...
if (appendFilter == null) appendFilter = "";
 ...
 sql= "SELECT cod_hacienda codigo, descripcion, observacion FROM tbl_cxp_clasif_hacienda"+appendFilter+" order by cod_hacienda";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "CLASIFICACION DE ECONOMIA Y FINANZAS ";
	String xtraSubtitle = "";
