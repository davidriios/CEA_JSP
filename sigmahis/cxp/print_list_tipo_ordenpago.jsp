...
if (appendFilter == null) appendFilter = "";
 ...
 sql= "SELECT cod_tipo_orden_pago codigo, descripcion, observacion FROM tbl_cxp_tipo_orden_pago"+appendFilter+" order by cod_tipo_orden_pago";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE ORDENES DE PAGO ";
	String xtraSubtitle = "";
