...
<!-- CXP                                      -->
<!-- Reporte: "Solic. de Orden de Pago x Beneficiario: " -->
<!-- Reporte: OP_0006.rdf                     -->
...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	String subtitle = "POR BENEFICIARIO";
	...
	for (int i=0; i<al.size(); i++)
	{
	   ...
	   if (!groupBy.equalsIgnoreCase(cdo.getColValue("unidad_adm1")))  
	   {
	   		if (i != 0)
			{
				...
				pc.addCols("Total por Unidad ",2,2);
			...
			pc.setFont(8, 1,Color.blue);
	   	    pc.addCols("    "+cdo.getColValue("descBeneficiario"),0,5);					
	   }	   
	    else
		if (!groupBy2.equalsIgnoreCase(cdo.getColValue("beneficiario")))
	   {
	   		//if (i != 0)
			//{		
			pc.setFont(7, 1,Color.red);
			pc.addCols("Total por Beneficiario ",2,2);
	   ...
	   if (!groupBy3.equalsIgnoreCase("[ "+cdo.getColValue("fecha")+" ] "+cdo.getColValue("documento")))
	   {
	   				
			pc.setFont(7, 1,Color.red); 
			pc.addCols(" ",0,dHeader.size());
			//pc.addCols(" ",2,1);//beneficiario
			//pc.addCols(" ",0,2);			
			//pc.addCols(" ",0,dHeader.size());  			
			//pc.addCols("Total      "+montoProv,2,5);	
			//montoProv=0;								
	...
	/*-----------------------------NUEVO-------------------------------------------------------------*/	 
		...
		if (!noDocto.trim().equals(cdo.getColValue("documento")))
		 {		
			 pc.addCols(" "+cdo.getColValue("fecha"),1,1,Color.lightGray);
			 pc.addCols(" "+cdo.getColValue("documento"),1,1,Color.lightGray);
			 pc.addCols(" "+(CmnMgr.getFormattedDecimal(cdo.getColValue("montoP"))),2,1,Color.lightGray);		   
			 pc.addCols(" "+cdo.getColValue("estado"),2,1,Color.lightGray);			  	   
			 pc.addCols(" "+cdo.getColValue("infoCheque"),1,1,Color.lightGray);			  
			 ...
			 pc.addCols("    "+cdo.getColValue("unidad_adm")+" "+cdo.getColValue("gastoDe")+"     "+cdo.getColValue("estado"),0,1);
			  pc.addCols(" ",0,1);					 
		...
		groupBy2 = cdo.getColValue("beneficiario");
		groupBy3 = "[ "+cdo.getColValue("fecha")+" ] "+cdo.getColValue("documento");
