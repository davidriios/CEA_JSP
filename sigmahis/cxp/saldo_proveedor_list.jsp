...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(a.cod_provedor) like '%"+request.getParameter("cod_provedor").toUpperCase()+"%'";
    searchOn = "a.cod_provedor";
  ...
  else
  {
	...
	sql = "select a.cod_provedor, b.nombre_proveedor, nvl(a.saldo,0) saldo from tbl_con_saldo_proveedor a, tbl_com_proveedor  b where a.cod_provedor = b.cod_provedor and a.compania = b.compania and a.compania = "+(String) session.getAttribute("_companyId")+appendFilter+" order by 2";
...
document.title = 'Actualización de Saldos de Proveedores - '+document.title;
	...
	for (i=0; i<size; i++)
		{
			 ...
			 saldo = eval('document.formDigito.saldo'+i).value;	
				...
				{		
					if(executeDB('<%=request.getContextPath()%>','update tbl_con_saldo_proveedor set saldo = '+saldo+' where cod_provedor = \''+cod+'\' and compania = \''+cia+'\'','tbl_con_saldo_proveedor'))
					 {
					 cont++;
					 //alert('saldo'+i+'..'+cod+'..'+saldo);
					 }
				}0	 
		}
		alert('Se Guardó la Actualización de Saldos ....!'+cont);
}
