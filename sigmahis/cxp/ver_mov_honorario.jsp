...
function setValues(){
	...
	window.frames['itemFrame'].location = '../cxp/ver_mov_honorario_det.jsp?beneficiario=<%=beneficiario%>&tipo=<%=tipo%>&fechaini='+fechaini+'&fechafin='+fechafin;
}
...
{	
	var fechaini = document.form1.fechaini.value;
	var fechafin = document.form1.fechafin.value;
	abrir_ventana('../cxp/print_movimiento_hon.jsp?beneficiario=<%=beneficiario%>&fechaini='+fechaini+'&fechafin='+fechafin+'&tipo=<%=tipo%>');
}
        ...
        <tr>
          <td class="TableBorder"><table align="center" width="100%" cellpadding="5" cellspacing="0">
                ...
                <td><table align="center" width="100%" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                      <td><iframe name="itemFrame" id="itemFrame" frameborder="0" align="center" width="100%" height="300" scrolling="yes" src="../cxp/ver_mov_honorario_det.jsp?fp=<%=fp%>&fg=<%=fg%>&mode=<%=mode%>&beneficiario=<%=beneficiario%>&tipo=<%=tipo%>&fechaini=<%=fechaini%>&fechafin=<%=fechafin%>"></iframe></td>
                    </tr>
                    <%=fb.formEnd(true)%>
