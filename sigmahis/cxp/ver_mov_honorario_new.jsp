...
function setValues(){
	...
	window.frames['itemFrame'].location = '../cxp/ver_mov_honorario_det_new.jsp?beneficiario=<%=beneficiario%>&tipo=<%=tipo%>&fechaini='+fechaini+'&fechafin='+fechafin;
}

function printMovimiento()
{	
	var codigo = '<%=beneficiario%>';
	var tipo = '<%=tipo%>';
	var fechaini = document.form1.fechaini.value;
	var fechafin = document.form1.fechafin.value;
	abrir_ventana('../cxp/print_estado_cta_hon_det.jsp?beneficiario='+codigo+'&tipo='+tipo+'&fechaini='+fechaini+'&fechafin='+fechafin);
}
                ...
                <td><table align="center" width="100%" cellpadding="0" cellspacing="1">
                    ...
                    <%=fb.formStart(true)%>
										...
										<tr>
											<td align="right">
											<authtype type='2'>
											<a href="javascript:printMovimiento()" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><font class="RedTextBold"> <cellbytelabel>Imprimir</cellbytelabel></font></a>
											</authtype></td>
										</tr>
                    ...
                    <tr>
                      <td><iframe name="itemFrame" id="itemFrame" frameborder="0" align="center" width="100%" height="300" scrolling="yes" src="../cxp/ver_mov_honorario_det_new.jsp?fp=<%=fp%>&fg=<%=fg%>&mode=<%=mode%>&beneficiario=<%=beneficiario%>&tipo=<%=tipo%>&fechaini=<%=fechaini%>&fechafin=<%=fechafin%>"></iframe></td>
                    </tr>
                    <%=fb.formEnd(true)%>
