...
<body onLoad="javascript:doAction();">
	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
                ...
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=89&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=31&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                </div>
				<div class="row">
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=1&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=32&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                </div>
                ...
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=34&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                </div>
				<div class="row">
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=46&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=61&colSpanClass=col-md-6" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
                </div>
				<div class="row">
                <jsp:include page="../datawidgets/cond_actual_paciente.jsp?seccionId=-1&colSpanClass=col-md-12" flush="true">
                  <jsp:param name="pacId" value="<%=pacId%>"></jsp:param>
                  <jsp:param name="admision" value="<%=admision%>"></jsp:param>
                </jsp:include>
    ...
    $(document).on('click', '.refresh-it', function(e){
		...
		var fechaEval = $('#fechaEval').val();
		
		if (fechaEval) fechaEval = fechaEval.split('-').reverse().join('/');
