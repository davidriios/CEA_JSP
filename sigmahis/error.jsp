...
<%
String linkAction = "history.go(-1)";
if (exception != null)
{
	if (exception.getMessage().contains("fuera del sistema")) linkAction = "closeSession()";
...
%>
						...
						Por favor haga <a href="javascript:<%=linkAction%>" class="Link00">click aqu&iacute;</a> e intente nuevamente o consulte con su administrador.<br>
						</label>
