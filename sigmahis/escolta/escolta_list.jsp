...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("primerNombre") != null && !request.getParameter("primerNombre").trim().equals(""))
  {
  ...
  if (request.getParameter("primerApellido") != null && !request.getParameter("primerApellido").trim().equals(""))
  {
    if (appendFilter.equals("")) appendFilter +=" Where"; else appendFilter +=" and";
...
function printList(){
	abrir_ventana("print_list_escolta.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>");
}
</script>
</head>
			...
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">
				    ...
				    <td width="15%">
 					...
 					<td width="25%"><cellbytelabel id="3">Primer Nombre</cellbytelabel>
						<%=fb.textBox("primerNombre",primerNombre,false,false,false,25,null,null,null)%>
				  	</td>
					<td width="60%"><cellbytelabel id="4">Primer Apellido</cellbytelabel>
