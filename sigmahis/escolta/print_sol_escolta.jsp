...
if (request.getParameter("estado") != null && !request.getParameter("estado").trim().equals("") && !request.getParameter("estado").trim().equals("T"))
{
