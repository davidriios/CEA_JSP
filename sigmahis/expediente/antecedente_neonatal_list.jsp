...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	sql = "select codigo, descripcion, decode(valor,'A','ALFANUMERICO','N','NUMERICO') as fvalor, orden, es_default from tbl_sal_factor_neonatal"+appendFilter+" order by orden";
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_factor_neonatal "+appendFilter);
...
document.title = 'EXPEDIENTE- MANTENIMIENTO- ANTECEDENTE NEONATAL - '+document.title;
function showMedidaFactor(id)
{
	abrir_ventana('../expediente/antecedente_neonatal_list_medida.jsp?fp=listfactor&mode=edit&id='+id);
}
function add()
{
	abrir_ventana('../expediente/antecedente_neonatal_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/antecedente_neonatal_config.jsp?fp=listfactor&mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_antecedente_neonatal.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE- MANTENIMIENTO- ANTECEDENTE NEONATAL"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo antecedente neonatal</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td align="center">
		<authtype type='4'><a href="javascript:showMedidaFactor(<%=cdo.getColValue("codigo")%>)" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel id="10">Unidad de medida</cellbytelabel></a></authtype>
			</td>
