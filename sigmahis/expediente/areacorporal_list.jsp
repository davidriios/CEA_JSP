...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion, orden FROM tbl_sal_examen_areas_corp WHERE codigo<>0"+appendFilter+" order by orden";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_sal_examen_areas_corp WHERE codigo<>0"+appendFilter);
...
document.title = 'Factores a Evaluar en Examen Físico - '+document.title;

function add()
{
	abrir_ventana('areacorporal_config.jsp');
}

function edit(id)
{
	abrir_ventana('areacorporal_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('print_list_areacorporal.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
	       <authtype type='3'><a href="javascript:add()" class="Link00">[ R<cellbytelabel id="1">egistrar Nuevo Factor de Examen F&iacute;sico</cellbytelabel> ]</a></authtype>
	    </td>
    </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="list">
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">
							<authtype type='4'><a href="javascript:edit(<%=cdo.getColValue("codigo")%>)" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel id="4">Editar</cellbytelabel></a></audtype>
					</td>
				</tr>
				<%
				}
