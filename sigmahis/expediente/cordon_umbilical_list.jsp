...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = " SELECT codigo, descripcion FROM tbl_sal_rn_cordon "+appendFilter+" ORDER BY codigo ASC ";
  al = SQLMgr.getDataList(" select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount(" SELECT count(*) FROM tbl_sal_rn_cordon "+appendFilter);
...
function add()
{
	abrir_ventana('cordon_umbilical_config.jsp');
}

function edit(id)
{
	abrir_ventana('cordon_umbilical_config.jsp?mode=edit&id='+id);
}


function printList()
{
	abrir_ventana('print_list_cordon_umbilical.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<tr>
<td align="right">&nbsp;
        <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Cord&oacute;n Umblical</cellbytelabel> ]</a></authtype>
</td>
</tr>
<tr>
<td>
