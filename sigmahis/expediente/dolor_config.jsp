...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	else
	{
		...
		sql = "select codigo, descripcion, observacion,estado, tipo from tbl_sal_dolor where codigo='"+id+"'";
...
document.title=" Edición -  Dolor "+document.title;
<%}%>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - DOLOR"></jsp:param>
</jsp:include>
...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<tr class="TextRow01" >
				...
				<td width="78">&nbsp;<%=fb.textBox("id",id,true,false,false,5,2,null,null,"onBlur=\"javascript:checkId(this)\"")%></td>
            </tr>
            <tr class="TextRow01" >
				<td width="22%">&nbsp;<cellbytelabel id="1">Tipo</cellbytelabel></td>
				<td width="78">&nbsp;<%=fb.select("tipo","AN=ANALOGA,CA=CAMPBELL,MM5=MENOS DE 5 AÑOS",cdo.getColValue("tipo"),false,false,0,"")%></td>
            </tr>
		   <tr class="TextRow01">
...
else
{
  ...
  cdo.setTableName("tbl_sal_dolor");
...
<%
	if (session.getAttribute("_urlInfo") != null && ((Hashtable) session.getAttribute("_urlInfo")).containsKey(request.getContextPath()+"/expediente/list_dolor.jsp"))
	{
%>
	window.opener.location = '<%=(String) ((Hashtable) session.getAttribute("_urlInfo")).get(request.getContextPath()+"/expediente/list_dolor.jsp")%>';
<%
	}
	else
	{
%>
	window.opener.location = '<%=request.getContextPath()%>/expediente/list_dolor.jsp';
<%
	}
