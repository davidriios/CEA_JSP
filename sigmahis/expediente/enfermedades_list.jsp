...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
	...
	sql = "select id, descripcion, tipo, orden, decode(status,'A','ACTIVO','I','INACTIVO' )status from tbl_sal_parametro where tipo ='"+fg+"'"+appendFilter;
...
document.title = 'Expediente - Mantenimiento - Enfermedades y Operaciones '+document.title;

function add()
{
	abrir_ventana('../expediente/enfermedades_config.jsp?fg=<%=fg%>');
}

function edit(id)
{
	abrir_ventana('../expediente/enfermedades_config.jsp?mode=edit&id='+id+'&fg=<%=fg%>');
}

function printList()
{
	abrir_ventana('../expediente/print_list_enfermedades.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>&fg=<%=fg%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
		<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva Enfermedad</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
			...
			<tr class="TextFilter">
				...
				<td width="50%">
					...
					<%=fb.textBox("descripcion","",false,false,false,30)%>
					<%=fb.submit("go","Ir")%>
				</td>
				<%=fb.formEnd()%>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="10%"><cellbytelabel id="8">Orden</cellbytelabel></td>
			<td width="50%"><cellbytelabel id="3">Descripci&oacute;n</cellbytelabel></td>
			<td width="10%"><cellbytelabel id="9">Tipo</cellbytelabel></td>	
