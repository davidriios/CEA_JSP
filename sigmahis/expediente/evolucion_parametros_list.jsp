...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "select id,codigo, descripcion, tipo,orden, decode(status,'A','ACTIVO','INACTIVO') status from tbl_sal_evolucion_parametro where tipo = '"+fg+"' "+appendFilter+" order by id ";
...
document.title = 'Evolucion - Parametros  - '+document.title;

function add()
{
	abrir_ventana('evolucion_parametro_config.jsp?fg=<%=fg%>');
}

function edit(id)
{
	abrir_ventana('evolucion_parametro_config.jsp?fg=<%=fg%>&mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('print_evolucion_param_list.jsp?fg=<%=fg%>&appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
      	   <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Par&aacute;metro</cellbytelabel> ]</a></authtype>
	    </td>
    </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="list">
				<tr class="TextHeader">
					<td width="10%"><cellbytelabel id="8">Id</cellbytelabel></td>
					<td width="10%"><cellbytelabel id="9">Orden</cellbytelabel></td>
					...
					<td width="10%"><cellbytelabel id="10">Estado</cellbytelabel></td>
					<td width="10%">&nbsp;</td>
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td><%=cdo.getColValue("orden")%></td>
					<td><%=cdo.getColValue("codigo")%></td>
					<td><%=cdo.getColValue("descripcion")%></td>
					<td><%=cdo.getColValue("status")%></td>
					<td align="center">
							<authtype type='4'><a href="javascript:edit(<%=cdo.getColValue("id")%>)" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')"><cellbytelabel id="11">Editar</cellbytelabel></a></authtype>
					</td>
				</tr>
				<%
				}
