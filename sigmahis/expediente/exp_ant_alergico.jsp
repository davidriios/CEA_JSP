...
<%=fb.hidden("seccion",seccion)%>
		...
		<tr class="TextHeader" align="center">
			<td width="40%"><cellbytelabel id="2">Tipo de Alerg&iacute;a</cellbytelabel></td>
			...
			<td width="7%"><cellbytelabel id="6">Observaci&oacute;n</cellbytelabel></td>
		</tr>
<%
