...
{	
	sql = "select a.codigo as cod_antecedente, a.descripcion, nvl(b.valor,' ') as valor, nvl(b.observacion,' ') as observacion,decode(b.antecedente,null,'I','U') action,to_char(b.fecha_creacion,'dd/mm/yyyy hh12:mi:ss am')fecha_creacion,b.usuario_creacion from tbl_sal_diagnostico_familiar a, tbl_sal_antecedente_familiar b where a.codigo=b.antecedente(+) and b.pac_id(+)="+pacId+ " and nvl(b.admision,"+noAdmision+") = "+noAdmision+" and a.status = 'A' order by a.orden, observacion desc nulls last";
...
%>
		...
		<tr class="<%=color%>">
			...
			<td><%=fb.textarea("observacion"+i,cdo.getColValue("observacion"),false,(!cdo.getColValue("valor").equalsIgnoreCase("S")),viewMode,50,2,2000,null,"width='100%'",null)%></td>
		</tr>
<%
}
%>
