...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
    ...
    rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_ant_med_importantes "+appendFilter);
...
<script>
document.title = 'Antecedentes Médicos Importantes - '+document.title;

function add()
{
	abrir_ventana('../expediente/exp_ant_medicos_importancia_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/exp_ant_medicos_importancia_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_ant_medicos_importancia.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - ANTECEDENTES MEDICOS IMPORTANTES"></jsp:param>
</jsp:include>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="68%"><cellbytelabel id="3">Descripci&oacute;n</cellbytelabel></td>
