...
if(desc==null){cdo = (CommonDataObject) iExpSecciones.get(seccion);desc = cdo.getColValue("descripcion");}	
	sql = "select a.codigo, a.descripcion, b.cod_trauma, to_char(b.fecha,'dd/mm/yyyy') as fecha, b.observacion, nvl(b.aplicar,' ') as aplicar, b.pac_id,decode(b.cod_trauma,null,'I','U') action,to_char(b.fecha_creacion,'dd/mm/yyyy hh12:mi:ss am')fecha_creacion,b.usuario_creacion from tbl_sal_factor_trauma a, tbl_sal_antecedente_trauma_ped b where a.codigo=b.cod_trauma(+) and b.pac_id(+)="+pacId;
...
document.title = 'EXPEDIENTE - Antecedentes Traumaticos - '+document.title;
...
<%=fb.hidden("noAdmision",noAdmision)%>
		...
		<tr class="TextHeader" align="center" >
			<td width="45%"><cellbytelabel id="1">Descripci&oacute;n<</cellbytelabel>/td>
			<td width="5%"><cellbytelabel id="2">Si</cellbytelabel></td>
			<td width="50%"><cellbytelabel id="3">Observaci&oacute;n</cellbytelabel></td>
		</tr>
<%
...
else
{
	...
	for (int i=0; i<size; i++)
	{
		...
		cdo.setTableName("tbl_sal_antecedente_trauma_ped");
		cdo.setWhereClause("pac_id="+request.getParameter("pacId")+" and cod_trauma="+request.getParameter("codigo"+i));
		...
		if (request.getParameter("aplicar"+i) != null && request.getParameter("aplicar"+i).equalsIgnoreCase("S"))
		{
			...
			cdo.addColValue("cod_trauma",request.getParameter("codigo"+i));
