...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion, estado FROM tbl_sal_areas_cuid_intensivo WHERE codigo<>0"+appendFilter+" order by descripcion";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_sal_areas_cuid_intensivo WHERE codigo<>0"+appendFilter);
...
function add(){
	abrir_ventana('exp_areas_cuidado_intensivo_config.jsp');
}

function edit(id){
	abrir_ventana('exp_areas_cuidado_intensivo_config.jsp?mode=edit&id='+id);
}
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
	       <authtype type='3'><a href="javascript:add()" class="Link00">[ R<cellbytelabel id="1">egistrar Nueva Area Cuidado Intensivo</cellbytelabel> ]</a></authtype>
	    </td>
    </tr>
	<tr>
		<td>
