...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			<table width="100%" cellpadding="1" cellspacing="1" >
					...
					<tr class="TextHeader">
								...
								<td width="05%" align="center"><%=fb.submit("addEspec","+",false,viewMode,null,null,"onClick=\"javascript:setBAction('"+fb.getFormName()+"',this.value)\"","Agregar Espécimen")%></td>
...
if (!modeSec.equalsIgnoreCase("add")){
   tabLabel += ",'Diag. Pre-Operatorio.','Diag. Post-Operatorio','Espècimen'";
}
%>
