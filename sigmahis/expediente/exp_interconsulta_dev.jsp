			...
			<td>
				<table width="100%" cellpadding="1" cellspacing="1">
					...
					<tr align="center" class="TextRow01">
						<td colspan="3" align="right"><a href="javascript:imprimir()" class="Link00">[ <cellbytelabel>Imprimir</cellbytelabel> ]</a><a href="javascript:verIntercon()" class="Link00">[ <cellbytelabel>Ver Solicitudes de Interconsulta</cellbytelabel> ]</a></td>
					</tr>
					<tr class="TextHeader" align="center">
						...
						<td width="5%"><%=fb.submit("agregar","+",false,viewMode,null,null,"onClick=\"javascript:setBAction('"+fb.getFormName()+"',this.value)\"","Agregar Interconsulta")%></td>
					</tr>
					<%
					...
					%>
						...
						<%}else{%>
							<tr class="<%=color%>" align="center">
								<td>
									<%=fb.textBox("nombre_medico"+i,cdo.getColValue("nombre_medico"),true,false,true,70,"Text10",null,null)%>
									<%=fb.button("medico","...",true,(viewMode || (cdo.getColValue("medico") != null && !cdo.getColValue("medico").trim().equals(""))),null,null,"onClick=\"javascript:medicoList("+i+")\"","Seleccionar Médico")%>
							    </td>
								<td>
									<%=fb.textBox("cod_espec"+i,cdo.getColValue("cod_especialidad"),false,false,true,10,"Text10",null,null)%>
									<%=fb.textBox("espec"+i,cdo.getColValue("descripcion"),false,false,true,70,"Text10",null,null)%>
								</td>
								<td rowspan="2">
									<%=fb.submit("rem"+i,"X",false,(viewMode || (cdo.getColValue("codigo") != null && !cdo.getColValue("codigo").trim().equals("0"))),null,null,"onClick=\"javascript:removeItem('"+fb.getFormName()+"',"+i+")\"","Eliminar")%>
								</td>
							</tr>
							<tr id="id<%=i%>" class="<%=color%>">
								<td colspan="2">
									<cellbytelabel>Pregunta</cellbytelabel>&nbsp;<%=fb.textarea("observacion"+i,cdo.getColValue("observacion"),false,false,(viewMode || (cdo.getColValue("codigo") != null && !cdo.getColValue("codigo").trim().equals("0"))),80,2,2000,"","","")%>&nbsp;&nbsp;
									<span style="vertical-align:top;">Respuestas&nbsp;(<%="0"%>)</span>
								</td>
							</tr>
						<%}%>
					<%
...
else
{
	...
	for (int i=0; i<size; i++)
	{
		...
		cdo.addColValue("medico_solicitante",request.getParameter("medico_solicitante"+i));
		cdo.setKey(i);
