...
function doAction(){newHeight();parent.newHeight();}
...
<%fb.appendJsValidation("if(!isAValidNoHemodialisis()){alert('Por favor introduzca un intero para el número de Hemodiálisis  !');error++;}");%>
		...
		<%if(!fg.trim().equals("HM")){%>
			...
			<td width="12%"><cellbytelabel id="1">Fecha</cellbytelabel></td>
			<td width="12%"><cellbytelabel id="2">Hora</cellbytelabel></td>
			<td width="7%"><cellbytelabel id="3">Temp.</cellbytelabel></td>
			<td width="4%"><cellbytelabel id="4">Pulso</cellbytelabel></td>
			<td width="7%"><cellbytelabel id="5">Resp</cellbytelabel>.</td>
			<td width="7%"><cellbytelabel id="6">P.Art</cellbytelabel>.</td>
			<td width="6%"><cellbytelabel id="7">F.Card.</cellbytelabel></td>
			<td width="6%"><cellbytelabel id="8">Pul.Card.</cellbytelabel></td>
			<td width="5%"><cellbytelabel id="9">Peso</cellbytelabel></td>
			<td width="6%"><cellbytelabel id="10">Talla</cellbytelabel></td>
			<td width="2%">&nbsp;</td>
			<td width="8%"><%=fb.submit("agregar","+",true,viewMode,null,null,"onClick=\"javascript:setBAction('"+fb.getFormName()+"',this.value)\"","Agregar Nota")%></td>
		</tr>
		<%}else{%>
		<tr align="center" class="TextHeader">
			<td width="12%"><cellbytelabel id="2">Hora</cellbytelabel></td>
			<td width="12%"><cellbytelabel id="6">P.Art.</cellbytelabel></td>
			<td width="8%"><cellbytelabel id="4">Pulso</cellbytelabel></td>
			<td width="4%"><cellbytelabel id="5">Resp</cellbytelabel>.</td>
			<td width="8%"><cellbytelabel id="3">Temp</cellbytelabel>.</td>
			<td width="7%"><cellbytelabel id="11">F. S</cellbytelabel></td>
			<td width="6%"><cellbytelabel id="12">P. V</cellbytelabel></td>
			<td width="6%"><cellbytelabel id="23">UF</cellbytelabel></td>
			<td width="6%"><cellbytelabel id="14">P.T.M</cellbytelabel></td>
			<td width="2%"><%=fb.submit("agregar","+",true,viewMode,null,null,"onClick=\"javascript:setBAction('"+fb.getFormName()+"',this.value)\"","Agregar Nota")%></td>
		</tr>
...
%>
		...
		<tr class="<%=color%>" align="left"<%=displayNote%>>
			<td>
			...
			<td><%=fb.textBox("temperatura"+i,drn.getTemperatura(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("pulso"+i,drn.getPulso(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("respiracion"+i,drn.getRespiracion(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("pArterial"+i,drn.getPArterial(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("fCard"+i,drn.getFCard(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("pCard"+i,drn.getPCard(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("peso"+i,drn.getPeso(),false,false,viewMode,5,10)%></td>
			<td><%=fb.textBox("talla"+i,drn.getTalla(),false,false,viewMode,5,10)%></td>

			<td><% if (cdoParam.getColValue("set_triage").trim().equals("S")){ %><%=fb.button("setTriage","Tria",true,viewMode,null,null,"onClick=\"javascript:setTriageDetail("+i+")\"")%><%}%></td>
			<td rowspan="2">
				<%=(drn.getCodigo().equals("0") || drn.getUsuarioCreacion().trim().equals((String) session.getAttribute("_userName")))?fb.submit("rem"+i,"X",true,viewMode,"",null,"onClick=\"javascript:removeItem('"+fb.getFormName()+"',"+i+")\""):""%>
			</td>
		</tr>
...
<tr class="TextHeader"<%=displayNote%>>
<td colspan="6">
<cellbytelabel id="15">Medicina y Tratamientos</cellbytelabel>
<%=fb.textarea("medTrat"+i,drn.getMedTrat(),false,false,viewMode,60,4,2000,null,"width:75%","")%>
</td>
<td colspan="6">
<cellbytelabel id="16">Notas de la enfermera</cellbytelabel>
<%=fb.textarea("observacion"+i,drn.getObservacion(),false,false,viewMode,60,4,2000,null,"width:75%","")%></td>
</tr>
...
<td width="37%" align="right" >[<font face="Courier New, Courier, mono">
	...
	<table width="100%" cellpadding="1" cellspacing="1">
		<tr class="<%=color%>"<%=displayNote%>>
<td width="12%" align="right"><cellbytelabel id="18">Evacuaci&oacute;n</cellbytelabel>:</td>
<td colspan="11"><%=fb.checkbox("evacuacion"+i,"S",drn.getEvacuacion().trim().equals("S"),viewMode,null,null,"")%>
&nbsp;&nbsp;Observación:&nbsp;<%=fb.textarea("evacuacionObs"+i, drn.getEvacuacionObs(), false, false, viewMode, 0, 1, "", "width:75%", "")%></td>
</tr>

<tr class="<%=color%>" <%=displayNote%> >
<td width="12%" align="right"><cellbytelabel id="19">Micci&oacute;n</cellbytelabel>:</td>
<td colspan="11"><%=fb.checkbox("miccion"+i,"S",drn.getMiccion().trim().equals("S"),viewMode,null,null,"")%>
&nbsp;&nbsp;Observación:&nbsp;<%=fb.textarea("miccionObs"+i, drn.getMiccionObs(), false, false, viewMode, 0, 1, "", "width:75%", "")%></td>
</tr>

<tr class="<%=color%>"<%=displayNote%>>
<td width="12%" align="right"><cellbytelabel id="20">V&oacute;mito</cellbytelabel>:</td>
 <td colspan="11"><%=fb.checkbox("vomito"+i,"S",drn.getVomito().trim().equals("S"),viewMode,null,null,"")%>
 &nbsp;&nbsp;Observación:&nbsp;<%=fb.textarea("vomitoObs"+i, drn.getVomitoObs(), false, false, viewMode, 0, 1, "", "width:75%", "")%></td>	 </tr>

<tr class="<%=color%>"<%=displayNote%>>
<td width="12%" align="right"><cellbytelabel id="21">Dolor</cellbytelabel>:</td>
<td colspan="11"><%=fb.select("dolor"+i,"S=Si,N=No",drn.getDolor(),false,viewMode,0,null,null,null)%>
&nbsp;&nbsp;</td>
	 </tr>


<tr class="<%=color%>"<%=displayNote%>>
<td width="12%" align="right"><cellbytelabel id="22">Comida</cellbytelabel>:</td>
<td colspan="11"><%=fb.select("comida"+i,"D=Desayuno,A=Almuerzo,M=Merienda,C=Cena",drn.getComida(),false,viewMode,0,null,null,null)%>
&nbsp;&nbsp;<cellbytelabel id="23">Comi&oacute;</cellbytelabel>&nbsp;<%=fb.select("comio"+i,"S=Si,N=No",drn.getComio(),false,viewMode,0,null,null,null)%>&nbsp;&nbsp;&nbsp;&nbsp;<cellbytelabel id="24">Cantidad</cellbytelabel>&nbsp;<%=fb.select("cantidad"+i,"0=Nada,1=1/4,2=1/2,3=1/3,4=Todo",drn.getCantidad(),false,viewMode,0,null,null,null)%>&nbsp;&nbsp;</td>
</tr>
...
<td colspan="12"><%=fb.select("diagnosticoEnf"+i,alDiag,drn.getDiagnosticoEnf(),false,(viewMode),0,"Text10",null,null,"","S")%></td>
</tr>
<tr class="<%=color%>"<%=displayNote%>>
<td width="12%" align="left"><cellbytelabel id="26">Observaci&oacute;n</cellbytelabel></td>
<td width="38%" align="left" ><%=fb.textarea("comentario"+i, drn.getComentario(), false, false, viewMode, 0, 3, "", "width:75%", "")%></td>
<td width="7%" align="right"><cellbytelabel id="27">Acci&oacute;n</cellbytelabel></td>
<td width="43%" ><%=fb.textarea("accion"+i, drn.getAccion(), false, false, viewMode, 0, 3, "", "width:75%", "")%></td>
</tr>
				...
				<%} else {%>
							...
							<td colspan="1">
								...
								<%=fb.textarea("recormon"+i,drn.getRecormon(),false,false,viewMode,10,4,2000,null,"width:75%","")%>
							</td>
							<td colspan="4">
						 <cellbytelabel id="16">Notas de la enfermera</cellbytelabel>
						<%=fb.textarea("observacion"+i,drn.getObservacion(),false,false,viewMode,60,4,2000,null,"width:75%","")%>
		...
		<tr class="<%=color%>" align="center"<%=displayNote%>>
			<td>
				<jsp:include page="../common/calendar.jsp" flush="true">
				<jsp:param name="noOfDateTBox" value="1"/>
				<jsp:param name="format" value="hh12:mi am"/>
			...
			<td><%=fb.textBox("pArterial"+i,drn.getPArterial(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("pulso"+i,drn.getPulso(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("respiracion"+i,drn.getRespiracion(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("temperatura"+i,drn.getTemperatura(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("flujoSanguineo"+i,drn.getFlujoSanguineo(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("pVenosa"+i,drn.getPVenosa(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("ultrafijacion"+i,drn.getUltrafijacion(),false,false,viewMode,4,10)%></td>
			<td><%=fb.textBox("pTransmembranica"+i,drn.getPTransmembranica(),false,false,viewMode,4,10)%></td>
			<td rowspan="2">
				<%=(drn.getCodigo().equals("0") || drn.getUsuarioCreacion().trim().equals((String) session.getAttribute("_userName")))?fb.submit("rem"+i,"X",true,viewMode,"",null,"onClick=\"javascript:removeItem('"+fb.getFormName()+"',"+i+")\""):""%>
			</td>
		</tr>
		<tr class="<%=color%>"<%=displayNote%>>
				...
				<%}  else {%>
						<td colspan="3">
							<cellbytelabel id="15">Medicina y Tratamientos</cellbytelabel>
							<%=fb.textarea("medTrat"+i,drn.getMedTrat(),false,false,viewMode,60,3,2000,null,"width:75%","")%>
						</td>
						<td width="7%">
							<cellbytelabel id="30">Eritropoyetina (uds)</cellbytelabel>: <%=fb.textBox("recormon"+i,drn.getRecormon(),false,false,viewMode,3,20)%>
			</td>
...
else
{
	...
	if (!ItemRemoved.equals(""))
	{
		...
		response.sendRedirect("../expediente/exp_notas_enfermeria_det.jsp?seccion="+seccion+"&mode="+mode+"&modeSec="+modeSec+"&pacId="+pacId+"&noAdmision="+noAdmision+"&fg="+fg+"&lastLineNo="+lastLineNo+"&change=1&defaultAction="+defaultAction);
		return;
	}
