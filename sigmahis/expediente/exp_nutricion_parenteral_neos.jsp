...
function setEvaluacion(code){window.location = '../expediente/exp_nutricion_parenteral_neos.jsp?modeSec=view&mode=<%=mode%>&fg=<%=fg%>&seccion=<%=seccion%>&medico=<%=medico%>&from=<%=from%>&pacId=<%=pacId%>&noAdmision=<%=noAdmision%>&id='+code+'&desc=<%=desc%>&cds=<%=cds%>';}
function add(){window.location = '../expediente/exp_nutricion_parenteral_neos.jsp?modeSec=add&mode=<%=mode%>&fg=<%=fg%>&seccion=<%=seccion%>&pacId=<%=pacId%>&noAdmision=<%=noAdmision%>&id=0&desc=<%=desc%>&cds=<%=cds%>&medico=<%=medico%>&from=<%=from%>';}
...
<tr class="TextRow01">
                 ...
                 <%=fb.hidden("desc",desc)%>
						<tr class="TextRow02">
                            ...
                            <%if(id.trim().equals("0")){%>
                            <a href="javascript:printExpAll();"  class="Link00">[<cellbytelabel id="3">Imprimir Todo</cellbytelabel>]</a>
                            <%}else{%>
                            <a href="javascript:printExp();"  class="Link00">[<cellbytelabel id="4">Imprimir</cellbytelabel>]</a>
                             <%}%>
                            </td>
						</tr>
...
%>
		...
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="setEvaluacion(<%=prop1.getProperty("id")%>);" style="text-decoration:none; cursor:pointer">
				<td><%=i%></td>
...
<%=fb.hidden("formaSolicitud","")%>
		...
		<tr class="TextRow01">
			...
			<td><%=fb.textBox("peso",prop.getProperty("peso"),false,false,viewMode,15,15,"Text10",null,null)%></td>
			<td>Talla<%=fb.textBox("talla",prop.getProperty("talla"),false,false,viewMode,15,15,"Text10",null,null)%></td>--->
			<td colspan="2"><cellbytelabel id="7">Hora Inicio</cellbytelabel>
			<!--<jsp:include page="../common/calendar.jsp" flush="true">
				<jsp:param name="noOfDateTBox" value="1"/>
				...
				<%=fb.textBox("hora_inicio",prop.getProperty("hora_inicio"),false,false,viewMode,10,15,"Text10",null,null)%><cellbytelabel id="8">ml/Hrs</cellbytelabel>
				</td>
		</tr>
		...
		<tr class="TextHeader">
			...
			<table align="center" width="100%" cellpadding="1" cellspacing="1">
				<tr class="TextRow01" align="center">
					<td width="15%"><%=fb.decBox("peso",prop.getProperty("peso"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="9">(Kg)</cellbytelabel></td>
					<td width="25%"> X <%=fb.decBox("volumen",prop.getProperty("volumen"),false,false,viewMode,7,"Text10",null,"onChange=\"javascript:Calc()\"")%><cellbytelabel id="10">(ml/por/dia)</cellbytelabel></td>
					<td width="25%">= <%=fb.textBox("volumen_dia",prop.getProperty("volumen_dia"),false,false,viewMode,7,"Text10",null,"")%> <cellbytelabel id="10">(ml/por/dia)</cellbytelabel> </td>
					<td width="35%"><cellbytelabel id="11">24 Hrs</cellbytelabel>= <%=fb.textBox("volumen_total",prop.getProperty("volumen_total"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="12">(ml/hrs)</cellbytelabel></td>
				</tr>
		...
		<tr class="TextHeader">
			<td colspan="9"><cellbytelabel id="17">MACRONUTRIENTES</cellbytelabel></td>
		</tr>
		...
		<tr class="TextRow02">
			<td colspan="9">
				<table align="center" width="100%" cellpadding="1" cellspacing="1">
						...
						<tr class="TextRow01">
							...
							<td width="10%"><%=fb.textBox("macro1",prop.getProperty("macro1"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="19">Gms/Kg/D&iacute;a</cellbytelabel></td>
							<td width="20%"><cellbytelabel id="20">Tipo de A.A(%)</cellbytelabel>:</td>
							<td width="10%"><%=fb.textBox("macro2",prop.getProperty("macro2"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="19">Gms/Kg/D&iacute;a</cellbytelabel></td>
							<td width="10%"><cellbytelabel id="21">Vol</cellbytelabel>.</td>
							<td width="15%"><%=fb.textBox("macro3",prop.getProperty("macro3"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="22">ml/24Hr</cellbytelabel>.</td>
							<td width="25%" rowspan="2"><cellbytelabel id="23">Gm N</cellbytelabel><%=fb.textBox("macro4",prop.getProperty("macro4"),false,false,viewMode,3,"Text10",null,"")%></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="25">Amino&aacute;cidos Especiales</cellbytelabel></td>
							<td><%=fb.textBox("macro5",prop.getProperty("macro5"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="19">Gms/Kg/D&iacute;a</cellbytelabel></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><cellbytelabel id="21">Vol</cellbytelabel>.</td>
							<td><%=fb.textBox("macro6",prop.getProperty("macro6"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="22">ml/24Hr</cellbytelabel>.</td>
						</tr>
						<tr class="TextRow03">
					...
					<!---</table>	
						...
						<tr class="TextRow02">
							...
							<td><%=fb.textBox("macro7",prop.getProperty("macro7"),false,false,viewMode,7,"Text10",null,"")%>% <cellbytelabel id="28">final</cellbytelabel></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><cellbytelabel id="21">Vol</cellbytelabel>.</td>
							<td><%=fb.textBox("macro8",prop.getProperty("macro8"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="22">ml/24Hr</cellbytelabel>.</td>
							<td>Kcal<%=fb.textBox("macro9",prop.getProperty("macro9"),false,false,viewMode,3,"Text10",null,"")%></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="29">L&iacute;pidos 10%  20%</cellbytelabel></td>
							<td><%=fb.textBox("macro10",prop.getProperty("macro10"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="19">Gms/Kg/D&iacute;a</cellbytelabel></td>
							<td><%=fb.textBox("macro11",prop.getProperty("macro11"),false,false,viewMode,7,"Text10",null,"")%></td>
							<td>&nbsp;</td>
							<td><cellbytelabel id="21">Vol</cellbytelabel>.</td>
							<td><%=fb.textBox("macro12",prop.getProperty("macro12"),false,false,viewMode,7,"Text10",null,"")%><cellbytelabel id="22">ml/24Hr</cellbytelabel>.</td>
							<td>Kcal<%=fb.textBox("macro13",prop.getProperty("macro13"),false,false,viewMode,3,"Text10",null,"")%></td>
						</tr>
						<!---</table>
					</td></tr>--->
			...
			<table align="center" width="100%" cellpadding="1" cellspacing="1">			
						...
						<tr class="TextRow01">
							...
							<td width="13%"><%=fb.textBox("electro1",prop.getProperty("electro1"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td width="5%"><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td width="5%">&nbsp;</td>
							<td width="13%"><%=fb.textBox("electro2",prop.getProperty("electro2"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td width="5%"><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
							<td width="5%">&nbsp;</td>
							
							<td><cellbytelabel id="34">Insulina(Reg)</cellbytelabel></td>
							<td><%=fb.textBox("electro6",prop.getProperty("electro6"),false,false,viewMode,5,"Text10",null,null)%></td>
						...
						<tr class="TextRow01">
							...
							<td><%=fb.textBox("electro4",prop.getProperty("electro4"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro5",prop.getProperty("electro5"),false,false,viewMode,5,"Text10",null,"")%></td>
							...
							<td width="13%"><%=fb.textBox("electro3",prop.getProperty("electro3"),false,false,viewMode,5,"Text10",null,null)%></td>
							<td width="10%"><cellbytelabel id="38">ml/kg</cellbytelabel></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="39">Fosfato Na</cellbytelabel></td>
							<td><%=fb.textBox("electro7",prop.getProperty("electro7"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro8",prop.getProperty("electro8"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><cellbytelabel id="40">Heparina</cellbytelabel></td>
							<td><%=fb.textBox("electro9",prop.getProperty("electro9"),false,false,viewMode,5,"Text10",null,null)%></td>
							<td><cellbytelabel id="35">U/d&iacute;a</cellbytelabel></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="41">KCL</cellbytelabel></td>
							<td><%=fb.textBox("electro10",prop.getProperty("electro10"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro11",prop.getProperty("electro11"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
							<td rowspan="4" >&nbsp;</td>
							<td rowspan="4" colspan="3" valign="top"><cellbytelabel id="42">Otros</cellbytelabel> <%=fb.textarea("electro12",prop.getProperty("electro12"),false,false,viewMode,50,3,2000,null,"",null)%></td>
						</tr>
						
						<tr class="TextRow01">
							<td><cellbytelabel id="43">Acetato K</cellbytelabel></td>
							<td><%=fb.textBox("electro13",prop.getProperty("electro13"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro14",prop.getProperty("electro14"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
						</tr>
						
						<tr class="TextRow01">
							<td><cellbytelabel id="44">Fosfato K</cellbytelabel></td>
							<td><%=fb.textBox("electro15",prop.getProperty("electro15"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro16",prop.getProperty("electro16"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="45">MgSO</cellbytelabel></td>
							<td><%=fb.textBox("electro17",prop.getProperty("electro17"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="32">mEq/kg</cellbytelabel></td>
							<td>&nbsp;</td>
							<td><%=fb.textBox("electro18",prop.getProperty("electro18"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td><cellbytelabel id="33">mEq/d&iacute;a</cellbytelabel></td>
						</tr>
						<tr class="TextRow01">
							<td><cellbytelabel id="46">Elementos Trazas</cellbytelabel>:</td>
							<td><%=fb.textBox("electro19",prop.getProperty("electro19"),false,false,viewMode,5,"Text10",null,"")%></td>
						...
						<tr class="TextRow01">
							...
							<td><%=fb.textBox("electro21",prop.getProperty("electro21"),false,false,viewMode,5,"Text10",null,"")%></td>
							<td>(<cellbytelabel id="50">mcg/d&iacute;a</cellbytelabel>)</td>
							<td>&nbsp;</td>
							<td><%=fb.checkbox("electro22","S",(prop.getProperty("electro22").equalsIgnoreCase("S")),viewMode,null,null,"")%></td>
						...
						<tr class="TextRow01">
							...
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><%=fb.checkbox("electro23","S",(prop.getProperty("electro23").equalsIgnoreCase("S")),viewMode,null,null,"")%></td>
...
fb.appendJsValidation("if(error>0)doAction();");%>
		<tr class="TextRow02">
			<td colspan="9" align="right">
				<cellbytelabel id="53">Opciones de Guardar</cellbytelabel>:
				<!--<%=fb.radio("saveOption","N",false,viewMode,false)%>Crear Otro-->
				<%=fb.radio("saveOption","O",true,viewMode,false)%><cellbytelabel id="54">Mantener Abierto</cellbytelabel>
				<%=fb.radio("saveOption","C",false,viewMode,false)%><cellbytelabel id="55">Cerrar</cellbytelabel>
