...
function doAction(){newHeight();var cda = document.form0.codigoAlmacen.value;if(cda==''){ alert('No se puede general la Solicigud, no se ha encontrado el cÓdigo de almacén..., VERIFIQUE!');}else{<%if(type!=null && type.equals("1")){%>showListInsumo();<%}%>}}
