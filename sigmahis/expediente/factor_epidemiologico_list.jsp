...
sql = "select codigo, descripcion from tbl_sal_factor_epidemiologico "+appendFilter+" order by codigo";
al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_factor_epidemiologico "+appendFilter);
...
document.title = 'Factores Epidemiológicos - '+document.title;

function add()
{
	abrir_ventana('../expediente/factor_epidemiologico_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/factor_epidemiologico_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_factor_epidemiologico.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - FACTOR EPIDEMIOLOGICO"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo factor epidemiologico</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
