...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("edad") != null && !request.getParameter("edad").trim().equals(""))
  {
	...
	edad    = request.getParameter("edad");    // utilizada para mantener la Descripción filtrada
  }
  if (request.getParameter("estado") != null && !request.getParameter("estado").trim().equals(""))
  {
	...
	estado    = request.getParameter("estado");    // utilizada para mantener la Descripción filtrada
  }

  sql = "SELECT codigo, descripcion,decode(edad,1,'2 MESES',2,'4 MESES',3,'6 MESES',4,'9 MESES',5,'12 MESES',6,'18 MESES',7,'2 AÑOS',8,'3 AÑOS',9,'5 AÑOS',10,'OTRAS') descEdad,decode(estado,'A','ACTIVA','I','INACTIVA') estado FROM tbl_sal_crecimiento_desarrollo WHERE codigo<>0"+appendFilter+" order by codigo";
			...
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">		
					...
					<td width="20%"><cellbytelabel id="4">Edad</cellbytelabel>
						<%=fb.select("edad","1=2 MESES,2=4 MESES,3=6 MESES,4=9 MESES,5=12 MESES,6=18 MESES,7=2 AÑOS,8=3 AÑOS,9=5 AÑOS,10=OTRAS",edad,false,false,0,"S")%>
					</td>
