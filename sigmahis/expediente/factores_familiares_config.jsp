...
sql = "select codigo, descripcion, orden, es_default from tbl_sal_diagnostico_familiar where codigo="+id;
...
else
{
  ...
  cdo.setTableName("tbl_sal_diagnostico_familiar");
...
<%
	if (session.getAttribute("_urlInfo") != null && ((Hashtable) session.getAttribute("_urlInfo")).containsKey(request.getContextPath()+"/expediente/factores_familiares_list.jsp"))
	{
%>
	window.opener.location = '<%=(String) ((Hashtable) session.getAttribute("_urlInfo")).get(request.getContextPath()+"/expediente/factores_familiares_list.jsp")%>';
<%
	}
	else
	{
%>
	window.opener.location = '<%=request.getContextPath()%>/expediente/factores_familiares_list.jsp';
<%
	}
