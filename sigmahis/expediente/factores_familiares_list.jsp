...
sql = "select codigo, descripcion, orden, es_default, status from tbl_sal_diagnostico_familiar"+appendFilter+" order by orden";
al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_diagnostico_familiar "+appendFilter);
...
document.title = 'Factores Familiares - '+document.title;

function add()
{
	abrir_ventana('../expediente/factores_familiares_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/factores_familiares_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_factores_familiares.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - FACTORES FAMILIARES"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo factor familiar</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="10%"><cellbytelabel id="3">Por defecto</cellbytelabel></td>
			<td width="8%"><cellbytelabel id="3">Estado</cellbytelabel></td>
			<td width="5%">&nbsp;</td>
		</tr>
<%
