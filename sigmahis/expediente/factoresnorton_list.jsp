...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("codigo") != null && !request.getParameter("codigo").trim().equals(""))
  {
    appendFilter += " and upper(codigo) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
		codigo     = request.getParameter("codigo");      // utilizada para mantener el Código del Factor
  }
  if (request.getParameter("descripcion") != null && !request.getParameter("descripcion").trim().equals(""))
  {
    appendFilter += " and upper(descripcion) like '%"+request.getParameter("descripcion").toUpperCase()+"%'";
		descrip    = request.getParameter("descripcion");  // utilizada para mantener la Descripción del Factor
  }
		...
		<td>
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">		
				    ...
				    <td width="50%">
					<cellbytelabel id="2">Tipo</cellbytelabel><%=fb.select("fg","NO=ESCALA DE NORTON,NI=NIPS,WB=WONG BAKER,CR=CRIES,AN=ANALOGA,MO=MORSE,BR=BRADEN,SG=SUSAN GIVENS,DO=ESCALA DOWNTON,CA=CAMPBELL,MAC=MACDEMS,MM5=MENORES DE 5 AÑOS,DF=DISCAPACIDAD FISICA,FOUR=ESCALA DE FOUR,TVP=ESACALA TPV - TEV,RAM=RAMSEY,OT=OTRAS",fg,false,false,0,"")%>  <cellbytelabel id="3">C&oacute;digo</cellbytelabel>
