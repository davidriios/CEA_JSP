...
sql = "select codigo, descripcion from tbl_sal_grupo_dosis"+appendFilter+" order by codigo";
al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_grupo_dosis "+appendFilter);
...
document.title = 'Formas Farmaceuticas - '+document.title;

function add()
{
	abrir_ventana('../expediente/formas_farmaceuticas_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/formas_farmaceuticas_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_formas_farmaceuticas.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - FORMAS FARMACEUTICAS"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Tipo de formas farmac&eacute;uticas</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="80%"><cellbytelabel id="3">Descripci&oacute;n</cellbytelabel></td>
			<td width="10%">&nbsp;</td>
		</tr>
<%
