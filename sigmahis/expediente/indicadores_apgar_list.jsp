...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = " SELECT codigo, descripcion FROM tbl_sal_indicador_apgar "+appendFilter+" ORDER BY codigo ASC ";
  al = SQLMgr.getDataList(" select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount(" SELECT count(*) FROM tbl_sal_indicador_apgar "+appendFilter);
...
function add()
{
	abrir_ventana('../expediente/indicadores_apgar_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/indicadores_apgar_config.jsp?mode=edit&id='+id);
}


function printList()
{
	abrir_ventana('../expediente/print_list_indicadores_apgar.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<tr>
<td align="right">&nbsp;
	   <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Indicador Apgar</cellbytelabel> ]</a></authtype>
</td>
</tr>
<tr>
<td>
