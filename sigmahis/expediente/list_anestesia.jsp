...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "select codigo, descripcion from tbl_SAL_TIPO_ANESTESIA WHERE codigo <>0 "+appendFilter+" ORDER BY codigo";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_SAL_TIPO_ANESTESIA a WHERE codigo <>0 "+appendFilter+" order by codigo");
...
{ 
	...
	{ 
	   case 1:
	       eval('window.opener.document.form0.tipoanestesia<%=index%>').value = code;
           eval('window.opener.document.form0.anestesia<%=index%>').value = name;
		   window.close();
	   break;
	   case 2:
	       eval('window.opener.document.form0.anestesia').value = code;
           eval('window.opener.document.form0.descAnestesia').value = name;
		   window.close();
	   break;
	    case 3:// Evaluacion Broncoscopia
	       eval('window.opener.document.form0.anestesia').value = code;
           eval('window.opener.document.form0.descAnestesia').value = name;
		   window.close();
	   break;
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
            ...
            <%=fb.formStart(true)%>
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:returnValue(<%=i%>,<%=id%>)">
