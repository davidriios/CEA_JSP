...
sql = "select codigo, descripcion,decode(estado,'A','ACTIVO','I','INACTIVO') estado from tbl_sal_dolor where codigo is not null "+appendFilter+" order by codigo";
...
document.title = 'Tipos de Dolor - '+document.title;

function add()
{
	abrir_ventana('../expediente/dolor_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/dolor_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_dolor.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Dolor</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
