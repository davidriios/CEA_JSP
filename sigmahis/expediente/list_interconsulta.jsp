...
<%=fb.hidden("fg",fg)%>
	...
	<tr class="TextHeader">
	  ...
	  <td colspan="2" ><cellbytelabel id="4">FECHA</cellbytelabel></td>
		<td><cellbytelabel id="5">OBSERVACIONES</cellbytelabel></td>
	</tr>
<%
String fecha = "";
int cont = 0;
...
%>
		<tr class="TextHeader01">
			<td colspan="3">[<%=cdo.getColValue("fecha")%>] <%=cdo.getColValue("nombremedico")%></td>
		</tr>
<%
	}
%>
		...
		<tr class="<%=color%>" onMouseOut="setoutc(this,'<%=color%>')">
			<td align="center">&nbsp;</td>
			<td colspan="2"><cellbytelabel id="6">Observaci&oacute;n M&eacute;dico de Planta</cellbytelabel><%=fb.textarea("observacion1"+i,cdo.getColValue("observacion1"),false,false,true,80,7,2000,"","width:100%","")%></td>
		</tr>
		<tr class="<%=color%>" onMouseOut="setoutc(this,'<%=color%>')">
			<td align="center">&nbsp;</td>
			<td colspan="2"><cellbytelabel id="7">Observaci&oacute;n del Interconsultor</cellbytelabel><%=fb.textarea("observacion1"+i,cdo.getColValue("observacion2"),false,false,true,80,7,2000,"","width:100%","")%></td>
		</tr>
<%
