...
sql = "select codigo, descripcion,decode(estado,'A','ACTIVO','I','INACTIVO') estado from tbl_sal_intervencion_dolor where codigo is not null "+appendFilter+" order by codigo";
...
document.title = 'Intervencion - Dolor - '+document.title;

function add()
{
	abrir_ventana('../expediente/intervencion_dolor_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/intervencion_dolor_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_intervencion_dolor.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
