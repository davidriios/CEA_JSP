...
sql = "select id, nombre,status ,decode(status,'A','ACTIVA','I','INACTIVA') descStatus from tbl_sal_tipo_muestra_eval "+appendFilter+" order by id";
...
document.title = 'Muestras - '+document.title;

function add()
{
	abrir_ventana('../expediente/tipo_muestra_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/tipo_muestra_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_muestra.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - MUESTRAS"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Tipo de Muestra</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
