...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  {
    appendFilter += (!appendFilter.trim().equals(""))?" and ":" where ";
  ...
  sql = "select codigo, descripcion, decode(estado,'A','ACTIVO','I','INACTIVO')as ESTADO, decode(finaliza_atencion,0,'NO','SI') as finaliza_atencion from tbl_sal_orden_salida "+appendFilter+" order by codigo";
...
document.title = 'Ordenes de Salidas - '+document.title;

function add()
{
	abrir_ventana('../expediente/ordenes_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/ordenes_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_ordenes_salida.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<tr>
	<td align="right">&nbsp;
		<authtype type='3'>  <a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva Orden de Salida</cellbytelabel> ]</a></authtype>
	</td>
</tr>
<tr>
	<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader">
			...
			<td width="20%"><cellbytelabel id="8">Estado</cellbytelabel></td>
			<td width="20%"><cellbytelabel>Finaliza Atenci&oacute;n</cellbytelabel></td>
			<td width="10%">&nbsp;</td>
		</tr>				
<%
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td><%=cdo.getColValue("finaliza_atencion")%></td>
			<td align="center">&nbsp;
<%
