...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
	...
	{
		appendFilter += " where upper(id) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
...
sql = "select id, nombre, descripcion,status, decode(status,'A','ACTIVA','I','INACTIVA') descStatus from tbl_sal_tecnica_evaluacion  "+appendFilter+" order by id";
...
document.title = 'Tecnicas - '+document.title;

function add()
{
	abrir_ventana('../expediente/tecnicas_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/tecnicas_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_tecnicas.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE - MANTENIMIENTO - TIPO DE TECNICAS"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">&nbsp;
<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva T&eacute;cnica</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
