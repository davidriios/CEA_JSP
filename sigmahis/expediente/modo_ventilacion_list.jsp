...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "select id, descripcion, codigo, decode(status,'A','ACTIVO','INACTIVO') status,orden from tbl_sal_modo_ventilacion where status is not null "+appendFilter+" order by 1";
...
document.title = 'Modos de Ventilacion - '+document.title;

function add()
{
	abrir_ventana('modo_ventilacion_config.jsp');
}

function edit(id)
{
	abrir_ventana('modo_ventilacion_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('print_modo_vent_list.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
       		<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Modo Ventilaci&oacute;n</cellbytelabel> ]</a></audtype>
	    </td>
    </tr>
	<tr>
		<td>
