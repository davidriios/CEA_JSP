...
sql = "select codigo, descripcion, estado, orden from tbl_sal_pregunta where descripcion is not null"+appendFilter+" order by codigo";
...
document.title = 'Preguntas Pre - Operatorias - '+document.title;

function add()
{
	abrir_ventana('../expediente/preguntas_pre_op_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/preguntas_pre_op_config.jsp?mode=edit&id='+id);
}
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PREGUNTAS PRE - OPERATORIA"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nueva pregunta pre-operator&iacute;a</cellbytelabel> ]</a></authtype>
		</td>
  </tr>
	<tr>
		<td>
