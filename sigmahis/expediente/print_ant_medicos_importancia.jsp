...
String userName = UserDet.getUserName();
	    ArrayList alTipo = new ArrayList();
		 ...
		 sql = "select codigo, descripcion, orden, es_default, decode(estado,'A','ACTIVO','I','INACTIVO') estado from tbl_sal_ant_med_importantes"+appendFilter+" order by orden";
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_factores_familiares";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("FACTORES FAMILIARES",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No Existen Factores Familiares Registrados.",1,2);
					pc.addTable();
