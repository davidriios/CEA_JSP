...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
   ...
   String iconChecked = ResourceBundle.getBundle("path").getString("images")+"/radiobutton_checked.gif";
		...
		pc.addBorderCols("Cod Vac.",1 ,1,15.2f);
		pc.addBorderCols("Vacuna",1 ,1,15.2f);
		pc.addBorderCols("SI",0 ,1,15.2f);
		pc.addBorderCols("NO",1 ,1,15.5f);
		pc.addBorderCols("Refuerzo/Vacunas/dosis",1 ,1,15.2f);
		pc.addBorderCols("Año",1 ,1,15.2f);
		pc.addBorderCols("Meses",1 ,1,15.2f);
		...
		pc.setFont(7, 0);
		pc.addCols(cdo.getColValue("COD_VACUNA"),0,1,15.2f);
		pc.addCols(cdo.getColValue("DESCRIPCION"),0,1,15.2f);
		pc.addCols(si,1,1);
		pc.addCols(no,1,1);
		pc.addCols(cdo.getColValue("refuerzo"),1,1,15.2f);
		pc.addCols(cdo.getColValue("anio"),1,1,15.2f);
