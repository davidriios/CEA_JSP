...
cdop = SQLMgr.getPacData(pacId, noAdmision);
  ...
  sql = "select a.codigo, a.descripcion, b.fec_nacimiento, b.cod_paciente, b.cod_epidem, b.observacion, nvl(decode(b.aplicar,'S','SI','N','NO'),'NO') as aplicar, b.pac_id from tbl_sal_factor_epidemiologico a, tbl_sal_antecedente_epidem b where a.codigo=b.cod_epidem(+) and b.pac_id(+)="+pacId;
...
//{
    ...
    cdo.addColValue("is_landscape",""+isLandscape);
    }
