...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
   ...
   String iconChecked = ResourceBundle.getBundle("path").getString("images")+"/radiobutton_checked.gif";
      ...
      pc.setFont(9, 1);
      pc.addCols("Fecha: "+cdo.getColValue("fecha_creacion_dsp", " "), 0, dHeader.size());
      pc.addCols("Creado por: "+cdo.getColValue("usuario_creacion", " "), 0, dHeader.size());
		}
