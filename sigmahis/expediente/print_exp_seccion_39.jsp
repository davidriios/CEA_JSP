...
System.out.println(sql);
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(cdo.getColValue("fecha_muerte"),0,1);
		pc.addCols(cdo.getColValue("hora_muerte"),0,1);
		pc.addCols(cdo.getColValue("numero_acta"),0,1);
		pc.addCols(cdo.getColValue("estado_patologo"),0,1);
		pc.addCols(cdo.getColValue("observa_a"),0,1);
