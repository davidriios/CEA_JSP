...
isUnifiedExp=true;}
		...
		if(al.size()<1){
			...
			for(int i = 0; i<al.size(); i++){
				...
				pc.addCols("Medico: "+cdo.getColValue("nombre_medico"),0,5,Color.gray);
				pc.addCols("Fecha: "+cdo.getColValue("fecha"),2,1,Color.gray);
				
				pc.setFont(8,0);
				pc.addBorderCols("Hora",1,1);
				pc.addBorderCols("Observaciones del Medico",1,5);
