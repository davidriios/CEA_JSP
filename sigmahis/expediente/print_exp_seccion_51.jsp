...
sbSql.append("select CODIGO, DESCRIPCION, USUARIO_CREAC, to_char(FECHA_CREAC,'dd/mm/yyyy hh12:mi:ss am') as FECHA_CREAC, USUARIO_MODIF, to_char(FECHA_MODIF,'dd/mm/yyyy hh12:mi:ss am') as FECHA_MODIF from TBL_SAL_RESULTADO_EKG where pac_id=");
sbSql.append(pacId);
sbSql.append(" and secuencia=");
sbSql.append(noAdmision);
if(!codigo.trim().equals("") && !fg.trim().equals("TD"))
{
	sbSql.append(" and codigo=");
	sbSql.append(codigo);
}
sbSql.append(" order by fecha_creac ");
...
/*//control imgae
		...
		pc.addBorderCols("Modificada el:", 1,1);
		pc.addBorderCols("Modificada por:", 1,1);
		...
		for (int i=0; i<al.size(); i++)
		{
			...
			pc.addCols(cdo.getColValue("USUARIO_CREAC"), 1,1);
			pc.addCols(cdo.getColValue("FECHA_MODIF"), 1,1);
			pc.addCols(cdo.getColValue("usuario_modif"), 1,1);
