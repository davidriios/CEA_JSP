...
sql = "select b.id, b.descripcion, a.pac_id, a.admision, nvl(a.seleccionado,'N') as seleccionado, a.observacion, b.evaluable, b.comentable, a.usuario_creacion from tbl_sal_enfermedad_operacion a, tbl_sal_parametro b where a.pac_id(+)="+pacId+" and b.tipo='PEO' and  a.parametro_id(+)=b.id order by orden, a.observacion desc nulls last";
