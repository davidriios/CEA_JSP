...
isUnifiedExp=true;}
		...
		if(prop == null){
			...
			if(prop.getProperty("acompañante").equalsIgnoreCase("F")){
				pc.addBorderCols("Familiar",0,1,0.5f,0.0f,0.0f,0.0f);
				pc.addBorderCols("",0,3,0.5f,0.0f,0.0f,0.0f);
				pc.addCols("",0,dHeader.size(),5f);
			}else
			if(prop.getProperty("acompañante").equalsIgnoreCase("C")){
				pc.addBorderCols("Camillero",0,1,0.5f,0.0f,0.0f,0.0f);
				pc.addBorderCols("",0,3,0.5f,0.0f,0.0f,0.0f);
				pc.addCols("",0,dHeader.size(),5f);
			}else
			if(prop.getProperty("acompañante").equalsIgnoreCase("E")){
				pc.addBorderCols("Personal Enf.",0,1,0.5f,0.0f,0.0f,0.0f);
				pc.addBorderCols("",0,3,0.5f,0.0f,0.0f,0.0f);
				pc.addCols("",0,dHeader.size(),5f);
			}else
			if(prop.getProperty("acompañante").equalsIgnoreCase("M")){
				pc.addBorderCols("Meedico",0,1,0.5f,0.0f,0.0f,0.0f);
				pc.addBorderCols("",0,3,0.5f,0.0f,0.0f,0.0f);
				pc.addCols("",0,dHeader.size(),5f);
			}else
			if(prop.getProperty("acompañante").equalsIgnoreCase("S")){
			...
			pc.addBorderCols("OBSERVACION (DX DE ENFERMERIA)",0,3,0.5f,0.0f,0.0f,0.0f);
			pc.addBorderCols(prop.getProperty("obserEnf"),0,3,0.5f,0.0f,0.0f,0.0f);
			pc.addCols("",0,dHeader.size(),5f);
			...
			if(fg.trim().equals("NIPE")){
				pc.addBorderCols("PLAN DE CUIDADO INICIAL: ",0,4,0.5f,0.0f,0.0f,0.0f);
				pc.addBorderCols(prop.getProperty("plan_incial"),0,2,0.5f,0.0f,0.0f,0.0f);
				pc.addCols("",0,dHeader.size(),5f);
			}
