...
sql="SELECT a.codigo AS cod_antecedente, a.descripcion, nvl(b.valor,' ') AS valor, nvl(b.observacion,' ') as observacion from TBL_SAL_DIAGNOSTICO_FAMILIAR a, TBL_SAL_ANTECEDENTE_FAMILIAR b where 1 = 1";

if (fp.trim().equalsIgnoreCase("exp_kardex")) sql += " and a.CODIGO=b.ANTECEDENTE AND b.PAC_ID = "+pacId;
else sql += " and a.CODIGO=b.ANTECEDENTE(+) AND b.PAC_ID(+) = "+pacId;
sql += " order by orden, b.observacion NULLS LAST ";
