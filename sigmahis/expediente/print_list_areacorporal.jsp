...
String userName = UserDet.getUserName();
		   ...
		   sql = "SELECT codigo, descripcion FROM tbl_sal_examen_areas_corp WHERE codigo<>0"+appendFilter+" order by descripcion";
 	...
 	if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_areacorporal";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("FACTORES A EVALUAR EN EL EXAMEN FÍSICO",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No Existen Areas Corporales Registradas.",1,2);
					pc.addTable();
