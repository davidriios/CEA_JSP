...
sql = "SELECT id, name, description, decode(status,'A','ACTIVO','I','INACTIVO') as status FROM tbl_sal_exp_docs where id is not null"+appendFilter+" ORDER BY name";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String title = "DOCUMENTOS MEDICOS";
	String subtitle = "";
	String xtraSubtitle = "";
