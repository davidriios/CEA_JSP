...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select id, descripcion, tipo,orden, decode(status,'A','ACTIVO','INACTIVO') status from tbl_sal_parametro where tipo = '"+fg+"' "+appendFilter+" order by id ";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String title = "ENFERMEDADES Y OPERACIONES";
	String subtitle = "";
	String xtraSubtitle = "";
