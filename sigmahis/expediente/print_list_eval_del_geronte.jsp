...
String userName = UserDet.getUserName();
     ...
     sql = "SELECT codigo, descripcion FROM tbl_sal_eval_geronte WHERE codigo<>0"+appendFilter+" order by 1";
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_eval_del_geronte";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No hay registros!!",1,2);
					pc.addTable();
