...
String userName = UserDet.getUserName();
			ArrayList al   = new ArrayList();
 			...
 			sql = "SELECT codigo, descripcion FROM tbl_sal_crecimiento_desarrollo WHERE codigo<>0"+appendFilter+" order by descripcion";
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_factores_crecimiento";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("FACTORES DE CRECIMIENTO Y DESARROLLO",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Factores de Crecimientos y Desarrollo Registrados.",1,2);
					pc.addTable();
