...
String userName = UserDet.getUserName();
	    ArrayList alTipo = new ArrayList();
		  ...
		  sql = "select codigo, descripcion, decode(activar_obs,'N','NO','S','SI') as activado from tbl_sal_diagnostico_personal"+appendFilter;
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_factores_personales";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("FACTORES PERSONALES",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No Existen Factores Personales Registrados.",1,2);
					pc.addTable();
					...
					for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
					{
							...
							pc.addCols(" "+cdo1.getColValue("activado"), 1,1);
							pc.addTable();
							if ((i + 1) == nItems) break;
					}//End For
