...
String userName = UserDet.getUserName();
      ...
      sql = "SELECT codigo, descripcion FROM tbl_sal_concepto_norton WHERE codigo<>0"+appendFilter+" order by descripcion";
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_escala_norton";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("FACTORES DE LA ESCALA DE NORTON",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Factores de la Escala de Norton Registrados.",1,2);
					pc.addTable();
