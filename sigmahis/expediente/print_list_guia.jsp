...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select id, nombre, descripcion,tipo, decode(status,'A','ACTIVO','INACTIVO') status from tbl_sal_guia "+appendFilter+" order by descripcion";
