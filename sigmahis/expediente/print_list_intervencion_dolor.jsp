...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select codigo, descripcion, decode(tipo,'ME','MEDICA','NO - FARMACOLOGICA') tipo, decode(estado,'A','ACTIVO','INACTIVO') estado from tbl_sal_intervencion_dolor "+appendFilter+" order by codigo";
