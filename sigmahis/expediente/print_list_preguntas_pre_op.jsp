...
String userName = UserDet.getUserName();
      ...
      sql = "select codigo, descripcion, decode(estado,'A','ACTIVO','INACTIVO') estado, orden from tbl_sal_pregunta where descripcion is not null "+appendFilter+" order by codigo";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("PREGUNTAS A LA REVISION PRE-OPERATORIA",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No Existen Preguntas para la Revision Pre-operatoria Registrados.",1,2);
					pc.addTable();
