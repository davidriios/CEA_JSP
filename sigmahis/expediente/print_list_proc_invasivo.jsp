...
String userName = UserDet.getUserName();
	    ArrayList alTipo = new ArrayList();
			...
			sql = "select codigo, descripcion, decode(estado, 'A','ACTIVO', 'I', 'INACTIVO') estado_desc from tbl_sal_infeccion where 1 = 1 "+appendFilter+" order by orden";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("PROCEDIMEINTOS INVASIVOS",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(7, 1);
						pc.addCols("No Existen Procedimientos Invasivos Registrados.",1,2);
					pc.addTable();
					...
					for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
					{
							...
							pc.addCols(" "+cdo1.getColValue("estado_desc"," "), 0,1);
