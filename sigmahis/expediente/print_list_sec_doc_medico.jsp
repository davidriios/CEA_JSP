...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("SECCIONES DE DOCUMENTOS MÉDICOS",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Secciones de Documentos Médicos Registrados.",1,4);
					pc.addTable();
					...
					for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
					{
							...
							pc.setFont(7, 1);
								...
								pc.addCols(" "+cdo1.getColValue("usadoPor"),0,1);
							pc.addTable();
							if ((i + 1) == nItems)
							{
		   						pc.createTable();
