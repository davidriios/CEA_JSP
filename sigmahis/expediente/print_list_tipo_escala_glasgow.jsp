...
sql = "select codigo, descripcion,decode(tipo,'A','ADULTOS','N','NIÑOS','T','AMBOS') tipo FROM tbl_sal_tipo_escala "+appendFilter+" ORDER BY codigo ASC ";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE ESCALA GLASGOW";
	String xtraSubtitle = "";
