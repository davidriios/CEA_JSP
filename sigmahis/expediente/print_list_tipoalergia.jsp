...
String userName = UserDet.getUserName();
     ...
     sql = "SELECT codigo, descripcion,orden, decode(es_default,'S','SI','NO') es_default FROM tbl_sal_tipo_alergia WHERE codigo<>0"+appendFilter+" order by orden";
...
String logoPath = companyImageDir+"/"+((_comp.getLogo() != null && !_comp.getLogo().trim().equals(""))?_comp.getLogo():"blank.gif");
		...
		String fileNamePrefix = "print_tipos_alergias";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("TIPOS DE ALERGÍAS",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Tipos de Alergías Registrados.",1,2);
					pc.addTable();
