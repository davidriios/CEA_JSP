...
//com = (Company) sbb.getSingleRowBean(ConMgr.getConnection(),sql,Company.class);
	  ...
	  sql="SELECT a.codigo, trim(a.descripcion) descripcion, b.codigo as subtipocod, b.cod_tipo_dieta, b.descripcion as subdieatdesc, b.observacion FROM tbl_cds_tipo_dieta a, tbl_cds_subtipo_dieta b WHERE  a.codigo=b.cod_tipo_dieta "+appendFilter+" order by a.descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPO DE DIETAS";
	String xtraSubtitle = "";
