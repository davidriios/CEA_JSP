...
//com = (Company) sbb.getSingleRowBean(ConMgr.getConnection(),sql,Company.class);
	  ...
	  sql="SELECT a.codigo, trim(a.descripcion) descripcion, b.codigo as subtipocod, b.cod_tipo_ordenvarios, b.descripcion as subdieatdesc, b.observacion FROM TBL_CDS_ORDENMEDICA_VARIOS a, TBL_CDS_OM_VARIOS_SUBTIPO b WHERE  a.codigo=b.cod_tipo_ordenvarios "+appendFilter+" order by a.descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPO DE ORDENMEDICA VARIOS";
	String xtraSubtitle = "";
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		if (!dieta.equalsIgnoreCase(cdo.getColValue("descripcion")))
			{
		...
		pc.setFont(7, 0);
		pc.setVAlignment(0);
			pc.addCols(" "+cdo.getColValue("subtipocod"),1,1);
			pc.addCols(" "+cdo.getColValue("subdieatdesc"),0,1);
			pc.addCols(" "+cdo.getColValue("observacion"),0,1);	
				
			
			dieta=cdo.getColValue("descripcion");	
