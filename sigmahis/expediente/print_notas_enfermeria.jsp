	...
	for (int i=0; i<al.size(); i++)
	{
		...
		if (fp.trim().equals("HM"))
		{
			...
			if (!groupBy2.trim().equalsIgnoreCase(cdo.getColValue("id")))
			{
				...
				pc.addBorderCols("SOLUCION",1,6,0.5f,0.5f,0.5f,0.5f,cHeight);
				pc.addBorderCols("PESO INICIAL",1,1,0.5f,0.5f,0.5f,0.5f,cHeight);
				pc.addBorderCols("PESO FINAL",1,1,0.5f,0.5f,0.5f,0.5f,cHeight);
				...
				pc.addBorderCols(cdo.getColValue("solucion"),1,6,0.5f,0.5f,0.5f,0.5f,cHeight);
				pc.addBorderCols(cdo.getColValue("peso_inicial"),1,1,0.5f,0.5f,0.5f,0.5f,cHeight);
				pc.addBorderCols(cdo.getColValue("peso_final"),1,1,0.5f,0.5f,0.5f,0.5f,cHeight);
