...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = " SELECT codigo, descripcion FROM tbl_sal_recuperacion_anestesia "+appendFilter+" ORDER BY codigo ASC ";
...
function add()
{
	abrir_ventana('../expediente/recuperacion_post_anestesia_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/recuperacion_post_anestesia_config.jsp?mode=edit&id='+id);
}


function printList()
{
	abrir_ventana('../expediente/print_recuperacion_post_anestesia_list.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<tr>
<td align="right">&nbsp;
       <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Recuperacion Anestesia</cellbytelabel> ]</a></authtype>
</td>
</tr>
<tr>
<td>
