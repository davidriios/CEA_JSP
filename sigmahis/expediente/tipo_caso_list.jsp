...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
    ...
    searchType = "1";
    searchDisp = "Código";
		codigo     = request.getParameter("codigo");         // utilizada para mantener el Código del Caso Policivo
	}
    ...
    searchDisp = "Descripción";
		descrip    = request.getParameter("descripcion");   // utilizada para mantener la Descripción del Caso Policivo
	}
  ...
  else
  {
	...
	sql = "select codigo, descripcion, decode(activar_obs,'N','No','S','Si') as activado from tbl_sal_tipo_caso"+appendFilter;
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from tbl_sal_tipo_caso "+appendFilter);
...
document.title = 'Expediente - Informe de casos polisivo -Tipo de Caso - '+document.title;

function add()
{
	abrir_ventana('../expediente/tipo_caso_config.jsp');
}

function edit(id)
{
	abrir_ventana('../expediente/tipo_caso_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../expediente/print_list_tipo_caso.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="EXPEDIENTE- INFORME DE CASO POLICIVO- TIPO DE CASO"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right">
			<authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevos tipo de caso</cellbytelabel> ]</a></authtype>
		</td>
  </tr> 
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
			...
			<td width="10%"> <cellbytelabel id="4">Obs.Activa</cellbytelabel></td>
			<td width="10%">&nbsp;</td>
		</tr>
<%
