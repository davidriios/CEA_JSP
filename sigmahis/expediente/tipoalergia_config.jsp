...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (code == null) throw new Exception("El Tipo de Alergía no es válido. Por favor intente nuevamente!");
...
<%if(mode.equalsIgnoreCase("add")){%>
document.title=" Tipo Alergía Agregar - "+document.title;
<%}else if(mode.equalsIgnoreCase("edit")){%>
document.title=" Tipo Alergía Edición - "+document.title;
<%}%>
</script>
</head>
