...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion,orden, decode(es_default,'S','SI','NO') es_default, decode(status,'A','ACTIVO','INACTIVO') status FROM tbl_sal_tipo_alergia WHERE codigo<>0"+appendFilter+" order by orden";
  al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_sal_tipo_alergia WHERE codigo<>0"+appendFilter);
...
<script>
document.title = 'Tipos de Alergías - '+document.title;

function add()
{
	abrir_ventana('tipoalergia_config.jsp');
}

function edit(code)
{
	abrir_ventana('tipoalergia_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_tipoalergia.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right">
          <authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel id="1">Registrar Nuevo Tipo de Alerg&iacute;a</cellbytelabel> ]</a></authtype>
   	    </td>
    </tr>
	<tr>
		<td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="list">
				<tr class="TextHeader">
					...
					<td width="10%" align="center"><cellbytelabel id="3">Orden</cellbytelabel></td>
					<td width="10%" align="center"><cellbytelabel id="3">Por defecto</cellbytelabel></td>
