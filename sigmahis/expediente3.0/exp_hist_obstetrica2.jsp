...
/*End here */
cdoBB = new CommonDataObject();
CommonDataObject cdoH1 = SQLMgr.getData("select embarazo, nvl(numero_hijo,1) numero_hijo, to_char(fecha_ruptura,'dd/mm/yyyy')||' '||to_char(hora_ruptura,'hh12:mi am') fecha_hora_ruptura from TBL_SAL_HISTORIA_OBSTETRICA where pac_id = "+pacId+" and codigo = "+noAdmision);
...
if(numeroBebe) abrir_ventana1('../expediente3.0/print_hist_obstetrica2.jsp?pacId=<%=pacId%>&noAdmision=<%=noAdmision%>&seccion=<%=seccion%>&desc=<%=desc%>&fecha_hora_nac='+fechaHoraNac+'&tiempo_ruptura='+tiempoRuptura+'&numero_bebe='+numeroBebe);}
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane <%=active0%>" id="datos_recien_nacido">
            ...
            <tr>
                ...
                <td align="right"><cellbytelabel id="7">Tiempo de vida</cellbytelabel></td>
                <td>
                <%=fb.textBox("tiempo_vida",cdo.getColValue("tiempo_vida"),false,false,viewMode,5,15,"form-control input-sm",null,null)%>
            ...
            <tbody>
            <tr>
                <td align="right"><cellbytelabel id="6">Per&iacute;metro cef&aacute;lico</cellbytelabel></td>
                <td colspan="3"><%=fb.textBox("perimetro_cefalico",cdo.getColValue("perimetro_cefalico"),false,false,viewMode,5,30,"form-control input-sm",null,null)%></td>
            </tr>
            </tbody>
            ...
            <tr>
                <td align="right">Evaluaci&oacute;n de riesgo</td>
                <td colspan="3">
                    <label class="pointer"><%=fb.radio("eval_riesgo","S",cdo.getColValue("eval_riesgo"," ").equalsIgnoreCase("S"),viewMode,false,null,null,"")%>&nbsp;<cellbytelabel id="15">Con riesgo</cellbytelabel></label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label class="pointer"><%=fb.radio("eval_riesgo","N",cdo.getColValue("eval_riesgo"," ").equalsIgnoreCase("N"),viewMode,false,null,null,"")%>&nbsp;<cellbytelabel id="15">Sin riesgo</cellbytelabel></label>
                </td>
            </tr>
            
            <tr>
                <td align="right">Se realisar&aacute; RCP</td>
                <td colspan="3">
                    <label class="pointer"><%=fb.radio("rcp","S",cdo.getColValue("rcp"," ").trim().equalsIgnoreCase("S"),viewMode,false,null,null,"")%>&nbsp;<cellbytelabel id="15">SI</cellbytelabel></label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label class="pointer"><%=fb.radio("rcp","N",cdo.getColValue("rcp"," ").trim().equalsIgnoreCase("N"),viewMode,false,null,null,"")%>&nbsp;<cellbytelabel id="15">NO</cellbytelabel></label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="right"><cellbytelabel id="8">Apgar 2</cellbytelabel></td>
                <td class="controls form-inline">
            ...
            <%
            java.util.Vector LP = CmnMgr.str2vector(cdo.getColValue("lugar_permanencia"), java.util.regex.Pattern.quote(","));
            %>
            
            <tr class="bg-headtabla">
                <td colspan="4"><cellbytelabel id="3">Lugar de permanencia del neonato</cellbytelabel>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <label class="pointer">                    
                    <%=fb.checkbox("lugar_permanencia_0", "UCIN",CmnMgr.vectorContains(LP,"UCIN"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Unidad de cuidado Neonatales</cellbytelabel>
                    </label>
                </td>
                <td colspan="2">
                    <label class="pointer"><%=fb.checkbox("lugar_permanencia_1", "JM",CmnMgr.vectorContains(LP,"JM"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Junto a la madre</cellbytelabel></label>
                </td>
            </tr>
            </tbody>
            ...
            <tr>
                <td colspan="2">
                    <label class="pointer"><%=fb.checkbox("lugar_permanencia_2", "USIN",CmnMgr.vectorContains(LP,"USIN"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Unidad de Semi intensivo Neonatal</cellbytelabel></label>
                </td>
                <td colspan="2">
                    <label class="pointer"><%=fb.checkbox("lugar_permanencia_3", "NS",CmnMgr.vectorContains(LP,"NS"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Ni&ntilde;o sano</cellbytelabel></label>
                </td>
            </tr>
            </tbody>
            ...
            <tr>
                <td colspan="2">
                    <label class="pointer"><%=fb.checkbox("lugar_permanencia_4", "AIS",CmnMgr.vectorContains(LP,"AIS"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Aislamiento</cellbytelabel></label>
                </td>
                <td colspan="2">
                    <label class="pointer"><%=fb.checkbox("lugar_permanencia_5", "TRANS",CmnMgr.vectorContains(LP,"TRANS"),viewMode,"lugar_permanencia",null,"")%>&nbsp;<cellbytelabel>Transferido</cellbytelabel></label>
                </td>
            </tr>
            </tbody>
            ...
            <tr>
                <td colspan="4" class="controls form-inline">
                    Lugar:&nbsp;<%=fb.textarea("lugar_transf",cdo.getColValue("lugar_transf"),false,false,viewMode||cdo.getColValue("lugar_transf"," ").equals(" "),60,1,0,"form-control input-sm","","")%>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Fecha/Hora:&nbsp;
                    <jsp:include page="../common/calendar_bootstrap.jsp" flush="true">
                    <jsp:param name="noOfDateTBox" value="1" />
                    <jsp:param name="clearOption" value="true" />
                    <jsp:param name="nameOfTBox1" value="fecha_transf" />
                    <jsp:param name="format" value="dd/mm/yyyy hh12:mi:ss am" />
                    <jsp:param name="valueOfTBox1" value="<%=cdo.getColValue("fecha_transf"," ")%>" />
                    <jsp:param name="readonly" value="<%=viewMode||cdo.getColValue("fecha_transf"," ").equals(" ")?"y":"n"%>" />
                    </jsp:include>
            ...
            <tr>
                ...
                <td colspan="3"><%=fb.textarea("condicion",cdo.getColValue("condicion"),false,false,viewMode,60,1,2000,"form-control input-sm","width:100%","")%></td>
            </tr>
            </tbody>
            ...
            <tr>
                ...
                <td colspan="3"><%=fb.textarea("observacion",cdo.getColValue("observacion"),false,false,viewMode,60,1,2000,"form-control input-sm","width:100%","")%></td>
            </tr>
            </tbody>
            
            <tr class="bg-headtabla">
                <td colspan="4">MEMBRANAS</td>
            </tr>
            <tr>
                <td colspan="4">
                    <span class="pull-left" style="text-align:left">
                            <b>Fecha y hora de Nacimiento:</b>&nbsp;<%=cdoBB.getColValue("fecha_hora_nac"," ")%><br>
                            <b>Tiempo de ruptura de membranas:</b>&nbsp;<%=cdoBB.getColValue("tiempo_ruptura"," ")%>&nbsp;horas
                        </span>
                </td>
            </tr>
            ...
            <div role="tabpanel" class="tab-pane <%=active2%>" id="alumbramiento">
               <%fb = new FormBean2("form1",request.getContextPath()+request.getServletPath(),FormBean2.POST);%>
                ...
                <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                    <tr>
                        <td>Alumbramiento</td>
                        <td><%=fb.select("alumbramiento","ES = Espontáneo, AR = Artificial, ME = Maniobras Externas, EM = Extracción Manual de Anexos, CO = Completa",cdo.getColValue("alumbramiento"),false,false,0,"form-control",null,null,null,"S")%></td>
