...
sectionId = "3,13,6,9,18,63,16,11,27,8";
...
$(function(){
 ...
 $("#section_id").change(function(e) {
      var self = $(this);
      var $tab = $("#tabTabdhtmlgoodies_tabView1_0");
      var $iframe = $("#i_nuevo_antecedente");
      var proceed = true;
...
function setPatientInfo(formName,iframeName){ 
    var $iframe = $("#i_nuevo_antecedente").contents();
    var fn = $("#fechaNacimiento",parent.document).val() || "<%=fechaNacimiento%>"
    var cp = $("#codigoPaciente",parent.document).val() || "<%=fechaNacimiento%>"
    $iframe.find("#dob").val(fn);
    $iframe.find("#codPac").val(cp);
...
<body class="body-form" style="padding-top: 0px !important;">
    ...
    <div class="table-responsive" data-pattern="priority-columns">
        ...
        <table class="table table-small-font table-bordered table-striped">
                          ...
                          <table align="center" width="100%" cellpadding="0" cellspacing="1">
                              ...
                              <tr>
                                  <td>
                                      ...
                                      <iframe id="i_nuevo_antecedente" name="i_nuevo_antecedente" width="100%" height="0" scrolling="no" frameborder="0" src=""></iframe>
                                  </td>
                              </tr>
                          </table>
                       </div>
          ...
          <script>
          <%String tabLabel = "'Nuevo Antecedente'";%>
