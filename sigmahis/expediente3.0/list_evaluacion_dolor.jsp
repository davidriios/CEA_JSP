...
function imprimir(){
  abrir_ventana("../expediente3.0/print_list_evaluacion_dolor.jsp?pacId=<%=pacId%>&noAdmision=<%=noAdmision%>&&desc=<%=desc%>&&fg=<%=fg%>")
}
</script>
</head>
...
<tr>
	<td class="TableBorder">
        ...
        <input type="button" value="Imprimir" class="CellbyteBtn" onclick="javascript:imprimir()">
			</td>
		</tr>
		<tr class="TextRow01">
		...
		<tr class="TextHeader">
			...
			<td width="30%"><cellbytelabel id="9">Intervenci&oacute;n</cellbytelabel></td>
		</tr>
<%
String fecha = "";
