...
sql = "select a.codigo,a.edad, a.descripcion, b.crecimiento,decode(b.crecimiento,null,'N','S') as valor, decode(a.edad,1,'2 MESES',2,'4 MESES',3,'6 MESES',4,'9 MESES',5,'12 MESES',6,'18 MESES',7,'2 AÑOS',8,'3 AÑOS',9,'5 AÑOS',10,'OTRAS') descEdad, b.meses, b.pac_id from  tbl_sal_crecimiento_desarrollo a, tbl_sal_crecimiento_paciente b where a.codigo=b.crecimiento(+) and b.pac_id(+)="+pacId+" and a.edad is not null order by a.edad,a.orden";
