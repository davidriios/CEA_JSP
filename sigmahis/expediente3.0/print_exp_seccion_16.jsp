...
//{
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		String doc = cdo.getColValue("documento1")==null?"":cdo.getColValue("documento1");
		boolean hasImage = hasImage = doc.toLowerCase().endsWith(".gif") || doc.toLowerCase().endsWith(".jpg") || doc.toLowerCase().endsWith(".jpeg")
