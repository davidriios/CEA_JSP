...
isUnifiedExp=true;}
	...
	pc.createTable();
		...
		//second row
		pc.setFont(10, 1);
		pc.addBorderCols("FECHA/USUARIO",1,1);
...
pc.setFont(8, 0);
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(cdo.getColValue("FECHA_CREA"," ")+" / "+cdo.getColValue("USUARIO_CREAC"," "),0,1);
