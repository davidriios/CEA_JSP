...
//java.util.GregorianCalendar gc=new java.util.GregorianCalendar();
	...
	if ( pc==null ){
		...
		pc.setFont(7,3);
		pc.addCols("Tipo Registro: H = Hospitalizado, C=Cirugia",0,dHeader.size());
		pc.addCols("",0,dHeader.size(), 10.2f);
