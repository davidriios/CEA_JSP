...
isUnifiedExp=true;}
		...
		for(int i = 0; i<alIC.size(); i++){
		   ...
		   pc.addCols(cdoIC.getColValue("descripcionEsp"),0,3);
		}
		...
		pc.addCols(intCon.getFecha() + "  "+intCon.getHora(),0,2);
		pc.addCols(intCon.getUsuarioCreacion(),0,1);
	    pc.addCols(intCon.getFechaCreacion(),0,2);
