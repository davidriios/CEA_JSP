...
isUnifiedExp=true;}
		...
		pc.setFont(9,1);
		pc.addBorderCols("No.: "+cdoIC.getColValue("codigo"," "),0,dHeader.size(),0f,1.5f,0f,0f,15.2f);
		pc.setFont(9,1,Color.white);
		pc.addBorderCols("Médico",0,3,Color.gray);
		pc.addBorderCols("Especialidad",1,3,Color.gray);
		pc.setFont(9,0);
		pc.addCols(cdoIC.getColValue("nombremedico"),0,3);
		pc.addCols(cdoIC.getColValue("descripcion"),0,3);
		...
		pc.setFont(9,1,Color.white);
		pc.addBorderCols("Fecha/hora",0,2,Color.gray);
		pc.addBorderCols("Creado por",0,1,Color.gray);
		pc.addBorderCols("Creado el",0,2,Color.gray);
		pc.addBorderCols("",0,1,Color.gray);
		pc.setFont(9,0);

		pc.addCols(cdoIC.getColValue("fecha"," ")+" "+cdoIC.getColValue("hora"," "),0,2);
		pc.addCols(cdoIC.getColValue("usuariocreacion"),0,1);
	    pc.addCols(cdoIC.getColValue("fechacreacion"),0,2);
		pc.setFont(9,1);
		pc.addCols(cdoIC.getColValue("status_dsp"),0,1);
