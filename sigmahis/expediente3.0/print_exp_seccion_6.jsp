...
//La relacion era mal, a.codigo no tiene referencia a la tabla b

  sql = "select A.cod_paciente, to_char(A.fec_nacimiento,'dd/mm/yyyy') as fec_nacimiento, A.codigo, to_char(A.fecha,'dd/mm/yyyy') as fecha, to_char(A.fecha,'hh12:mi am') hora, A.tipo_trauma, A.observacion, A.pac_id, B.DESCRIPCION, get_idoneidad(usuario_creacion, 1) usuario_creacion, get_idoneidad(usuario_modificacion, 1)usuario_modificacion, to_char(FECHA_CREACION, 'dd/mm/yyyy hh12:mi am') fecha_creacion, to_char(FECHA_MODIFICACION , 'dd/mm/yyyy hh12:mi am') fecha_modificacion from tbl_sal_antecedente_trauma A, tbl_sal_factor_trauma B where A.tipo_trauma=B.codigo and a.pac_id="+pacId+" and nvl(admision,"+noAdmision+") = "+noAdmision+" order by a.fecha desc, to_date(to_char(A.fecha,'hh12:mi am'),'hh12:mi am') desc";
...
//{
	...
	pc.createTable();
		...
		pc.addBorderCols("CREAC.",1);
		pc.addBorderCols("MODIF.",1);
