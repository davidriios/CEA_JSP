...
sql="select a.codigo, a.descripcion, b.cod_paciente, b.fec_nacimiento, b.factor_prenatal, b.observacion, nvl(b.valor,' ') as valor, b.pac_id from tbl_sal_factor_prenatal a, tbl_sal_antecedente_prenatal b where a.codigo=b.factor_prenatal(+) and b.pac_id(+)="+pacId+" order by b.observacion desc nulls last /*a.codigo desc*/";
