...
al = SQLMgr.getDataList(sql);
    ...
    pc.addBorderCols("F. Creación",1,1, Color.gray);
    ...
    pc.addCols("",0,dHeader.size());
        ...
        pc.addCols("ENFERMEDAD NOTIFICABLE",1,dHeader.size(),Color.gray);
        pc.addCols(" ",1,dHeader.size());
        
        al = SQLMgr.getDataList("select n.observacion, n.cod_enf, e.codigo as enfermedad, e.nombre as enfermedad_desc from tbl_sal_notif_enfermedades n, tbl_cds_enfermedad_notificable e where tipo_diag = 'A' and n.tipo = 'S' and n.cod_enf = e.codigo and n.pac_id = "+pacId+" and n.admision = "+noAdmision);
        
        pc.setFont(8,1, Color.white);
		pc.addBorderCols("ENFERMEDAD",0,3, Color.gray);
		pc.addBorderCols("OSERVACION",0,4, Color.gray);
        pc.setFont(8,0);
        
         for(int i = 0; i<al.size(); i++){
            cdo = (CommonDataObject)al.get(i);
            pc.addBorderCols(cdo.getColValue("enfermedad_desc"),0,3);
