...
isUnifiedExp=true;}
    ...
    if (showHeader.equals("Y")){
        ...
        al = SQLMgr.getDataList("select n.observacion, n.cod_enf, e.codigo as enfermedad, e.nombre as enfermedad_desc from tbl_sal_notif_enfermedades n, tbl_cds_enfermedad_notificable e where tipo_diag = 'A' and n.tipo = 'I' and n.cod_enf = e.codigo and n.pac_id = "+pacId+" and n.admision = "+noAdmision);
