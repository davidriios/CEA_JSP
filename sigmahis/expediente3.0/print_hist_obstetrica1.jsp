...
String horasLabor = request.getParameter("horas_labor");
...
Vector setBox = new Vector();
	...
	pc.createTable();
		...
		pc.addCols("Fecha Creac.: "+cdo2.getColValue("fecha_creacion", " "), 0, 7);
		pc.addCols("Usuario: "+cdo2.getColValue("usuario_creacion"," "),2,6);
		
		if (!cdo2.getColValue("usuario_modificacion"," ").trim().equals("")) {
			pc.addCols("Fecha Modif.: "+cdo2.getColValue("FECHA_modificacion"," "), 0, 7);
			pc.addCols("Usuario: "+cdo2.getColValue("usuario_modificacion"," "),2,6);
		}
	...
	pc.addBorderCols("GENERALES PARTO",0,dHeader.size(),cHeight,Color.GRAY);
	pc.setFont(7, 0);
    ...
    pc.addBorderCols("No. de controles Pre-natales: "+cdo2.getColValue("controlPrenatal"," "),0,dHeader.size(),0.5f,0.0f,0.0f,0.0f,cHeight);
    pc.addBorderCols("Tipo Sangre: "+cdo2.getColValue("tipoSangre"," "),0,dHeader.size(),0.5f,0.0f,0.0f,0.0f,cHeight);
    pc.addBorderCols("Presión Arterial: "+cdo2.getColValue("presionArterial"," "),0,dHeader.size(),0.5f,0.0f,0.0f,0.0f,cHeight);
    ...
    /*
	pc.setFont(7, 1);
	pc.addBorderCols("ALUMBRAMIENTO",0,4,cHeight);
	pc.setFont(7, 0);
    ...
    */
	...
	pc.setFont(7, 0,Color.WHITE);
	pc.addBorderCols("DATOS ADICIONALES",0,dHeader.size(),cHeight,Color.GRAY);
	...
	/*********LIQUIDOS AMNIOTICOS **************/
    pc.setFont(7, 0,Color.WHITE);
    pc.addBorderCols("LIQUIDO AMNIOTICO ",0,dHeader.size(),cHeight,Color.GRAY);
    ...
    */
	...
	pc.setFont(7, 0,Color.WHITE);
	pc.addBorderCols("TACTOS ",0,dHeader.size(),cHeight,Color.GRAY);
	pc.setFont(7, 0);
	...
	for (int i=0; i<al.size(); i++)
	{
        ...
        if (i+1 == al.size()) {
            pc.addCols("Horas de labor:   "+horasLabor,0,dHeader.size());
            pc.addCols("Tipo de parto:   "+cdo.getColValue("tipoParto"),0,dHeader.size());
            pc.addCols("Motivo Cesarea:   "+cdo.getColValue("motivoCesarea"),0,dHeader.size());
	...
	pc.addCols(" ",0,dHeader.size());
	pc.addBorderCols("PARTO INSTRUMENTAL ",0,dHeader.size(),Color.GRAY);
	...
	pc.addCols("KRISTELLER "+cdo2.getColValue("tipoForcep"),0,1);
	...
	//pc.addBorderCols(" ",0,dHeader.size(),cHeight);
	pc.setFont(0, 0);
	pc.addBorderCols("",0,dHeader.size(),0.0f,0.5f,0.0f,0.0f);
	pc.setFont(7, 0);
