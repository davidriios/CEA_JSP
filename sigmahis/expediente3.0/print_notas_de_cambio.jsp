...
sql = "select codigo, usuario_creacion, to_char(fecha_creacion, 'dd/mm/yyyy') fecha, to_char(fecha_creacion, 'hh12:mi:ss am') hora, nota from tbl_sal_notas_cambio where pac_id = "+pacId+" and admision = "+noAdmision+" and tipo = '"+fg+"' "+(!codigo.equals("0")?" and codigo = "+codigo:"")+" order by 1 desc";
	
al = SQLMgr.getDataList(sql);
if(desc == null) desc = "";

if (desc.trim().equals("")) {
  if (fg.trim().equalsIgnoreCase("NEEU")) desc = "NOTAS DE CAMBIO";
}
...
for(int i = 0; i<al.size(); i++){
    ...
    pc.addBorderCols(cdo.getColValue("codigo"),1,1);
