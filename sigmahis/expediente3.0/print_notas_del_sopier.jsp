...
sbSql.append("select CODIGO, DESCRIPCION, USUARIO_CREAC, to_char(FECHA_CREAC,'dd/mm/yyyy hh12:mi:ss am') as FECHA_CREAC, USUARIO_MODIF, to_char(FECHA_MODIF,'dd/mm/yyyy hh12:mi:ss am') as FECHA_MODIF, area, area_desc, estado from tbl_sal_notas_del_soapier z where pac_id = ");
sbSql.append(pacId);
sbSql.append(" and secuencia = ");
sbSql.append(noAdmision);
sbSql.append(" and nvl(tipo, 'S') = '");
sbSql.append(fg);
sbSql.append("'");
...
if (!codigo.trim().equals("") && !codigo.trim().equals("0")){
    ...
    sbSql.append(" and estado <> 'I' order by z.fecha_creac");
}
...
//{
	...
	String subTitle = !desc.trim().equals("") ? desc : "NOTAS DEL SOAPIER";
	String xtraSubtitle = "";
...
/*//control imgae
    ...
    pc.addBorderCols("Descripción:", 1,1);
		...
		for (int i=0; i<al.size(); i++)
		{
			...
			pc.addCols(cdo.getColValue("USUARIO_CREAC"," ")+" / "+cdo.getColValue("USUARIO_MODIF"," "), 1,1);
			pc.addCols(cdo.getColValue("area_desc"), 1,1);
            if (cdo.getColValue("estado"," ").trim().equalsIgnoreCase("I")) {
                pc.setFont(9,1,Color.red);
                pc.addCols("INVALIDA", 0,dHeader.size());
            }
		}
