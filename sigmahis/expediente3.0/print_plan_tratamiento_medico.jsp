...
sql = "select a.codigo, a.descripcion, b.observacion, b.aplicar from tbl_sal_tipo_tratamientos_med a, tbl_sal_plan_tratamientos_det b where a.estado = 'A' and a.codigo = b.tipo_tratamiento and b.pac_id = "+pacId+" and b.admision = "+noAdmision+" and b.cod_plan = "+codigo;
...
pc.addBorderCols("TRATAMIENTO",0 ,1,Color.lightGray);
