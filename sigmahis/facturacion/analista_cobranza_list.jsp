...
function add()
{
	abrir_ventana('../facturacion/analista_cobranza_config.jsp');
}

function edit(id)
{
	abrir_ventana('../facturacion/analista_cobranza_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../facturacion/print_list_analista.jsp');
}
</script>
</head>
