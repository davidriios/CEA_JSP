...
/*if (!(SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"200017") || SecMgr.checkAccess(session.getId(),"200018") || SecMgr.checkAccess(session.getId(),"200019") || SecMgr.checkAccess(session.getId(),"200020"))) throw new Exception("Usted no tiene los suficientes Derechos de Acceso a esta página.");*/
...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  if (request.getParameter("code") != null)
  {
    ...
    searchType = "1";
    searchDisp = "Código";
		codigo     = request.getParameter("code");              // utilizada para mantener el Código del Tipo de Ajuste
  }
  else if (request.getParameter("descripcion") != null)
  {
    ...
    searchDisp = "Descripcion";
		descrip    = request.getParameter("descripcion");      // utilizada para mantener la Descripción del Tipo de Ajuste
  }
...
document.title = 'Inventario - Administración - Tipo Ajuste - '+document.title;
