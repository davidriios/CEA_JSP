...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "SELECT codigo, descripcion FROM tbl_adm_categoria_admision"+appendFilter+" order by descripcion";
...
function returnValue(id,code,name)
{
    switch(id)
   {
     case 1:
	   window.opener.document.form1.catCode.value = code;
	   window.opener.document.form1.cat.value = name;
	   window.close();
	 break;
	 
	 case 2:
	   window.opener.document.form1.categoria.value = code;
	   window.opener.document.form1.categoriaDesc.value = name;
	   window.close();
	 break;
   } 
}
			...
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">		
				    ...
				    <td width="50%">
						...
						<%=fb.intBox("codigo","",false,false,false,40,null,null,null)%>
					<%=fb.submit("go","Ir")%>
					</td>
				    <%=fb.formEnd()%>		
					<%
