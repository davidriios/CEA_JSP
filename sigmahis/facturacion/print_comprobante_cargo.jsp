...
if (!SecMgr.checkLogin(session.getId())) throw new Exception("Usted está fuera del sistema. Por favor entre al sistema con su nombre de usuario y clave!!!");
  ...
  CommonDataObject cdoHeader = new CommonDataObject();
	...
	String fileNamePrefix = "print_comprobante_cargo_"+compId+"_"+codigo;
	String fileNameSuffix = "";
	String directory = java.util.ResourceBundle.getBundle("path").getString("pdfdocs")+"/";
	String dir=java.util.ResourceBundle.getBundle("path").getString("pdfdocs")+"/"+folderName.trim();
	String fileName=fileNamePrefix+"_"+year+"-"+month;
	String docTitle = "COMPROBANTE DE CARGO A CONTRATO DE ALQUILER POR FACTURAR";
	...
	if(create.equalsIgnoreCase("0")) throw new Exception("No se puede crear la carpeta! Intente nuevamente.");
		...
		for (int j=1; j<=nPages; j++){
			...
			pc.createTable();
				...
				pc.setFont(14, 1);
				pc.addBorderCols("Cargo No.:", 0, 1, 0.5f, 0.5f, 0.5f, 0.0f);
				pc.addBorderCols(codigo+"-"+anio, 0, 1, 0.5f, 0.5f, 0.5f, 0.5f);
			pc.addTable();
