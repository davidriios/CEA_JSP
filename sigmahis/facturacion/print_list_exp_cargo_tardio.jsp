...
al = SQLMgr.getDataList(sql);
 	...
 	if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_exp_cargo_tardio";
...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("EXPLICACION DE CARGOS TARDIOS",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Registros de Explicacion de Cargos Tardios.",1,4);
					pc.addTable();
					...
					for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
					{
							...
							pc.addCols(""+cdo1.getColValue("admision"),1,1);
