...
int no2 = 0;
			for (int j=1; j<=nPages; j++)
			{
				...
				pc.createTable();
					pc.setFont(9, 1);
					pc.addCols("NOTAS DE AJUSTES",1,2);
					pc.addTable();
				pc.createTable();
			        pc.setFont(7, 1);
				...
				pc.addTable();
					...
					pc.createTable();
						pc.setFont(9, 1);
						pc.addCols("No Existen Notas de Ajustes Registradas.",1,4);
					pc.addTable();
