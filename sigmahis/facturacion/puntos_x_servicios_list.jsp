...
if (request.getParameter("codCat") != null && !request.getParameter("codCat").equals("")) codCat = request.getParameter("codCat");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("descripcion") != null && !request.getParameter("descripcion").trim().equals(""))
  {
	...
	descripcion    = request.getParameter("descripcion");  // utilizada para mantener la descripción 
  }
  
  sql = "SELECT codigo, descripcion, valor, estado, cap_code as capCode FROM tbl_fac_serv_pto_hna WHERE cod_cat ="+codCat+" and compania ="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
document.title = 'Puntos x Servicios - '+document.title;

function add()
{
	abrir_ventana1('../contabilidad/puntos_x_servicios_config.jsp?codCat=<%=codCat%>');
}

function edit(code)
{
	abrir_ventana1('../contabilidad/puntos_x_servicios_config.jsp?mode=edit&code='+code+'&codCat=<%=codCat%>');
}

function printList()
{
	abrir_ventana1('../contabilidad/print_list_puntos_x_servicios.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>&codCat=<%=codCat%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right"><authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Punto</cellbytelabel> ]</a></authtype></td>
    </tr>
	<tr>
		<td>
			<table width="100%" cellpadding="0" cellspacing="1">
			    <tr class="TextFilter">		
				    ...
				    <td width="50%"><cellbytelabel>C&oacute;digo</cellbytelabel><%=fb.textBox("codigo",codigo,false,false,false,40)%></td>
				    <td width="50%"><cellbytelabel>Descripci&oacute;n</cellbytelabel><%=fb.textBox("descripcion",descripcion,false,false,false,40)%><%=fb.submit("go","Ir")%></td>
				    <%=fb.formEnd()%>		
			    </tr>
			</table>
		</td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="list">
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td><%=cdo.getColValue("valor")%></td>
					<td><%=cdo.getColValue("estado")%></td>
					<td><%=cdo.getColValue("capCode")%></td>					
