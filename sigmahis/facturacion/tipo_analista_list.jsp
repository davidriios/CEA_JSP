...
document.title = 'Tipo de Analista / Cobranza - '+document.title;

function add()
{
	abrir_ventana('../facturacion/tipo_analista_config.jsp');
}

function edit(id)
{
	abrir_ventana('../facturacion/tipo_analista_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../facturacion/print_list_tipo_analista.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CUENTAS POR COBRAR - TIPO DE ANALISTA / COBRANZA"></jsp:param>
</jsp:include>
...
//{
%>
			<a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Tipo de Analista/Cobranza</cellbytelabel> ]</a>
<%
//}
%>
		</td>
