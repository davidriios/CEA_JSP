...
if (chkOMFar) {
	...
	sbSql.append(" and not exists (select null from tbl_int_orden_farmacia where pac_id = z.pac_id and (/*adm_cargo = */z.adm_corte in (admision, adm_cargo) or (adm_cargo >= z.adm_corte and admision = z.secuencia)) and tipo_orden = z.tipo_orden and orden_med = z.orden_med and codigo = z.codigo)");//x aprobar
	...
	sbSql.append(" and exists (select null from tbl_int_orden_farmacia where pac_id = z.pac_id and (/*adm_cargo = */z.adm_corte in (admision, adm_cargo) or (adm_cargo >= z.adm_corte and admision = z.secuencia)) and tipo_orden = z.tipo_orden and orden_med = z.orden_med and codigo = z.codigo and other1 = 1 and ( (fg = 'ME' and estado in ('P')) ))");//x despachar
	sbSql.append(" and pac_id = ");
	sbSql.append(pacienteId);
	sbSql.append(" and adm_corte = ");
	sbSql.append(noAdmision);
...
if (chkOMFarBM) {
	...
	sbSql.append(" and exists (select null from tbl_int_orden_farmacia where pac_id = z.pac_id and (/*adm_cargo = */z.adm_corte in (admision, adm_cargo) or (adm_cargo >= z.adm_corte and admision = z.secuencia)) and tipo_orden = z.tipo_orden and orden_med = z.orden_med and codigo = z.codigo and other1 = 1 and ( fg = 'BM' and estado in ('P','A') ))");//x despachar
	sbSql.append(" and pac_id = ");
	sbSql.append(pacienteId);
	sbSql.append(" and adm_corte = ");
	sbSql.append(noAdmision);
...
%>
<jsp:forward page="../facturacion/reg_analisis_fact.jsp">
