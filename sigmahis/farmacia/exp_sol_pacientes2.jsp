	...
	<tr>
		<td class="TableLeftBorder TableTopBorder TableBottomBorder TableRightBorder">
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				...
				<tr>
					<td colspan="3">
<iframe name="itemFrame" id="itemFrame" align="center" width="100%" height="0" scrolling="yes" frameborder="0" border="0" src="../farmacia/exp_sol_pacientes_det2.jsp?fecha=<%=fecha%>&fechaHasta=<%=fechaHasta%>&fg=<%=fg%>&estado=<%=status%>&cds=<%=cds%>&timer=<%=timer%>&orden=<%=orden%>&setFecha=<%=cdo.getColValue("set_fecha")%>&cdsExpanded=<%=cdo.getColValue("cds_expanded")%>"></iframe>
					</td>
				</tr>
				<%=fb.formEnd(true)%>
