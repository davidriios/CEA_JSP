...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "ARTICULOS DE BANCO DE MEDICAMENTO";
	String xtraSubtitle = "";
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		if (!groupBy.trim().equals(cdo.getColValue("familyCode")+"-"+cdo.getColValue("classCode")))
		{
			pc.setFont(7, 1);
			pc.addCols(" ["+cdo.getColValue("familyName")+"] "+cdo.getColValue("className"),0,dHeader.size());
		}
		pc.setFont(7, 0);
		pc.setVAlignment(0);
		pc.addCols(" "+cdo.getColValue("itemCode"),0,1);
		pc.addCols(" "+cdo.getColValue("description"),0,1);
		pc.addCols(" "+cdo.getColValue("status"),0,1);

		groupBy = cdo.getColValue("familyCode")+"-"+cdo.getColValue("classCode");
