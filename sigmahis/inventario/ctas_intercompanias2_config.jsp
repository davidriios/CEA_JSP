...
if(request.getMethod().equalsIgnoreCase("GET")) {
    ...
    try{
        ...
        else throw new Exception("La Compañía no es inválida. Por favor intente nuevamente!");
    } catch (Exception e){
	...
	if (request.getParameter("cuenta") != null)
  {
	...
	sql = "SELECT DISTINCT cta1, cta2, cta3, cta4, cta5, cta6, cta1||'-'||cta2||'-'||cta3||'-'||cta4||'-'||cta5||'-'||cta6 as cuentaCode, cta1||'¦'||cta2||'¦'||cta3||'¦'||cta4||'¦'||cta5||'¦'||cta6||'¦'||compania as keyCta, descripcion as cuenta FROM tbl_con_catalogo_gral WHERE cta1='113' and cta2='03' and compania="+compId+appendFilter+" order by descripcion";	
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_con_catalogo_gral WHERE cta1='113' and cta2='03' and compania="+compId+appendFilter);
...
document.title="Cuentas Intercompañías - Edición - "+document.title;
</script>
	...
	<tr>
		<td class="TableLeftBorder TableTopBorder TableRightBorder">
			<table  align="center" width="100%"  border="0" cellspacing="0" cellpadding="1">
				...
				<tr class="TextPager">
					<td colspan="3"><div align="right"><span class="TitlesBendigo">
...
{
	window.opener.location = 'ctas_intercompanias_config.jsp?compId=<%=compId%>&lastLineNo=<%=lastLineNo%>&change=1';
	window.close();
}
</script>
</head>
