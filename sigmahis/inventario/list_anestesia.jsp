...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo, descripcion from tbl_cdc_tipo_anestesia"+appendFilter+" order by descripcion";
	al = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cdc_tipo_anestesia"+appendFilter);
...
document.title = 'Lista de Tipo de Anestesia - '+document.title;

function returnValue(code, name)
{
window.opener.document.form1.tipo.value=code; 
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="INVENTARIO - MANTENIMIENTO - LISTA TIPO DE ANESTESIA"></jsp:param>
</jsp:include>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td>&nbsp;<a href="javascript:returnValue('<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("descripcion")%>')" class="Link00">Seleccionar</a></td>
				</tr>
				<%
				}
		%>						
