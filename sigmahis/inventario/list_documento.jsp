...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " where upper(documento) like '%"+request.getParameter("code").toUpperCase()+"%'";
    searchOn = "documento";
  ...
  else
  {
	...
	sql="select documento as code, descripcion from tbl_inv_documento_recepcion "+appendFilter+" order by descripcion";
...
document.title = 'Lista de Documentos de Recepción- '+document.title;

function returnValue(code,name)
{
<%if(fp.equalsIgnoreCase("sinsolicitud")){%>
window.opener.document.form1.codigos.value=code; 
window.opener.document.form1.otro.value=name; 
<%}else{%>
window.opener.document.form1.documento.value=code; 
window.opener.document.form1.nombredoc.value=name;
<%}%>
window.close();
}
</script>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="MATERIALES CON SOLICITUD DE COMPRA"></jsp:param>
</jsp:include>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td>&nbsp;<a href="javascript:returnValue('<%=cdo.getColValue("code")%>','<%=cdo.getColValue("descripcion")%>')" class="Link00"><%=cdo.getColValue("descripcion")%></a></td>
				</tr>
				<%
				}
		%>						
