...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(a.anio) like '%"+request.getParameter("code").toUpperCase()+"%'";
    searchOn = "a.anio";
  ...
  else
  {
	...
	sql="select a.anio as code, a.tipo_compromiso,a.num_doc, b.descripcion, d.cod_provedor, d.nombre_proveedor from tbl_com_comp_formales a, tbl_com_tipo_compromiso b, tbl_com_proveedor d "+appendFilter+" order by descripcion";
	al = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_com_comp_formales a, tbl_com_tipo_compromiso b, tbl_com_proveedor d "+appendFilter);
...
document.title = 'Lista de Orden de Compra - '+document.title;

function returnValue(code,name,otros)
{
window.opener.document.form1.code.value=code; 
window.opener.document.form1.numero.value=name; 
window.opener.document.form1.descripcion.value=otro; 
window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="LISTA DE ORDEN DE COMPRA"></jsp:param>
</jsp:include>
