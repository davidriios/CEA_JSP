...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(cod_provedor) like '%"+request.getParameter("code").toUpperCase()+"%'";
  ...
  {
    appendFilter += " and upper(nombre_proveedor) like '%"+request.getParameter("name").toUpperCase()+"%'";
  ...
  else
  {
	...
	sql="select compania, cod_provedor as code, nombre_proveedor as name, estado_proveedor as estatus from tbl_com_proveedor where compania="+(String) session.getAttribute("_companyId")+appendFilter+" and estado_proveedor='ACT' order by nombre_proveedor";
...
document.title = 'Lista de Proveedor- '+document.title;

function returnValue(code,name)
{
window.opener.document.form1.codig.value=code; 
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
			...
			<tr class="TextFilter">		
				...
				<%=fb.formStart()%>
				<td width="50%">&nbsp;C&oacute;digo de Proveedor
				...
				<%=fb.formStart()%>
				<td width="50%">&nbsp;Nombre del Proveedor
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader">
	  	<td width="10%">&nbsp;</td>
		<td width="20%">&nbsp;C&oacute;digo de Proveedor.</td>
		<td width="70%">&nbsp;Nombre de Proveedor</td>	
	</tr>
	<%
