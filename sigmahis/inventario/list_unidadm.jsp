...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    	appendFilter += " and upper(cod_medida) like '%"+request.getParameter("code").toUpperCase()+"%'";
  ...
  {    
	...
	sql="select cod_medida as code, descripcion as name from tbl_inv_unidad_medida where status <> 'I' "+appendFilter+" order by descripcion";
...
document.title = 'Lista de Unidad de Medida - '+document.title;

function returnValue(code, name)
{
window.opener.document.form1.unitCode.value=code; 
window.opener.document.form1.unitName.value=name; 
window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="INVENTARIO - MANTENIMIENTO - UNIDAD DE MEDIDA"></jsp:param>
</jsp:include>
