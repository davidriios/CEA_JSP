...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_cdc_tipo_usos_anestesia"+appendFilter);
...
document.title = 'Lista de Tipo de Uso  Anestesia - '+document.title;

function returnValue(code, nam)
{
if (eval('window.opener.document.form1.<%=codeField%>')) eval('window.opener.document.form1.<%=codeField%>').value = code;
if (eval('window.opener.document.form1.<%=descField%>')) eval('window.opener.document.form1.<%=descField%>').value = nam;
window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="INVENTARIO - MANTENIMIENTO - LISTA TIPO DE USO ANESTESIA"></jsp:param>
</jsp:include>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				%>
				<tr class="<%=color%>" onClick="javascript:returnValue('<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("descripcion")%>')" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" style="cursor:pointer">
					<td align="right"><%=preVal + i%>&nbsp;</td>
					<td>&nbsp;<%=cdo.getColValue("codigo")%></td>
					<td colspan="2">&nbsp;<%=cdo.getColValue("descripcion")%></td>
