...
document.title = 'Inventario - Materiales Sin Solicitud de Compra - '+document.title;

function add()
{
abrir_ventana('../inventario/materiales_sin_solicitud_compra_config.jsp');
}
...
function  printList()
{
abrir_ventana('print_list_material_sin_solicitud_compra.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="INVENTARIO - RECEPCION - MATERIALES SIN SOLICITUD DE COMPRAS"></jsp:param>
</jsp:include>
...
{
%>
		<a href="javascript:add()" class="Link00">[ Registrar Nuevo Material Sin Solicitud de Compra ]</a>
<%
}
%>
		</td>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader" align="center">
		...
		<td width="40%">&nbsp;Documento Recepci&oacute;n</td>
		<td width="30%">&nbsp;Almac&eacute;n</td>
		<td width="10%">&nbsp;</td>
	</tr>
	<tr class="TextRow01">
		<td align="center">1</td>
		<td align="center">2008-58</td>
		<td>PLANILLA ADICIONAL</td>
		<td>AGUAS CRISTALINAS</td>
		<td align="center">
