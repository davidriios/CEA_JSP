...
sql = " select codigo,nombre, decode(estado,'A','ACTIVA','INACTIVA') estado_desc from tbl_inv_cat_eq_comodatos where compania = "+(String) session.getAttribute("_companyId")+appendFilter+"";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "CATEGORIAS EQUIPOS COMODATOS";
	String xtraSubtitle = "";
	...
	pc.addBorderCols("Nombre categoría",0,1);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(" "+cdo1.getColValue("codigo"),0,1,cHeight);
		pc.addCols(" "+cdo1.getColValue("nombre"),0,1,cHeight);
		pc.addCols(" "+cdo1.getColValue("estado_desc"),1,1,cHeight);
