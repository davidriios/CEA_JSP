...
+ " and a.compania = "+session.getAttribute("_companyId") + " and a.fre_documento = 'FG' " + appendFilter
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_fact_del_proveedor";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("INVENTARIO",1,1);
					pc.addCols("FACTURAS DEL PROVEEDOR", 1, 1);
				pc.addTable();
