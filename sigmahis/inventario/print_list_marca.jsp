...
sbSql.append("select marca_id, codigo, descripcion, decode(estado,'A','ACTIVO','I','INACTIVO',estado) as estado from tbl_inv_marca where compania = ");
...
if (request.getMethod().equalsIgnoreCase("GET")) {
	...
	String subtitle = "LISTA DE MARCAS";
	String xtraSubtitle = "";
