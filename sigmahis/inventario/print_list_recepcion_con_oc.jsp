...
+ " where a.cod_proveedor = b.cod_provedor and a.codigo_almacen = c.codigo_almacen and a.compania = c.compania "
+ " and a.compania = "+session.getAttribute("_companyId") + " and a.fre_documento = 'OC'" + appendFilter
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_recepcion_con_oc";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("INVENTARIO",1,1);
					pc.addCols("RECEPCIÓN CON ORDEN DE COMPRA", 1, 1);
				pc.addTable();
