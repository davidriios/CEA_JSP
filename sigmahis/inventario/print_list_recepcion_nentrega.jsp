...
+ " and a.compania = "+session.getAttribute("_companyId") + " and a.fre_documento = 'NE' " + appendFilter
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_recepcion_nentrega";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("INVENTARIO",1,1);
					pc.addCols("RECEPCIÓN NOTA DE ENTREGA", 1, 1);
				pc.addTable();
