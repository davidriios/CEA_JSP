...
//if (appendFilter == null) appendFilter = "";
	...
	sql="select codigo_ajuste as code, descripcion  from tbl_inv_tipo_ajustes"+appendFilter+" order by descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_tipoajuste";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("INVENTARIO",1,1);
					pc.addCols("TIPOS DE AJUSTES", 1, 1);
				pc.addTable();
