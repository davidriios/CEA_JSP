...
sql="select cod_medida as code, descripcion as name from tbl_inv_unidad_medida "+appendFilter;
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_unidadmedida";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("INVENTARIO",1,1);
					pc.addCols("UNIDADES DE MEDIDA", 1, 1);
				pc.addTable();
				...
				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe la unidad de medida seleccionado",1,5);
						pc.addTable();
						}
				else{
					if (al.size() > 0)
