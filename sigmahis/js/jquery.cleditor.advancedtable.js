...
(function($) {
  ...
  $.cleditor.buttons.table = {
    ...
    popupContent:
      ...
      "<td style=\"padding-right:6px;\">Cols:<br /><input type=text value=3 size=12 /></td>" +
      "<td style=\"padding-right:6px;\">Rows:<br /><input type=text value=3 size=12 /></td>" +
      "</tr><tr>" +
      "<td style=\"padding-right:6px;\">Cell Spacing:<br /><input type=text value=1 size=12 /></td>" +
      "<td style=\"padding-right:6px;\">Cell Padding:<br /><input type=text value=1 size=12 /></td>" +
      "</tr><tr>" +
