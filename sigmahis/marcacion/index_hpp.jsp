            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="inner cover" style="text-align: left">
                        ...
                        <p>
                          <img src="./images/default-avatar.png" width="150px" height="150px" style="border:blue 1px solid" id="photo">
                        </p>    
		...
		$(function(){
			$(".action-type").click(function(e){
			  $(".action-type").prop("disabled", true);
				...
				if (type) $("#tipo_marcacion").val(type);
			});
		});
    </script>
  </body>
