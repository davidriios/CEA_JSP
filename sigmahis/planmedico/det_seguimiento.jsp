...
<jsp:useBean id="SegMgr" scope="page" class="issi.planmedico.SeguimientoMgr" />
<jsp:useBean id="fb" scope="page" class="issi.admin.FormBean" />
<jsp:useBean id="htSeg" scope="session" class="java.util.Hashtable"/>
<%
...
if (!SecMgr.checkLogin(session.getId())) throw new Exception("Usted está fuera del sistema. Por favor entre al sistema con su nombre de usuario y clave!!!");
	...
	if(request.getMethod().equalsIgnoreCase("GET")){
		if ((mode.equals("edit") || mode.equals("view")) && id != null && !id.equals("")){
			sbSql.append("select a.id, a.tipo, a.id_trx, to_char(a.fecha, 'dd/mm/yyyy') fecha, to_char(a.fecha_seguimiento, 'dd/mm/yyyy') fecha_seguimiento, a.nota, a.usuario, a.estado, a.id_parent from tbl_gen_seguimiento a where a.id = ");
			sbSql.append(id);
			...
			cdo.addColValue("fecha_seguimiento", "");
		}
				...
				<table align="center" width="100%" cellpadding="1" cellspacing="1">
					...
					<tr>
						<td colspan="4" onClick="javascript:showHide(0)" style="text-decoration:none; cursor:pointer">
							...
							<tr class="TextPanel">
								<td width="95%">&nbsp;<%=(mode.equals("add")?"Agregar":(mode.equals("edit")?"Editar":"Ver"))%> Seguimiento</td>
						...
						<td colspan="4">
							<table width="100%" cellpadding="1" cellspacing="1">
								<tr class="TextRow01">
									...
									<td class="TextLabel" align="right">Fecha:</td>
									<td>
									<jsp:include page="../common/calendar.jsp" flush="true">
									<jsp:param name="noOfDateTBox" value="1" />
									<jsp:param name="nameOfTBox1" value="fecha_seguimiento" />
									<jsp:param name="valueOfTBox1" value="<%=cdo.getColValue("fecha_seguimiento")%>" />
									</jsp:include>
									</td>
...
<%
	...
	if(request.getParameter("fecha_seguimiento")!=null) cdo.addColValue("fecha_seguimiento", request.getParameter("fecha_seguimiento"));
	...
	if (request.getParameter("baction")!=null && request.getParameter("baction").equalsIgnoreCase("Guardar")) {
		if(mode.equals("add")){
			SegMgr.add(cdo);
			returnId = SegMgr.getPkColValue("id");
...
<%
if(SegMgr.getErrCode().equals("1")){
%>
	alert('<%=SegMgr.getErrMsg()%>');
<%
...
} else throw new Exception(SegMgr.getErrMsg());
%>
}
