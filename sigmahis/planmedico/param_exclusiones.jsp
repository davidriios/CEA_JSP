...
{
  var fecha_desde     = document.form0.fecha_desde.value||'ALL';
  var fecha_hasta     = document.form0.fecha_hasta.value||'ALL';
  var plan     			  = document.form0.plan.value||'ALL';
  var exclusion     	= document.form0.exclusion.value;
	if(value=="1")
	{
		if(fecha_desde=='' || fecha_hasta == '') alert('Introduzca rango de fecha!');
		else if(exclusion=='') alert('Introduzca Exclusión!');
		else abrir_ventana("../cellbyteWV/report_container.jsp?reportName=planmedico/rpt_pm_exclusiones.rptdesign&exclusiones="+exclusion+"&plan="+plan+"&fechaDesde="+fecha_desde+"&fechaHasta="+fecha_hasta);
	}
	...
	<tr>
		<td class="TableLeftBorder TableTopBorder TableBottomBorder TableRightBorder">
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextFilter" >
				   <td width=""><cellbytelabel>Exclusi&oacute;n:</cellbytelabel></td>
				   <td width="" colspan="3">
					 <%=fb.textBox("exclusion","",false,false,false,50,50,"Text10",null,null)%>
					 </td>
			  </tr>
				<tr class="TextFilter" >
				   <td>PLAN:</td>
					 <td><%=fb.select("plan","1=PLAN FAMILIAR,2=PLAN TERCERA EDAD","",false,false,0,"Text10",null,null,null,"T")%></td>
