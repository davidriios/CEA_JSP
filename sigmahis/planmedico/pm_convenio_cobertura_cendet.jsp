...
<tr class="TextHeader" align="center">
	...
	<td width="34%"><cellbytelabel>Tipo de Servicio</cellbytelabel></td>
...
<%=fb.hidden("montoEmp"+i,cc.getMontoEmp())%>
<%=fb.hidden("tipoValEmp"+i,cc.getTipoValEmp())%>
