...
{
	abrir_ventana2('../common/check_articulo.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}

function showUsoList()
{
	abrir_ventana2('../common/check_uso.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}

function showProductoCdsList()
{
	abrir_ventana2('../common/check_producto_x_cds.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}

function showProcedimientoList()
{
	abrir_ventana2('../common/check_procedimiento.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}

function showOtrosCargosList()
{
	abrir_ventana2('../common/check_otroscargos.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}

function showTipoHabitacionList()
{
	abrir_ventana2('../common/check_tipo_habitacion.jsp?fp=pm_convenio_exclusion_detalle&mode=<%=mode%>&empresa=<%=empresa%>&secuencia=<%=secuencia%>&tipoPoliza=<%=tipoPoliza%>&tipoPlan=<%=tipoPlan%>&planNo=<%=planNo%>&categoriaAdm=<%=categoriaAdm%>&tipoAdm=<%=tipoAdm%>&clasifAdm=<%=clasifAdm%>&tipoCE=<%=tipoExclusion%>&ce=<%=exclusion%>&ceDetLastLineNo=<%=exclDetLastLineNo%>&tipoServicio=<%=tipoServicio%>&centroServicio=<%=centroServicio%>&tipoCds=<%=tipoCds%>&inventarioSino=<%=inventarioSino%>');
}
...
<tr class="<%=color%>" align="center"<%=displayExclDetalle%>>
	...
	<td>
	<%//=fb.select("tipoCobPac"+i,"D=DIARIO,E=EVENTO",ed.getTipoCobPac(),false,false,0,"Text10",null,null)%>
	<%=fb.select("tipoCobPac"+i,"E=EVENTO",ed.getTipoCobPac(),false,false,0,"Text10",null,null)%>
	</td>
	...
	<%=fb.hidden("montoEmp"+i,ed.getMontoEmp())%>
	<%=fb.hidden("tipoValEmp"+i,ed.getTipoValEmp())%>
	<%=fb.hidden("tipoCobEmp"+i,ed.getTipoCobEmp())%>
	<span style="visibility:hidden"><%=fb.checkbox("empSolBenef"+i,"S",(ed.getEmpSolBenef() != null && ed.getEmpSolBenef().equals("S")),false)%></span>
</tr>
<%
}
%>
