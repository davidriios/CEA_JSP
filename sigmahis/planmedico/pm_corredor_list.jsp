...
String nombre = "";
String identificacion = "", estado="", telefono="";
...
function manageSurvey(option){
   if (typeof option == "undefined") abrir_ventana('../planmedico/pm_corredor_config.jsp');
   else if(option=='edit'){
      if (getCurVal() == "") alert("Por favor seleccione uno para poder seguir!");
      else abrir_ventana('../planmedico/pm_corredor_config.jsp?mode=edit&id='+getCurVal());
   }
   else if(option=='print'){
      abrir_ventana('../planmedico/print_corredor_list.jsp?nombre=<%=nombre%>&identificacion=<%=identificacion%>&estado=<%=estado%>');
   }
}
...
function changeAltTitleAttr(obj,type,ctx){
  var opt = {"edit":"Editar","print":"Imprimir"};
	if (typeof obj != "undefined" && typeof type != "undefined" && typeof ctx != "undefined"){
	  ...
	  document.getElementById("printImg").alt = "Imprimir Lista Corredor";
	  document.getElementById("editImg").alt = "Seleccione un Corredor a Editar";
	  document.getElementById("printImg").title = "Imprimir Lista Corredor";
	  document.getElementById("editImg").title = "Seleccione un Corredor a Editar";
	}
}
...
<%=fb.formStart()%>
	<tr><%//="[2] IMPRIMIR       [3] REGISTRAR       [4] EDITAR"  %>
		<td colspan="4" align="right" style="cursor:pointer">
			<authtype type='3'>
			<img src="../images/add_survey.png" alt="Registrar Nuevo Corredor" title="Registrar Nuevo Corredor" onClick="javascript:manageSurvey()" width="32px" height="32px"/>
			</authtype>&nbsp;
			<authtype type='4'>
			...
			<authtype type='2'>
			<img src="../images/printer.png" onClick="javascript:manageSurvey('print')" onMouseOver="javascript:changeAltTitleAttr(this,'print','Corredor')" id="printImg"/>
			</authtype>
		</td>
	</tr>
<%=fb.formEnd(true)%>
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
		...
		<td colspan="2">&nbsp;<cellbytelabel id="2">Nombre</cellbytelabel>&nbsp;
			...
			&nbsp;<cellbytelabel>Identificaci&oacute;n</cellbytelabel>&nbsp;
			<%=fb.textBox("identificacion",identificacion,false,false,false,30,null,null,null)%>
			<%=fb.submit("go","Ir")%></td>
		<%=fb.formEnd()%>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader" align="center">
		...
		<td width="25%"><cellbytelabel>Porc. Comisi&oacute;n</cellbytelabel></td>
...
<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">&nbsp;<%=cdo.getColValue("porc_comision")%></td>
