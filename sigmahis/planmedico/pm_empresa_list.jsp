...
function manageSurvey(option){
   if (typeof option == "undefined") abrir_ventana('../planmedico/pm_empresa_config.jsp');
      ...
      else abrir_ventana('../planmedico/pm_empresa_config.jsp?mode=edit&id='+getCurVal());
   }
   else if(option=='print'){
      abrir_ventana('../planmedico/pm_print_empresa_list.jsp?nombre=<%=nombre%>&ruc=<%=ruc%>&estado=<%=estado%>&telefono=<%=telefono%>&idEmpresa='+getCurVal());
   }
}
...
<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">
					  <%=fb.radio("radioVal","",false,false,false,null,null,"onClick=\"javascript:setId("+cdo.getColValue("id_empresa")+")\"")%>
					</td>
				</tr>
				<%
				}
