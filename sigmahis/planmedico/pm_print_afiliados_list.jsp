...
String cantMin = (request.getParameter("cantMin")==null?"":request.getParameter("cantMin"));
String cantMax = (request.getParameter("cantMax")==null?"":request.getParameter("cantMax"));
...
String idAfiliado = (request.getParameter("idAfiliado")==null?"":request.getParameter("idAfiliado"));
...
if(request.getMethod().equalsIgnoreCase("GET")) {
	...
	String subtitle = "AFILIADO POR PLAN";
	String xtraSubtitle = "";
	...
	tblContent.addElement(".50"); //Descripcion
	...
	pc.addBorderCols("Min-Max",1,1);
	pc.addBorderCols("Mensualidad",1,1);
	pc.addBorderCols("Estado",1,1);

	pc.setTableHeader(3);

	if (al.size()==0) {
		pc.addCols("No existen datos a cerca de afiliados por plan!",1,tblContent.size());
	}
	else{
        ...
        pc.addCols(cdo1.getColValue("cant_min_max"),1,1) ;
