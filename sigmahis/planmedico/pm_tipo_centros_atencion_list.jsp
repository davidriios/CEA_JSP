...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  if (request.getParameter("searchQuery") != null)
  {
	...
	sbSql.append("select t.id, t.estado, decode(t.estado, 'A', 'Activo', 'I', 'Inactivo') estado_desc, t.descripcion from tbl_pm_tipo_centro_atencion t where 1=1 ");
	if(!descripcion.equals("")){
		sbSql.append(" and t.descripcion like '%");
		sbSql.append(descripcion.trim());
		sbSql.append("%'");
	}
	if(!id.equals("")){
		sbSql.append(" and t.id = ");
		sbSql.append(id);
	}
	if(!estado.equals("")){
		sbSql.append(" and t.estado = '");
		sbSql.append(estado);
		sbSql.append("'");
	}
...
function manageSurvey(option){
   if (typeof option == "undefined") abrir_ventana('../planmedico/pm_tipo_centros_atencion_config.jsp');
   else if(option=='edit'){
      if (getCurVal() == "") alert("Por favor seleccione uno para poder seguir!");
      else abrir_ventana('../planmedico/pm_tipo_centros_atencion_config.jsp?mode=edit&id='+getCurVal());
   }
   else if(option=='print'){
      abrir_ventana('../planmedico/pm_print_tipo_centros_atencion_list.jsp?descripcion=<%=descripcion%>&estado=<%=estado%>&id='+getCurVal());
   }
}
...
function changeAltTitleAttr(obj,type,ctx){
  var opt = {"edit":"Editar","print":"Imprimir"};
	if (typeof obj != "undefined" && typeof type != "undefined" && typeof ctx != "undefined"){
	  ...
	  document.getElementById("printImg").alt = "Imprimir Lista Empresa";
	  document.getElementById("editImg").alt = "Seleccione una Empresa a Editar";
	  document.getElementById("printImg").title = "Imprimir Lista Empresa";
	  document.getElementById("editImg").title = "Seleccione una Empresa a Editar";
	}
}
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="Plan Medicico - Mantenimiento - Tipo Centros de Atención"></jsp:param>
</jsp:include>
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
		...
		<td colspan="2">&nbsp;<cellbytelabel>C&oacute;digo</cellbytelabel>&nbsp;
			<%=fb.textBox("id",id,false,false,false,5,null,null,null)%>
			&nbsp;<cellbytelabel id="2">Descripci&oacute;n</cellbytelabel>&nbsp;
			<%=fb.textBox("descripcion",descripcion,false,false,false,50,null,null,null)%>
			&nbsp;&nbsp;Estado:<%=fb.select("estado","A=Activo,I=Inactivo",estado,"T")%>
			&nbsp;&nbsp;<%=fb.submit("go","Ir")%></td>
		<%=fb.formEnd()%>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader" align="center">
		...
		<td width="25%"><cellbytelabel>Estado</cellbytelabel></td>
		<td width="5%">&nbsp;</td>
	</tr>
