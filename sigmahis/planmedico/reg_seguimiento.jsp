...
function ver(id_trx, id, mode){
	var iFrameName = '', page = '';
	iFrameName='iFrameSeguimiento';
	page = '../planmedico/det_seguimiento.jsp?tipo=<%=tipo%>&id_trx=<%=id_trx%>&fg=<%=fg%>&id='+id+'&mode='+mode;
    ...
    <tr>
			<td class="TableBorder">
				<table align="center" width="100%" cellpadding="1" cellspacing="1">
					...
					<tr class="" align="center">
						...
						<!--<div id="list_op" width="100%" style="overflow;position:absolute">-->
							<table width="99%" border="0" align="center">
								...
								<%
								key = "";
								if (htSeg.size() != 0) al = CmnMgr.reverseRecords(htSeg);
								for (int i=0; i<htSeg.size(); i++){
									key = al.get(i).toString();
									CommonDataObject cdo = (CommonDataObject) htSeg.get(key);
									String color = "";
								...
								<tr class="<%=color%>" align="center">
									...
									<td><%=cdo.getColValue("fecha_seguimiento")%></td>
					...
					<tr class="TextRow01">
						<td colspan="4">
						<iframe name="iFrameSeguimiento" id="iFrameSeguimiento" frameborder="0" align="center" width="100%" height="220" scrolling="yes" src="../planmedico/det_seguimiento.jsp?tipo=<%=tipo%>&mode=<%=mode%>&id_trx=<%=id_trx%>&id=<%=id%>&fg=<%=fg%>"></iframe>
						</td>
					</tr>			
				</table>
			</td>
