...
function setDesc(){
	...
	if(x[1]==''){
		...
		var total = 0.00;
		if(x[0]=='M') total = parseFloat(x[1]);//parseFloat(document.form1.precio.value)-parseFloat(x[1]);
...
function doSubmit(valor){
	...
	else if(_cantidad < cantidad) {alert('La cantidad no puede ser mayor a la original!');document.form1.cantidad.value=_cantidad;}
	else {
