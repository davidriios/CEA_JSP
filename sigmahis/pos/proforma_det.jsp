	...
	<td class="TableBorder">
		<table align="center" width="100%" cellpadding="1" cellspacing="1">
			...
			<tr class="TextHeader" align="center">
				...
				<td width="3%">
				<input type="button" class="btn btn-sm btn-danger" id="rem" name="rem" value="X" onClick="javascript:borrarAll();"></td>
			</tr>
			<%
			if (htDet.size() > 0) al = CmnMgr.reverseRecords(htDet, false);
			...
			<%} else {%><td>&nbsp;</td><%}%>
				...
				<td align="center">
				<input type="button" class="btn btn-sm " id="rem<%=i%>" name="rem<%=i%>" value="X" onClick="javascript:borrar('<%=i%>');">
