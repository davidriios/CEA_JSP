...
if (!desc.equals("")) appendFilter += " and descripcion like '%"+desc+"%'";

sbSql.append("SELECT codigo, descripcion FROM tbl_con_pres_area where compania=");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "LISTADO DE  ÁREAS";
	String xtraSubtitle = " ";
