...
sbSql.append("SELECT cod_ajuste as codigo, descripcion FROM tbl_con_tipo_ajuste where cod_ajuste is not null ");
sbSql.append(appendFilter);
sbSql.append(" order by cod_ajuste,descripcion");
