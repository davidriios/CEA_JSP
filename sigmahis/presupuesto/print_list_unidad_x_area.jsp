...
sbSql.append("select a.unidad_adm, a.descripcion FROM tbl_con_pres_unidad_x_area a  WHERE a.area=");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "UNIDADES POR ÁREAS";
	String xtraSubtitle = " ";
	...
	pc.setTableHeader(3);//create de table header
