...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  {
    appendFilter += " and upper(cod_ajuste) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
  ...
  sql = "SELECT cod_ajuste as codigo, descripcion FROM tbl_con_tipo_ajuste where cod_ajuste is not null "+appendFilter+" order by cod_ajuste, descripcion";
...
function add()
{
  abrir_ventana('../presupuesto/tipoajustes_config.jsp');
}

function edit(id)
{
  abrir_ventana('../presupuesto/tipoajustes_config.jsp?mode=edit&id='+id);
}

function printList()
{
  abrir_ventana('../presupuesto/print_list_tipo_ajustes.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right"><authtype type='3'><a href="javascript:add()" class="Link00">[ <cellbytelabel>Registrar Nuevo Tipo de Ajuste</cellbytelabel> ]</a></authtype></td>
    </tr>
  <tr>
    <td>
