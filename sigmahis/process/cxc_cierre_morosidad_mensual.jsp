...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("mes",mes)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Cerrar Morosidad Mensual</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de cerrar la Morosidad para <%=anio%>-<%=mes%> </font></cellbytelabel></td>
				</tr>
...
{
  sql.append("update tbl_cxc_morosidades_mes set estatus = 'C', fecha_cierre = sysdate, usuario_cierre = '");
