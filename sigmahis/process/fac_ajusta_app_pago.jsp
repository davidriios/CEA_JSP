...
String data_refer = request.getParameter("data_refer");
...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("mode",mode)%>
			<%=fb.hidden("code",code)%>
			<%=fb.hidden("data_refer",data_refer)%>
				<tr>
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr class="TextRow01">
					<td width="10%" align="right"><cellbytelabel>C&oacute;digo:</cellbytelabel></td>
					<td width="90%"><b><%=code%></td>				
				</tr>							
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de actualizar la aplicacion de pagos?</font></cellbytelabel></td>
				</tr>
				<tr class="TextRow02">
...
else
{
  ...
  code = request.getParameter("code");
	sql.append("call sp_cja_ajustar_pago_app(");
