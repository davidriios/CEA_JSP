...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("code",code)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Cambiar facturas Corporativas a Impresa = No</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de modificar Las facturas de la lista No. <%=code%>?</font></cellbytelabel></td>
				</tr>
				<tr class="TextRow02">
...
else
{
  ...
  code = request.getParameter("code");
	sql.append("call sp_fac_upd_fact_fisc_no_imp(");
