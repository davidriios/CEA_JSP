...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("id",id)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Cierrar Orden al Proveedor</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de cerrar la orden <%=anio%>-<%=id%> </font></cellbytelabel></td>
				</tr>
                <tr class="TextRow01">
...
{
  sql.append("update tbl_com_comp_formales set status_old=status ,status = 'Z', fecha_mod = sysdate, usuario_mod = '");
