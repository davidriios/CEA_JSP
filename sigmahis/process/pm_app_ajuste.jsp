...
if(tipo_aju.equals("1")) tipo_aju_desc = "Descuento a Factura";
else if(tipo_aju.equals("2")) tipo_aju_desc = "Anular Pago";
else if(tipo_aju.equals("3")) tipo_aju_desc = "Nota de Credito";
else if(tipo_aju.equals("4")) tipo_aju_desc = "Nota de Credito CxP";
else if(tipo_aju.equals("5")) tipo_aju_desc = "Nota de Debito";
...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("estado",estado)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Aprobaci&oacute;n de Ajuste</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de <%=mode%> el Ajuste No. <%=code%> de <%=tipo_aju_desc%>?</font></cellbytelabel></td>
				</tr>
				<tr class="TextRow02">
...
else
{
  ...
  code = request.getParameter("code");
	sql.append("call sp_pm_aprobar_ajuste(");
