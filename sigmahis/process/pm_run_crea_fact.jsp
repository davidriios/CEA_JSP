...
String apl_desc = request.getParameter("apl_desc");
...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("anio",anio)%>
			<%=fb.hidden("mes",mes)%>
			<%=fb.hidden("apl_desc",apl_desc)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Crear Facturas</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de CREAR Facturas?</font></cellbytelabel></td>
				</tr>
...
else
{
  ...
  sql.append("call sp_pm_crea_facturas(?,?,?,?,?,?,?)");
  CommonDataObject param = new CommonDataObject();//parametros para el procedimiento
	  ...
	  param.addInNumberStmtParam(1,request.getParameter("contrato"));
		param.addInNumberStmtParam(2,request.getParameter("cantidad"));
		param.addOutStringStmtParam(3);
		param.addInStringStmtParam(4,"CREA");
		param.addInNumberStmtParam(5,request.getParameter("anio"));
		param.addInNumberStmtParam(6,request.getParameter("mes"));
		param.addInStringStmtParam(7,request.getParameter("apl_desc"));
