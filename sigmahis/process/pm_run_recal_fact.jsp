...
<!-- ================================   F O R M   S T A R T   H E R E   ================================ -->
			...
			<%=fb.hidden("num_pagos",num_pagos)%>
				<tr class="TextHeader" align="center">
					<td colspan="2">Crear Facturas</td>
				</tr>
				<tr class="TextRow01">
					<td colspan="2" align="center"><cellbytelabe><font class="RedTextBold">Est&aacute; seguro de Recalcular Cancelación de Facturas?</font></cellbytelabel></td>
				</tr>
...
else
{
  ...
  sql.append("call sp_pm_recal_facturas(?,?)");
  CommonDataObject param = new CommonDataObject();//parametros para el procedimiento
	...
	param.addInNumberStmtParam(2,request.getParameter("num_pagos")==null||request.getParameter("num_pagos").equals("")?"0":request.getParameter("num_pagos"));
