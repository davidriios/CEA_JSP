...
sql ="select codigo, descripcion, decode(estado,'A','ACTIVO','I','INACTIVO') as estado from tbl_res_planes WHERE codigo<>0 "
+appendFilter;
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_planes_hospedaje";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Residencial",1,1);
					pc.addCols("PLANES DE HOSPEDAJE", 1, 1);
				pc.addTable();
				...
				{
					pc.createTable();
						pc.addCols("No existe el Plan seleccionado",1,5);
					pc.addTable();
				}
				else
				{
