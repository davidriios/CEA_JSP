...
sql ="SELECT secuencia, descripcion, DECODE(estatus,'A','Activo','I','Inactivo') as estatus FROM tbl_res_tipo_habitacion "
+ " WHERE secuencia<>0"+appendFilter+" order by descripcion";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_tiposhabit_residencial";
			...
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  pc.addCols("Residencial",1,1);
					pc.addCols("TIPOS DE HABITACIÓN RESIDENCIAL", 1, 1);
				pc.addTable();
				...
				{
					pc.createTable();
						pc.addCols("No existe el Tipo de Habitación seleccionado",1,5);
					pc.addTable();
				}
				else
				{
					if (al.size() > 0)
					{
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
							...
							pc.setFont(7, 0);
								...
								pc.addCols(" "+cdo1.getColValue("estatus"),0,1);
							pc.addTable();
