...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	{
		if (code == null) throw new Exception("El Código de Tipo Habitación no es válido. Por favor intente nuevamente!");
...
<%if(mode.equalsIgnoreCase("add")){%>
document.title=" Tipos de Habitación Residentes Agregar - "+document.title;
<%}else if(mode.equalsIgnoreCase("edit")){%>
document.title=" Tipos de Habitación Residentes Edición - "+document.title;
<%}%>
</script>
</head>
