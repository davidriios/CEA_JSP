...
<script language="javascript">document.title="Beneficio - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="6" align="right"><a href="javascript:openwin('beneficio_config.jsp');" ><font class="Link00">[ Registrar Nuevo Beneficio ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
