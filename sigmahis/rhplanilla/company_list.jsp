...
function add()
{
	abrir_ventana('company_config.jsp');
}

function edit(code)
{
	abrir_ventana('company_config.jsp?mode=edit&code='+code);
}

function printList()
{
	abrir_ventana('print_list_compania.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="RECURSOS HUMANOS - MANTENIMIENTO - COMPAÑIA"></jsp:param>
</jsp:include>
...
//{
%>
	    <a href="javascript:add()" class="Link00">[ Registrar Nueva Compa&ntilde;ia ]</a>
<%
//}
%>
			&nbsp;
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextHeader" align="center">
					...
					<td width="35%">Representante Legal</td>					
					<td width="10%">&nbsp;</td>
				</tr>				
				<%
