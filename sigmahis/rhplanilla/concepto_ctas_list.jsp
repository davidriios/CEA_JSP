...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  if (request.getParameter("descripcion") != null && !request.getParameter("descripcion").trim().equals(""))
  {
	...
	sql="select cod_concepto as code, descripcion, cod_compania from tbl_pla_cuenta_concepto where cod_compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
...
document.title = 'Planilla - Cuenta de Concepto - '+document.title;

function add()
{
abrir_ventana('../rhplanilla/concepto_ctas_config.jsp');
}

function edit(id)
{
abrir_ventana('../rhplanilla/concepto_ctas_config.jsp?mode=edit&id='+id);
}

function  printList()
{
abrir_ventana('print_list_concepto_ctas.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PLANLLA - MANTENIMIENTO - CONCEPTO DE CUENTAS"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
	<tr>
		<td colspan="4" align="right"><authtype type='3'>	<a href="javascript:add()" class="Link00">[ Registrar Nuevo Concepto de Cuentas ]</a></authtype></td>
	</tr>
