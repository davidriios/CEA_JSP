...
document.title = 'Parámetros Generales- '+document.title;
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="RECURSOS HUMANOS - PARÁMETROS GENERALES"></jsp:param>
</jsp:include>
