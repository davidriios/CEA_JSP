...
/**
==============================================================================================
800013	VER LISTA DE CRITERIOS DE JUSTIFICACION
800014	IMPRIMIR LISTA DE CRITERIOS DE JUSTIFICACION
...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select compania, codigo, descripcion from tbl_pla_criterio where compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by descripcion";
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_criterio where compania="+(String) session.getAttribute("_companyId")+appendFilter);
...
document.title = 'Recursos Humanos - Criterio de Justificación - '+document.title;

function add()
{
abrir_ventana('../rhplanilla/criterio_justicacion_config.jsp');
}

function edit(id)
{
abrir_ventana('../rhplanilla/criterio_justicacion_config.jsp?mode=edit&id='+id);
}

function  printList()
{
abrir_ventana('print_list_criterio_justificacion.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="Recursos Humanos - Mantenimiento - Criterio de Justificación "></jsp:param>
</jsp:include>
...
{
%>
<authtype type='3'>	<a href="javascript:add()" class="Link00">[ Registrar Nuevo Criterio de Justificaci&oacute;n ]</a></authtype>
<%
}
%>
		</td>
