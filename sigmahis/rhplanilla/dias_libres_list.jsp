...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  if (!fecha.trim().equals("")) { sbFilter.append(" and trunc(fecha) = to_date('"); sbFilter.append(fecha); sbFilter.append("','dd/mm/yyyy')"); }
...
function add()
{
abrir_ventana('../rhplanilla/dias_libres_config.jsp');
}

function edit(id)
{
abrir_ventana('../rhplanilla/dias_libres_config.jsp?mode=edit&id='+id);
}

function  printList()
{
abrir_ventana('../rhplanilla/print_list_dias_libres.jsp?appendFilter=<%=IBIZEscapeChars.forURL(sbFilter.toString())%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
	<tr>
		<td colspan="4" align="right"><authtype type='3'>	<a href="javascript:add()" class="Link00">[ Registrar Nuevo día libre ]</a></authtype></td>
	</tr>	
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr class="TextHeader" align="center">
		...
		<td width="12%">&nbsp;Dia libre</td>
		<td width="61%">&nbsp;Descripci&oacute;n</td>
		<td width="10%">&nbsp;</td>
	</tr>
<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td>&nbsp;<%=cdo.getColValue("dia_libre")%></td>
					<td>&nbsp;<%=cdo.getColValue("descripcion")%></td>
					<td align="center"><authtype type='4'>		<a href="javascript:edit('<%=cdo.getColValue("fecha")%>')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Editar</a></authtype></td>
				</tr>
				<%
				}
				%>							
