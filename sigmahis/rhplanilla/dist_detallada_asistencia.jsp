...
function setValues(){
	...
	if(anio!='' && mes !='' && quincena != ''){
		window.location = '../rhplanilla/dist_detallada_asistencia.jsp?anio='+anio+'&mes='+mes+'&fp=<%=fp%>&quincena='+quincena;
	}
}
...
function setTextValues(){
	...
	if(anio!='' && mes !='' && quincena != ''){
	window.frames['itemFrame1'].location = '../rhplanilla/dist_det_asist_emp.jsp?grupo='+grupo+'&area='+uf_codigo+'&anio='+anio+'&mes='+mes+'&fp=<%=fp%>&quincena='+quincena+'&fecha_inicio='+fecha_inicio+'&fecha_final='+fecha_final;
	window.frames['itemFrame2'].location = '../rhplanilla/dist_det_asist_semanas.jsp?grupo='+grupo+'&area='+uf_codigo+'&anio='+anio+'&mes='+mes+'&fp=<%=fp%>&quincena='+quincena+'&fecha_inicio='+fecha_inicio+'&fecha_final='+fecha_final;
	}
}
...
function setDiasValues(i){
	...
	if(anio!='' && mes !='' && quincena != '' && sem_fecha_inicio != '' && sem_fecha_final != ''){
		window.frames['itemFrame3'].location = '../rhplanilla/dist_det_asist_dias.jsp?sem_fecha_inicio='+sem_fecha_inicio+'&sem_fecha_final='+sem_fecha_final+'&anio='+anio+'&mes='+mes+'&fp=<%=fp%>&quincena='+quincena+'&emp_id='+emp_id+'&fecha_inicio='+fecha_inicio+'&fecha_final='+fecha_final;
	}
}
...
function setMarDetValues(i){
	...
	window.frames['itemFrame4'].location = '../rhplanilla/dist_det_asist_dias_mar.jsp?fecha='+fecha+'&fp=<%=fp%>&emp_id='+emp_id+'&index='+i;
	window.frames['itemFrame5'].location = '../rhplanilla/dist_det_asist_dias_det.jsp?fecha='+fecha+'&fp=<%=fp%>&emp_id='+emp_id;
}
...
function setMarDetValuesOnLoad(){
	if(window.frames['itemFrame3'].document.form.rb){
		...
		window.frames['itemFrame4'].location = '../rhplanilla/dist_det_asist_dias_mar.jsp';
		window.frames['itemFrame5'].location = '../rhplanilla/dist_det_asist_dias_det.jsp';
	}
}
              ...
              <tr>
                <td><table align="center" width="100%" cellpadding="0" cellspacing="1">
                    ...
                    <tr height="250">
                      ...
                      <td width="30%"><iframe name="itemFrame2" id="itemFrame2" frameborder="0" align="center" width="100%" height="220" scrolling="yes" src="../rhplanilla/dist_det_asist_semanas.jsp?fp=<%=fp%>&fg=<%=fg%>&mode=<%=mode%>"></iframe></td>
