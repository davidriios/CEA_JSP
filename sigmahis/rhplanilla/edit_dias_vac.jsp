...
function doSubmit(value){
	...
	if(value=='Ir')
	window.frames['itemFrame'].location = '../rhplanilla/edit_dias_vac_det.jsp?nombre='+nombre+'&cedula='+cedula+'&estado='+estado+'&cargo='+cargo+'&numEmpleado='+numEmpleado+'&descripcion='+desc+'&empId='+empId;
	if(value=='Guardar')
                ...
                <td><table align="center" width="100%" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                      <td><table width="100%" cellpadding="1" cellspacing="0">
                          <tr class="TextFilter">
                            <td width="16%">&nbsp;Nombre del Empleado:</td>
                            <td width="20%"><%=fb.textBox("nombre","",false,false,false,25,null,null,null)%></td>
                            <td width="12%">&nbsp;C&eacute;dula:</td>
                            <td width="17%"><%=fb.textBox("cedula","",false,false,false,15,null,null,null)%></td>
                            <td width="10%">&nbsp;Estado:</td>
                            <td width="25%"><%=fb.select(ConMgr.getConnection(), "select codigo, descripcion from tbl_pla_estado_emp order by codigo", "estado","",false,false,0,"Text10",null,null,null,"T")%></td>
                          </tr>
                          <tr class="TextFilter">
                            <td>&nbsp;Cargo del Empleado:</td>
                            <td ><%=fb.textBox("cargo","",false,false,false,25,null,null,null)%></td>
                            <td width="12%">&nbsp;Num Empleado<br>&nbsp;EMP. ID</td>
                            <td width="13%"><%=fb.textBox("numEmpleado","",false,false,false,15,null,null,null)%><br><%=fb.intBox("empId","",false,false,false,15,null,null,null)%></td>
                            <td>&nbsp;Departamento:</td>
                    ...
                    <tr>
                      <td><iframe name="itemFrame" id="itemFrame" frameborder="0" align="center" width="100%" height="300" scrolling="yes" src="../rhplanilla/edit_dias_vac_det.jsp?fp=<%=fp%>&fg=<%=fg%>&mode=<%=mode%>"></iframe></td>
                    </tr>
                    <tr class="TextRow02">
                      <td align="right">
