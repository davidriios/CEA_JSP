...
if (!(SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),"800077") || SecMgr.checkAccess(session.getId(),"800078") || SecMgr.checkAccess(session.getId(),"800079") || SecMgr.checkAccess(session.getId(),"800080"))) throw new Exception("Usted no tiene los suficientes Derechos de Acceso a esta página.");
