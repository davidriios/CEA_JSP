...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  String codigo  = "";           // variables para mantener el valor de los campos filtrados en la consulta
    ...
    searchType = "1";
    searchDisp = "Código";
		codigo     = request.getParameter("codigo");  // utilizada para mantener el Código del Factor filtrado
	}
  ...
  else
  {
	...
	sql = "select codigo, descripcion, tipo, definicion, valor_min, valor_max from tbl_pla_factores"+appendFilter;
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from  tbl_pla_factores "+appendFilter);
...
document.title = 'Planilla - Factores a Evaluar - '+document.title;

function add()
{
	abrir_ventana('../rhplanilla/factores_config.jsp');
}

function edit(id)
{
	abrir_ventana('../rhplanilla/factores_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../rhplanilla/print_list_factores.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
//{
%>
	<authtype type='3'>		<a href="javascript:add()" class="Link00">[ Registrar Nuevos Factores a Evaluar ]</a></authtype>
<%
//}
%>
		</td>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<tr class="TextHeader" align="center">
		   <td width= "4%">&nbsp;</td>
			...
			<td width="31%">Definici&oacute;n</td>
			<td width="10%">M&iacute;nima</td>
			<td width="9%">M&aacute;xima</td>
			<td width="9%">&nbsp;</td>
...
%>
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
			...
			<td><%=cdo.getColValue("definicion")%></td>
			<td align="center"><%=cdo.getColValue("valor_min")%></td>
			<td align="center"><%=cdo.getColValue("valor_max")%></td>
			<td align="center">
<%
//if (SecMgr.checkAccess(session.getId(),"0") || SecMgr.checkAccess(session.getId(),""))
//{
