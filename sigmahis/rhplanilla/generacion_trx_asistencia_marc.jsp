...
function generarTrx(){
	...
	if(generar){
		...
		if(executeDB('<%=request.getContextPath()%>', 'call sp_pla_genera_trx(' + v_compania + ', \'' + p_fechaini + '\', \'' + p_fechafin + '\', \'' + v_numempleado + '\', ' + v_provincia + ', ' + v_sigla + ', ' + v_tomo + ', ' + v_asiento + ', ' + v_grupo + ', \'' + v_tar + '\', \'' + v_aus + '\', \'' + v_hext + '\', \'' + v_user + '\', ' + p_emp_id + ')', '', '')){
