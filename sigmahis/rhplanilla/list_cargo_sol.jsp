...
function returnValue(op,code,name)
{
	...
	{  
		case 1:
window.opener.document.form0.cargo1.value=code; 
window.opener.document.form0.nameCargo1.value=name;
window.close();
		break;
		
		case 2:
window.opener.document.form0.cargo2.value=code; 
window.opener.document.form0.nameCargo2.value=name;
window.close();
		break;
		
		case 3:
window.opener.document.form0.cargo3.value=code; 
window.opener.document.form0.nameCargo3.value=name;
window.close();
		break;
...
<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="dirc">
	...
	<%
				...
				%>
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:returnValue(<%=id%>,'<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("denominacion")%>')" style="cursor:pointer">
