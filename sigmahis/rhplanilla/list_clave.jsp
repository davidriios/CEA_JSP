...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(clave) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    searchOn = "clave";
  ...
  if(fp.equalsIgnoreCase("empleado"))
  	{
	sql="select clave as codigo, descripcion from tbl_pla_clave_renta "+appendFilter+"  order by descripcion";
	alcentro =SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_clave_renta "+appendFilter);
	}
...
document.title = 'Lista de Clave de Renta- '+document.title;
...
{
%>
window.opener.document.form0.clave.value=eval('document.clavess.codigo'+k).value;
window.opener.document.form0.nameClave.value=eval('document.clavess.descripcion'+k).value;
<%
}
%>
window.close();
...
<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="cla">
	<tr class="TextHeader">
	  <td width="10%">&nbsp;</td>
	...
	<%
	fb = new FormBean("clavess",request.getContextPath()+"/common/urlRedirect.jsp");
	%>
	<%=fb.formStart()%>
	<%
