...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	sql = "SELECT codigo, nombre FROM TBL_SEC_COMPANIA WHERE codigo!=0"+appendFilter+" order by nombre";
	
	al = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
	rowCount = CmnMgr.getCount("select count(*) count from TBL_SEC_COMPANIA WHERE codigo!=0"+appendFilter);
...
document.title = 'Lista de Compañía - '+document.title;

function setValues(cod,desc)
{
	window.opener.document.form1.compania.value = cod;
	window.opener.document.form1.nombreCompania.value = desc;
	window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value=" PLANILLA - PARÁMETROS"></jsp:param>
</jsp:include>
