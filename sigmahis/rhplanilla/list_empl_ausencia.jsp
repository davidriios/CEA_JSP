...
document.title = 'Planilla - Listado de Ausencia - '+document.title;
...
{ 
    ...
    abrir_ventana2('../rhplanilla/ausencia_detail.jsp?provincia=<%=provincia%>&sigla=<%=sigla%>&tomo=<%=tomo%>&asiento=<%=asiento%>&numEmpleado=<%=numEmpleado%>&area=<%=area%>&fecha='+fecha+'&codigo='+codigo); 
}
function printList()
{
	abrir_ventana('../rhplanilla/print_list_empl_ausencia.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PLANILLA - TRANSACCION - LISTADO AUSENCIA"></jsp:param>
</jsp:include>
...
<!-- ================================   R E S U L T S   S T A R T   H E R E   ================================ -->
		...
		<%=fb.hidden("ta_hsal"+i,cdo.getColValue("ta_hent"))%>  
        <%=fb.hidden("ta_hsal"+i,cdo.getColValue("ta_hsal"))%>
