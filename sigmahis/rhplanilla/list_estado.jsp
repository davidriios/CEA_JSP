...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo, descripcion from tbl_pla_estado_emp "+appendFilter+" order by descripcion";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_estado_emp "+appendFilter);
...
switch(op)
	{  
	   case 1:
		window.opener.document.form1.codeEstado.value=code; 
		window.opener.document.form1.estados.value=name;
		window.close();
		break;
		
		case 2:
		window.opener.document.form0.estado.value=code; 
		window.opener.document.form0.nameEstado.value=name;
		window.close();
		break;
	}
}
...
<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="est">
	<tr class="TextHeader">
	  <td width="10%">&nbsp;</td>
