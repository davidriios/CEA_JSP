...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_f_pago_emp "+appendFilter);
	}	
...
document.title = 'Lista de Forma de Paago- '+document.title;
...
{
%>
window.opener.document.form0.forma.value=eval('document.formass.codigo'+k).value;
window.opener.document.form0.nameForma.value=eval('document.formass.descripcion'+k).value; 
<%
}
%>
window.close();
...
<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="dirc">
	...
	<%fb = new FormBean("formass",request.getContextPath()+"/common/urlRedirect.jsp");%>
	<%=fb.formStart()%>
	<%
