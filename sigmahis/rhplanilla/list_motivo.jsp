...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  else
  {
	...
	sql = "select codigo, descripcion from tbl_pla_motivo_falta"+appendFilter+" order by codigo";
...
{
		window.opener.document.form1.mfalta_duelo.value = eval('document.motivo.codigo'+k).value;
		window.opener.document.form1.nDescrip.value = eval('document.motivo.descripcion'+k).value;
		window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="RECURSOS HUMANOS -  SELECCION - MOTIVOS DE FALTAS"></jsp:param>
</jsp:include>
...
//{
%>
		<!--	<a href="javascript:add()" class="Link00">[ Registrar Nuevos Motivos de Faltas ]</a>----->
<%
//}
%>
		</td>
...
<%=fb.hidden("descripcion"+i,cdo.getColValue("descripcion"))%>
		...
		<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:setMotivo(<%=i%>)" style="text-decoration:none; cursor:pointer">
