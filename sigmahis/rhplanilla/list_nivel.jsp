...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo as code, descripcion as name from tbl_sec_nivel_unidadej "+appendFilter+" order by descripcion";
...
document.title = 'Lista de Niveles - '+document.title;
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="CONVENIOS - MANTENIMIENTO - CENTRO EDUCATIVO"></jsp:param>
</jsp:include>
