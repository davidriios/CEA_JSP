...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo, descripcion from tbl_pla_parentesco "+appendFilter+"  order by descripcion";
	alcentro = SQLMgr.getDataList("select * from (select rownum as rn, a.* from ("+sql+") a) where rn between "+previousVal+" and "+nextVal);
  rowCount = CmnMgr.getCount("SELECT count(*) from tbl_pla_parentesco "+appendFilter);
...
document.title = 'Lista de Parentescos- '+document.title;

function returnValue(code,name)
{
	
window.opener.document.form0.urgCode.value=code; 
window.opener.document.form0.urgParentesco.value=name;
window.close();
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PLANILLA - MANTENIMIENTO - PARENTESCOS"></jsp:param>
</jsp:include>
