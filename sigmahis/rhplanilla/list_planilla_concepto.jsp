...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " where upper(cod_concepto) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    searchOn = "cod_concepto";
  ...
  else
  {
	...
	sql="select cod_concepto as codigo, descripcion from tbl_pla_planilla_concepto "+appendFilter+" order by descripcion";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_planilla_concepto "+appendFilter);
...
{
<%
if(fp.equalsIgnoreCase("registroPlanilla"))
{
%>	

window.opener.document.form0.codeconcepto.value=eval('document.conceptoss.codigo'+k).value;
window.opener.document.form0.concepto.value=eval('document.conceptoss.descripcion'+k).value;
