...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(ruta) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    codigo = request.getParameter("codigo");
  }
  if (request.getParameter("descripcion") != null && !request.getParameter("descripcion").trim().equals(""))
  {
    appendFilter += " and upper(nombre_banco) like '%"+request.getParameter("descripcion").toUpperCase()+"%'";
    descripcion = request.getParameter("descripcion");
  }
	sql="select ruta as codigo, nombre_banco as descripcion, observacion from tbl_adm_ruta_transito where ruta is not null "+appendFilter+" order by nombre_banco";
...
document.title = 'Lista de Rutas - '+document.title;

function returnValue(code,name)
{
window.opener.document.form1.ruta.value=code; 
window.opener.document.form1.rutaname.value=name; window.close();
}
</script>
</head>
