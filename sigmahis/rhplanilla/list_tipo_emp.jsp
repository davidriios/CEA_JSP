...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
	...
	else if (request.getParameter("horas_te") != null)
	{
		appendFilter += " where horas_tiempoext ="+request.getParameter("horas_te");
    searchOn = "horas_tiempoext";
    searchVal = request.getParameter("horas_te");
    searchType = "2";
  ...
  else
  {
	...
	sql = "select codigo, descripcion, horas_tiempoext, nvl(minutos_contar,0) minutos_cont, nvl(minimo_minutos,0) min_minutos, nvl(dias_enfermedad,0) dias_enfermedad from tbl_pla_tipo_empleado "+appendFilter;
...
function printList()
{
	abrir_ventana('../rhplanilla/print_list_tipo_emp.jsp');
}
</script>
</head>
...
{
%>
			<a href="javascript:add()" class="Link00">[ Registrar Nuevo Tipo de Empleado ]</a>
<%
}
%>
		</td>
...
%>
				...
				<td width="33%">
					Horas T. Ext.
					<%=fb.textBox("horas_te","",false,false,false,20)%>
					<%=fb.submit("go","Ir")%>
				</td>
				<%=fb.formEnd()%>
