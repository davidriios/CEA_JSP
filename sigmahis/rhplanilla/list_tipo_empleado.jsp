...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select codigo, descripcion from tbl_pla_tipo_empleado "+appendFilter+" order by descripcion";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_tipo_empleado"+appendFilter);
...
document.title = 'Lista de Tipo de Empleado - '+document.title;
...
function returnValue(op,code,name)
{
	...
	{  
	   case 1:
		window.opener.document.form0.tipoempleado.value=code; 
		window.opener.document.form0.empleado.value=name; 
		window.close();
		break;
		
		case 2:
		window.opener.document.form0.tipos.value=code; 
		window.opener.document.form0.nameEmpleado.value=name; 
		window.close();
		break;
	}
}
...
<table align="center" width="100%" cellpadding="0" cellspacing="1" class="sortable" id="tip">
	<tr class="TextHeader">
	  <td width="10%">&nbsp;</td>
