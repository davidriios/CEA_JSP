...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " where upper(cod_reporte) like '%"+request.getParameter("codigo").toUpperCase()+"%'";
    searchOn = "cod_reporte";
  ...
  else
  {
	...
	sql="select cod_reporte as codigo, nombre from tbl_pla_reporte "+appendFilter+" order by nombre";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_reporte "+appendFilter);
...
switch(op)
	{  
	   case 1:
window.opener.document.form1.codemensual.value=code; 
window.opener.document.form1.mensual.value=name;
window.close();
		break;
	}
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				%>
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')" onClick="javascript:returnValue(<%=id%>,<%=cdo.getColValue("codigo")%>,'<%=cdo.getColValue("nombre")%>')">
