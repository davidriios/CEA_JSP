...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  {
    appendFilter += " and upper(descripcion) like '%"+request.getParameter("nacionalidad").toUpperCase()+"%'";
  ...
  else
  {
	...
	sql="select codigo, descripcion from tbl_sec_unidad_ejec where compania="+(String) session.getAttribute("_companyId")+appendFilter+" and nivel='3' and codigo <100 order by codigo";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_sec_unidad_ejec where compania="+(String) session.getAttribute("_companyId")+" and nivel='3' and codigo <100 "+appendFilter);
...
document.title = 'Lista de Ubicaciones - '+document.title;

function returnValue(code,name)
{
window.opener.document.form1.ubicacion.value=code; 
window.opener.document.form1.nameUbicacion.value=name; window.close();
}
</script>
</head>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td>&nbsp;<a href="javascript:returnValue('<%=cdo.getColValue("codigo")%>','<%=cdo.getColValue("descripcion")%>')" class="Link00"><%=cdo.getColValue("descripcion")%></a></td>
				</tr>
				<%
				}
		%>						
