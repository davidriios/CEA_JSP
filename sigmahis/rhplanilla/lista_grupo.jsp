...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else
  {
	...
	sql="select cod_grupo as codigo, nombre from tbl_pla_grupo_descuento "+appendFilter+" order by nombre";
	alcentro = SQLMgr.getDataList(sql);
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_grupo_descuento "+appendFilter);
...
document.title = 'Lista de Grupo - '+document.title;

function setValues(code,name)
{
window.opener.document.form1.grupoId.value = code;
window.opener.document.form1.nombreGrupo.value = name;
window.close();
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PLANILLA - MANTENIMIENTO - LISTA DE GRUPOS DE DESCUENTOS"></jsp:param>
</jsp:include>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<%
				...
				%>
				<tr class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')"  onClick="javascript:setValues(<%=cdo.getColValue("codigo")%>,'<%=cdo.getColValue("nombre")%>')">
