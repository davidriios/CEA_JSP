...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  String codigo   = "";    // variables para mantener el valor de los campos filtrados en la consulta
    ...
    searchType = "1";
    searchDisp = "Código";
		codigo     = request.getParameter("codigo");   // utilizada para mantener el Código del Estado del Empleado
	}
  ...
  else
  {
	...
	sql = "select codigo, descripcion, decode(pagar_vacacion,'S','Sí','N','No') pagar_vacacion, decode(pagar_xiii_mes,'S','Sí','N','No') pagar_xiii_mes, decode(pagar_pantig,'S','Sí','N','No') pagar_pantig, decode(pagar_indemn,'S','Sí','N','No') pagar_indemn, decode(pagar_recargo25,'S','Sí','N','No') pagar_recargo25, decode(pagar_recargo50,'S','Sí','N','No') pagar_recargo50 from tbl_pla_li_motivo where compania = "+(String) session.getAttribute("_companyId")+appendFilter+" order by codigo";
