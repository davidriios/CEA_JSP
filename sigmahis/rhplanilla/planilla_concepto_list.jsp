...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  sql = "select cod_concepto as codigo, descripcion from tbl_pla_planilla_concepto where cod_concepto >0 "+appendFilter+" order by descripcion asc";
...
document.title = 'Concepto de Planilla - '+document.title;

function add()
{
	abrir_ventana('../rhplanilla/planilla_concepto_config.jsp');
}
function edit(id)
{
	abrir_ventana('../rhplanilla/planilla_concepto_config.jsp?mode=edit&id='+id);
}
function printList()
{
	abrir_ventana('../rhplanilla/print_list_planilla_concepto.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="PLANILLA - MANTENIMIENTO - CONCEPTO DE PLANILLA"></jsp:param>
</jsp:include>
<table align="center" width="99%" cellpadding="1" cellspacing="0">
    <tr>
        <td align="right"><authtype type='3'><a href="javascript:add()" class="Link00">[ Registrar Nuevo Concepto de Planilla ]</a></authtype></td>
    </tr>
	<tr>
		<td>
