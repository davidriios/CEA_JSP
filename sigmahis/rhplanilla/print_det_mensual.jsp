...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	for (int i=0; i<tot.size(); i++)
	{
		...
		htUni.put(cdo1.getColValue("meses"),cdo1);
	...
	pc.createTable();
		...
		pc.addCols("FECHA AUMENTO",1,1);
		pc.addCols("SALARIO ANTERIOR",2,1);
		pc.addCols("SOBRESUELDO",2,1);
		pc.addCols("SALARIO NUEVO",2,1);
		
		pc.setFont(7, 0);
		pc.addCols("",0,dHeader.size());
			
		pc.setFont(7, 1);
		pc.addCols("FECHA DE AUMENTO :  "+fechaProc,0,2);
		pc.addCols("  ",0,6);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		if (!sec.equalsIgnoreCase(cdo.getColValue("meses")))
		{
		if (i!=0)
		{
		...
		pc.addCols("Empleados : "+cdo2.getColValue("count"),2,5);
		pc.addCols(" "+CmnMgr.getFormattedDecimal(cdo2.getColValue("totsant")),2,1);
		pc.addCols(" "+CmnMgr.getFormattedDecimal(cdo2.getColValue("totmonto")),2,1);
		pc.addCols(" "+CmnMgr.getFormattedDecimal(cdo2.getColValue("totnsal")),2,1);
		//pc.addTable();
		sec =  cdo.getColValue("meses");
		...
		pc.setFont(7, 0);
			...
			pc.setFont(7, 0);
		pc.setVAlignment(0);
		pc.addCols(" "+cdo.getColValue("meses"),0,8);
		...
		pc.addCols(""+CmnMgr.getFormattedDecimal(cdo.getColValue("sueldo_anterior")),2,1);
		pc.addCols(""+CmnMgr.getFormattedDecimal(cdo.getColValue("aumento")),2,1);
		pc.addCols(""+CmnMgr.getFormattedDecimal(cdo.getColValue("nuevoSalario")),2,1);
      ...
      //  montoTotal += cdo.getColValue("monto");
		...
		totSala += Double.parseDouble(cdo.getColValue("sueldo_anterior"));
		totSaln += Double.parseDouble(cdo.getColValue("nuevoSalario"));
	...
	pc.addCols(" TOTALES FINALES :  "+al.size()+"  EMPLEADOS : ",2,5);
