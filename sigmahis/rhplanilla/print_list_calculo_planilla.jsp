...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "ESTADO DE PLANILLAS CALCULADAS";
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		pc.addBorderCols("No. Planilla",1);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.addCols(cdo.getColValue("codPlanilla"),1,1);
		pc.addCols(cdo.getColValue("numPlanilla"),1,1);
		pc.addCols(cdo.getColValue("descripcion"),0,1);
		pc.addCols(cdo.getColValue("fechaPago"),1,1);
		pc.addCols(cdo.getColValue("descEstado"),1,1);
