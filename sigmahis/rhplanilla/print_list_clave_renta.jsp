...
if (appendFilter == null) appendFilter = "";
  ...
  sql = "select clave, descripcion, pago_base from tbl_pla_clave_renta"+appendFilter+" order by clave";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_clave_renta";
					...
					if (al.size() > 0)
					{
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
						    CommonDataObject cdo1 = (CommonDataObject) al.get(i);
								...
								pc.createTable();
								pc.setFont(7, 0);
									pc.addCols(" "+cdo1.getColValue("clave"),1,1);
									pc.addCols(" "+cdo1.getColValue("descripcion"),0,1);
									pc.addCols(" "+CmnMgr.getFormattedDecimal(cdo1.getColValue("pago_base")),2,1);
								pc.addTable();
