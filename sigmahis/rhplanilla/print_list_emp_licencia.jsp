...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = " LISTADO DE EMPLEADOS POR CON/SIN LICENCIA DE CONDUCIR ";
	String xtraSubtitle = "";
	...
	for (int i=0; i<al.size(); i++)
	{
		CommonDataObject cdo = (CommonDataObject) al.get(i);
			...
			if (!un.equalsIgnoreCase(cdo.getColValue("licencia")))
			{
			un = cdo.getColValue("licencia");
			unDesc = cdo.getColValue("departamento");
			pc.setFont(7, 1);
			pc.addCols(" "+cdo.getColValue("licencia"),0,3);
			...
			pc.setFont(7, 1);
			pc.addCols(" UNIDAD ADMINISTRATIVA :   [ "+cdo.getColValue("seccion")+" ] "+cdo.getColValue("seccionDesc"),0,3);
