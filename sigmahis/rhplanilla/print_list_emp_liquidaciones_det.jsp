		...
		if (i != 0)
			  {
			   ...
			   pc.addBorderCols("   "+cdo.getColValue("nombre"),0,5,cHeight * 1,Color.lightGray);	
			    pc.addBorderCols(" "+cdo.getColValue("fecha"),1,5,cHeight * 1,Color.lightGray);	
			   pc.addBorderCols(" Cargo:  "+cdo.getColValue("denominacion"),0,4,cHeight * 1,Color.lightGray);	
			   pc.addBorderCols("      Cédula: "+cdo.getColValue("cedula"),0,5,cHeight * 1,Color.lightGray);	
			   pc.addBorderCols(" Fecha de Ingreso:  "+cdo.getColValue("ingreso"),1,5,cHeight * 1,Color.lightGray);
			   pc.addBorderCols(" Salario Base :  "+CmnMgr.getFormattedDecimal(cdo.getColValue("salario")),0,4,cHeight * 1,Color.lightGray);	
