...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = " LISTADO DE EMPLEADOS POR DIRECCION Y SECCION ";
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		pc.addCols("Cédula/Pass",1,1);
		pc.addCols("Nombre del Empleado ",1,2);	
		pc.addCols("No.S.Soc.",1,1);
		pc.addCols("Fecha de Ingreso",1,1);
		pc.addCols(" ",1,1);
