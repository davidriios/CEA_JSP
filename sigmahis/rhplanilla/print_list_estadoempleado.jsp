...
if (appendFilter == null) appendFilter = "";
 ...
 sql= "select codigo as codigo, descripcion as documento, decode(recibe_pago,'S','SI','N','NO') as certificado from tbl_pla_estado_emp "+appendFilter+" order by codigo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "ESTADOS DE EMPLEADOS ";
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		pc.addBorderCols("Recibe Pago",1);
