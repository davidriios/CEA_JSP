...
if (appendFilter == null) appendFilter = "";
	...
	sql="select a.provincia||'-'||a.sigla||'-'||a.tomo||'-'||a.asiento as cedula, a.provincia, a.sigla, a.tomo, a.asiento,   a.primer_nombre||' '||a.primer_apellido||' '||a.segundo_apellido as nombre , a.ubic_seccion as seccion, ' [ '||a.ubic_seccion||' ] '||b.descripcion as descripcion, a.emp_id as empId, a.num_empleado as numero, a.num_ssocial as social, a.tipo_renta||'-'||nvl(a.num_dependiente,'0') renta, to_char(a.salario_base,'99,999,990.00') as salario, to_char(a.rata_hora,'99,990.00') as rata, to_char(a.fecha_nacimiento,'dd-mm-yyyy') nacimiento, to_char(a.fecha_ingreso,'dd-mm-yyyy') ingreso, a.horas_base horas, a.estado, e.descripcion estadoDesc, d.denominacion as cargo from tbl_pla_empleado a, tbl_sec_unidad_ejec b, tbl_pla_cargo d, tbl_pla_estado_emp e where a.compania = b.compania and a.ubic_seccion = b.codigo and a.estado = e.codigo and a.cargo = d.codigo and a.compania = d.compania and a.compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by a.ubic_seccion, a.primer_apellido";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	pc.createTable();
		...
		pc.addBorderCols("Clare Renta",1,1);	
