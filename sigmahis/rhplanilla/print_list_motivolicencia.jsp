...
if (appendFilter == null) appendFilter = "";
	...
	sql = "select codigo, descripcion,clausula from tbl_pla_motivo_licencia "+appendFilter+" order by codigo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.setVAlignment(0);
			...
			pc.addCols(" "+cdo.getColValue("clausula"),0,1);
