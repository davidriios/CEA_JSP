...
if (appendFilter == null) appendFilter = "";
 ...
 sql="select a.tipo_reg as Tipo, a.reg_control as Control, a.salario_limite as SalarioLimite, a.cod_compania as cia, e.codigo as cod, e.nombre as namecia, b.cod_compania as comp, b.cod_acreedor as codeacredor, b.cod_grupo as codegrupo, b.descuento_mensual, b.frecuencia_descuento, c.cod_grupo as cot, c.nombre as namegrupo, d.cod_acreedor as acredor, d.nombre as nameacredor from tbl_pla_parametros a, TBL_SEC_COMPANIA e, tbl_pla_parametros_desctos b, tbl_pla_grupo_descuento c, tbl_pla_acreedor d where a.cod_compania=e.CODIGO and b.cod_acreedor= d.cod_acreedor and b.cod_grupo=c.cod_grupo and a.cod_compania=b.cod_compania "+appendFilter+" order by e.nombre";
...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_parametros";
...
//				pc.addTable();
				...
				Vector setHeader2=new Vector();
					...
					setHeader2.addElement(".42");
					setHeader2.addElement(".13");
				...
				pc.createTable();
				pc.addBorderCols("Compañía",1);
				pc.addBorderCols("Acreedor",1);
				pc.addBorderCols("Grupo Descuento",1);
				pc.addBorderCols("Tipo",1);
				pc.addBorderCols("Control",1);
				pc.addTable();

				if (al.size()==0) {
						pc.createTable();
							pc.addCols("No existe el parametro seleccionado",1,5);
						pc.addTable();
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
						    CommonDataObject cdo1 = (CommonDataObject) al.get(i);
								...
								pc.setFont(7, 0);
									...
									pc.addCols(" "+cdo1.getColValue("nameacredor"),0,1);
									pc.addCols(" "+cdo1.getColValue("namegrupo"),0,1);
									pc.addCols(" "+cdo1.getColValue("tipo"),1,1);
									pc.addCols(" "+cdo1.getColValue("control"),1,1);
								pc.addTable();
