...
if(request.getMethod().equalsIgnoreCase("GET")) {
		...
		String fileNamePrefix = "print_list_personal_externo";
...
for (int j=1; j<=nPages; j++)
{
			Vector setHeader0=new Vector();
				...
				pc.setFont(9, 1);
				  ...
				  pc.addCols("PERSONAL EXTERNO", 1, 1);
				pc.addTable();
				...
				pc.createTable();
					...
					pc.addBorderCols("Institución",1);
				pc.addTable();
					...
					if (al.size() > 0)
					{
						...
						for (int i=((maxLines * j) - maxLines); i<(maxLines * j); i++)
						{
							...
							pc.setFont(7, 0);
								...
								pc.addCols(" "+cdo1.getColValue("nombre")+" "+cdo1.getColValue("apellido"),0,1);
								pc.addCols(" "+cdo1.getColValue("institucion"),0,1);
							pc.addTable();
