...
if (appendFilter == null) appendFilter = "";
	...
	sbSql.append("select cod_concepto as codigo, descripcion from tbl_pla_planilla_concepto where cod_concepto >0 "); 
	sbSql.append(appendFilter.toString());
	sbSql.append(" order by cod_concepto asc");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "CONCEPTOS DE PLANILLAS";
	String xtraSubtitle = "";
