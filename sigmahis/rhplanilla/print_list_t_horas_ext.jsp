...
sql.append("select codigo, descripcion, factor_multi, detalle_factor from tbl_pla_t_horas_ext where codigo is not null");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE HORAS EXTRAS";
	String xtraSubtitle = "";
	...
	pdfHeader(pc, _comp, xtraCompanyInfo, title, subtitle, xtraSubtitle, userName, fecha, dHeader.size());
		...
		pc.addBorderCols("Factor Multiplicador",1);
		pc.addBorderCols("Detalle de Factor",1);
		pc.setTableHeader(2);
		...
		for ( int j = 0; j<al.size(); j++ ){
			...
			pc.addCols(" "+cdo.getColValue("factor_multi"),2,1);
			pc.addCols(" "+cdo.getColValue("detalle_factor"),0,1);
