...
if (appendFilter == null) appendFilter = "";
	 ...
	 sql = "SELECT codigo, descripcion from tbl_pla_tipo_accion_evaluacion where codigo<>0"+appendFilter+" order by codigo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = " TIPOS DE ACCIONES POST EVALUACION ";
	String xtraSubtitle = "";
