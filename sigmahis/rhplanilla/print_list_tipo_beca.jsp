...
if (appendFilter == null) appendFilter = "";
 ...
 sql = "select cod_beca as codigo, descripcion as documento, to_char(monto,'999,999,990.00') as precio from tbl_pla_tipo_beca  "+appendFilter+" order by cod_beca";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE BECARIOS ";
	String xtraSubtitle = "";
