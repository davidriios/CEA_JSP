...
if (appendFilter == null) appendFilter = "";
	...
	sbSql.append("select tipopla, descripcion from tbl_pla_tipo_planilla where tipopla >0 ");
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE PLANILLA";
	String xtraSubtitle = "";
	...
	for (int i=0; i<al.size(); i++)
	{
		CommonDataObject cdo1 = (CommonDataObject) al.get(i);
			...
			pc.addCols(" "+cdo1.getColValue("tipopla"),1,1);
