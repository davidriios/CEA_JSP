...
if (appendFilter == null) appendFilter = "";
		...
		sql= "select codigo, descripcion from tbl_pla_tipo_uniforme where compania = "+ session.getAttribute("_companyId")+" "+appendFilter+" order by codigo";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE UNIFORMES ";
	String xtraSubtitle = "";
