...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = "TIPOS DE EMPLEADOS ";
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		pc.addBorderCols("Horas Extras Permitidas",1);	
		pc.addBorderCols("Minutos a Contar ",1);	
		pc.addBorderCols("Tiempo Mínimo ",1);
	...
	for (int i=0; i<al.size(); i++)
	{
		...
		pc.setVAlignment(0);
			...
			pc.addCols(" "+cdo.getColValue("horas_tiempoext"),1,1);	
			pc.addCols(" "+cdo.getColValue("minutos_cont"),1,1);
			pc.addCols(" "+cdo.getColValue("min_minutos"),1,1);
			pc.addCols(" "+cdo.getColValue("dias_enfermedad"),1,1);	
