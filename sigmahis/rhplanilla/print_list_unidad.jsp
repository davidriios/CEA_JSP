...
if (appendFilter == null) appendFilter = "";
			...
			sql= "select a.codigo, a.descripcion, to_number(a.nivel,'99999') as nivel, '[ '||b.codigo||' ] '||b.descripcion as nivelDesc, a.direccion, a.telefono, a.extension, a.fax, a.email, a.depto_preelab as preelab from tbl_sec_unidad_ejec a, tbl_sec_nivel_unidadej b where a.nivel = b.codigo and a.compania = "+(String) session.getAttribute("_companyId")+" "+appendFilter+" order by a.nivel, a.descripcion";
...
if (request.getMethod().equalsIgnoreCase("GET"))
{
	...
	String subtitle = " UNIDADES ADMINISTRATIVAS ";
	String xtraSubtitle = "";
	...
	pc.createTable();
		...
		pc.addBorderCols("Direccion",1);
		pc.addBorderCols("Teléfono ",1,1);	
		pc.addBorderCols("Extensión",1);
	...
	for (int i=0; i<al.size(); i++)
	{
		CommonDataObject cdo = (CommonDataObject) al.get(i);
			...
			pc.setFont(7, 1);
			pc.addCols(" "+cdo.getColValue("nivelDesc"),0,8);
			}
	    ...
	    pc.addCols(" "+cdo.getColValue("extension"),1,1);
