...
<script language="javascript">document.title="Rango Salario - "+document.title;</script>
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="6" align="right"><a href="javascript:openwin('rangosalario_config.jsp');" ><font class="Link00">[ Registrar Nuevo Rango ]&nbsp;</font></a></td>
	</tr>	
	<tr class="TextFilter">
...
<table align="center" width="100%" cellpadding="0" cellspacing="1">
	...
	<tr class="TextRow01" onMouseOver="setoverc(this,'TextRowOver','TextRow01')" onMouseOut="setoutc(this,'TextRow01')">
		...
		<td><a href="javascript:openwin('rangosalario_config.jsp')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Editar</a></td>		
	</tr>							
