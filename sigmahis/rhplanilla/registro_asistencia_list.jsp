...
if(request.getParameter("estado")!=null)
{
 ...
 appendFilter += " and upper(b.estado) like '%"+request.getParameter("estado").toUpperCase()+"%'";
 }
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
			...
			<td width="50%" height="22">&nbsp;N&uacute;mero de Empleado&nbsp;&nbsp;&nbsp;&nbsp;
							<%=fb.textBox("numero","",false,false,false,10,null,null,null)%>
				</td>
  ...
  <tr class="TextFilter">
	<td width="50%">&nbsp;Estado del Empleado&nbsp;&nbsp;
		<%=fb.select(ConMgr.getConnection(),"select codigo as cod,codigo||' - '||descripcion descripcion, codigo from tbl_pla_estado_emp ORDER BY 1","estado","","T")%></td>
	</td>
        ...
        <%
			...
			for (int i=0; i<al.size(); i++)
			{
				...
				<tr id="rs<%=i%>" class="<%=color%>" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'<%=color%>')">
					...
					<td align="center">
					<a href="javascript:showPopWin('../rhplanilla/reg_asistencia_list.jsp?empId=<%=cdo.getColValue("empId")%>&id=<%=i%>',winWidth*.80,_contentHeight*.80,null,null,'');"><font class="BoltText">Ver</font></a> </td>
