...
/*if(seccion==null){ 
sql = "SELECT codigo, descripcion, descripcion FROM tbl_sal_expediente_secciones "+appendFilter+" ORDER BY codigo";
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="REPORTES DE EMPLEADOS VARIOS"></jsp:param>
</jsp:include>
...
<%=fb.hidden("grupo",grupo)%>
		...
		<tr class="TextRow01" onClick="javascript:doRedirect('4')" style="cursor:pointer" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'TextRow01')">		<td>Cargos de Empleados</td>
		</tr>
		...
		<tr class="TextRow02" onClick="javascript:doRedirect('15')" style="cursor:pointer" onMouseOver="setoverc(this,'TextRowOver')" onMouseOut="setoutc(this,'TextRow02')">		<td>Carta de Empleados</td>
		</tr>	
			...
			<iframe id="iDetalle" name="iDetalle" width="100%" height="418" scrolling="si" frameborder="0" src="../rhplanilla/reg_varios_empleado_redirect.jsp"></iframe>
			</td>
		</tr>
