...
/**
==============================================================================================
800057	VER LISTA DE RUTA DE IMAGENES DE EMPLEADOS
800058	IMPRIMIR LA LISTA DE EMPLEADOS Y SUS RUTAS
800059	AGREGAR RUTA DE IMAGENES DE EMPLEADOS
800060	MODIFICAR RUTA DE IMAGENES
==============================================================================================
**/
...
String nextVal = ""+recsPerPage, previousVal = "1", searchQuery, searchOn = "SO", searchVal = "Todos", searchType = "ST", searchDisp = "SD", searchValDisp = "Todos", searchValFromDate = "SVFD", searchValToDate = "SVTD";
  ...
  else if (request.getParameter("nombre") != null)
  {
    ...
    searchDisp = "Nombre";
      ...
      else if (request.getParameter("unidad_organi") != null)
  {
    appendFilter += " and upper(a.unidad_organi) like '%"+request.getParameter("unidad_organi").toUpperCase()+"%'";
    searchOn = "unidad_organi";
    searchVal = request.getParameter("unidad_organi");
    searchType = "1";
    searchDisp = "Unidad";
  }
  ...
  else
  {
	...
	sql="select a.provincia||'-'||a.sigla||'-'||a.tomo||'-'||a.asiento as cedula, a.provincia, a.sigla, a.tomo, a.asiento, a.compania,  a.primer_nombre||' '||a.segundo_nombre||' '||a.primer_apellido||' '||segundo_apellido  as nombre ,a.primer_nombre, a.primer_apellido, a.unidad_organi as depto, b.descripcion as descripcion from tbl_pla_estudiante a, tbl_sec_unidad_ejec b where a.compania = b.compania and a.unidad_organi = b.codigo and a.compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by a.unidad_organi, a.primer_apellido";
  ...
  rowCount = CmnMgr.getCount("SELECT count(*) FROM tbl_pla_estudiante where compania="+(String) session.getAttribute("_companyId")+appendFilter);
		...
		sql="select codigo, descripcion  from  tbl_sec_unidad_ejec where nivel = 2 and compania="+(String) session.getAttribute("_companyId")+appendFilter+" order by codigo";
...
document.title = 'Recursos Humanos - Ruta de Imagenes de Estudiantes - '+document.title;

function edit(prov,sig,tom,asi,empid)
{
abrir_ventana('../rhplanilla/rutaimagen_est_config.jsp?mode=edit&prov='+prov+'&sig='+sig+'&tom='+tom+'&asi='+asi+'&empid='+empid);
}


function  printList()
{
abrir_ventana('print_list_rutaimagen_est.jsp');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="RECURSOS HUMANOS - RUTA DE IMAGENES ESTUDIANTES"></jsp:param>
</jsp:include>
...
<!-- ================================   S E A R C H   E N G I N E S   S T A R T   H E R E   ================================ -->
		...
		<td width="50%">&nbsp;Unidad&nbsp;
					<%=fb.textBox("unidad_organi","",false,false,false,30,null,null,null)%>
					<%=fb.submit("go","Ir")%></td>
		<%=fb.formEnd()%>	
		...
		<td width="20%">&nbsp;</td>
				...
				%>
				   <tr align="left" bgcolor="#FFFFFF" class="linksblacklight">
                      <td colspan="6" class="TitulosdeTablas"> [<%=cdo.getColValue("depto")%>] - <%=cdo.getColValue("descripcion")%></td>
                   </tr>
				<%
				   }
				  %>
...
{
%>
			<authtype type='4'>	<a href="javascript:edit('<%=cdo.getColValue("provincia")%>','<%=cdo.getColValue("sigla")%>','<%=cdo.getColValue("tomo")%>','<%=cdo.getColValue("asiento")%>','<%=cdo.getColValue("empid")%>')" class="Link02Bold" onMouseOver="setoverc(this,'Link01Bold')" onMouseOut="setoutc(this,'Link02Bold')">Editar</a></authtype>
                    <%}%>					</td>
				</tr>
                            <%
