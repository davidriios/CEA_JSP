...
document.title = 'Recursos Humanos - Ruta de Imagenes - '+document.title;

function edit(prov,sig,tom,asi,empid)
{
abrir_ventana('../rhplanilla/rutaimagen_config.jsp?mode=edit&prov='+prov+'&sig='+sig+'&tom='+tom+'&asi='+asi+'&empid='+empid);
}


function  printList()
{
abrir_ventana('print_list_rutaimagen.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<jsp:include page="../common/title.jsp" flush="true">
	<jsp:param name="title" value="RECURSOS HUMANOS - RUTA DE IMAGENES "></jsp:param>
</jsp:include>
