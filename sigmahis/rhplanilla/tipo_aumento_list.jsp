...
if (request.getMethod().equalsIgnoreCase("GET"))
{
  ...
  if (request.getParameter("searchQuery") != null)
  {
	...
	sql = "select codigo, descripcion from tbl_pla_tipo_aumento where compania="+(String) session.getAttribute("_companyId")+" "+appendFilter+" order by codigo";
...
document.title = 'Planilla - Tipos de Aumentos - '+document.title;

function add()
{
	abrir_ventana('../rhplanilla/tipo_aumento_config.jsp');
}

function edit(id)
{
	abrir_ventana('../rhplanilla/tipo_aumento_config.jsp?mode=edit&id='+id);
}

function printList()
{
	abrir_ventana('../rhplanilla/print_list_tipo_aumento.jsp?appendFilter=<%=IBIZEscapeChars.forURL(appendFilter)%>');
}
</script>
</head>
...
<table align="center" width="99%" cellpadding="1" cellspacing="0">
  <tr>
    <td align="right"><authtype type='3'><a href="javascript:add()" class="Link00">[ Registrar Nuevos Tipo de Aumentos ]</a></authtype></td>
  </tr>
	<tr>
		<td>
