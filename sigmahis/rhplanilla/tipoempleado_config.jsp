...
<script language="javascript">document.title="Tipo Empleado Edición - "+document.title;</script>
...
<!--STYLE UP-->	
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="1">
				<tr class="TextHeader">
					<td colspan="4" align="left">&nbsp;Tipo Empleado</td>
				</tr>	
				<tr class="TextRow01" >
					<td>&nbsp;C&oacute;digo</td>
					<td colspan="3">&nbsp;<input type="text" name="codigo" size="30" value=""></td>
				</tr>							
				<tr class="TextRow02" >
					<td>&nbsp;Descripci&oacute;n</td>
					<td colspan="3">&nbsp;<input type="text" name="nombre" size="45" value=""></td>
				</tr>
				<tr class="TextRow01" >
					<td width="18%">&nbsp;Dia de Enfermedad</td>
					<td width="32%">&nbsp;<input type="text" name="enfermedad" size="30" value=""></td>
					<td width="20%">&nbsp;Horas Extras Permitidas</td>
					<td width="30%">&nbsp;<input type="text" name="horasExtras" size="30" value=""></td>
				</tr>
				<tr class="TextRow02" >
					<td>&nbsp;Minutos a Contar</td>
					<td>&nbsp;<input type="text" name="minutos" size="30" value=""></td>
					<td>&nbsp;Tiempo M&iacute;nimo</td>
					<td>&nbsp;<input type="text" name="tiempoMinimo" size="30" value=""></td>
				</tr>							
				<tr>
